 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Toba_Sniffs_Functions_ValidDefaultValueSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        while (($nextArg = $phpcsFile->findNext(T_VARIABLE, ($nextArg + 1), $argEnd)) !== false) {
            ...
            if (($argHasDefault === false) && ($defaultFound === true)) {
                $error  = '[Funciones#declaracion] Arguments with default values must be at the end';
