...
{section name=tag loop=$info_tags}
	...
	{if $info_tags[tag].keyword eq "wiki"}
		<tr>
			<td colspan="2"><strong><a href='{$subdir}../wiki/trac/toba/wiki/{$info_tags[tag].data}.html'>Documentación WIKI</a></strong></td></tr>
	{/if}	
	{if $info_tags[tag].keyword eq "jsdoc"}
		{assign var="jsdoc" value=" "|split:$info_tags[tag].data}
		<tr><td colspan="2"><a href='{$subdir}../api_js/{$jsdoc[0]}.html'><strong>Clase Javascript equivalente: {$jsdoc[1]}</strong></a></td></tr>
	{/if}
{/section}
</table>
{/if}
