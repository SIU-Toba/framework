...
<? 	echo "<a href='" . $this->vinculador->generar_solicitud("toba",null,array("tipo_vista" =>"general")) . "' class='basico'>"; 
	echo recurso::imagen_apl('solicitudes.gif',true,null,null,"Vista General"); 
	echo "</a>&nbsp;";
	echo "<a href='" . $this->vinculador->generar_solicitud("toba",null,array("tipo_vista" =>"menu")) . "' class='basico'>"; 
