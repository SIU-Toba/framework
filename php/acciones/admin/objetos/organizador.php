...
<? 	
	//OBJETOS Estaticos
	echo "<a href='" . $this->vinculador->generar_solicitud("toba",null,array("tipo_vista_obj" =>"estatico")) . "' class='basico'>"; 
	...
	echo "<a href='" . $this->vinculador->generar_solicitud("toba",null,array("tipo_vista_obj" =>"capas")) . "' class='basico'>"; 
	echo recurso::imagen_apl('objetos/met_capas.gif',true,null,null,"Desarrollo en CAPAS"); 
	echo "</a>";
	echo "</td><td class='lista-obj-titcol'>";
	//OBJETOS para trabajar con el MODELO
	echo "<a href='" . $this->vinculador->generar_solicitud("toba",null,array("tipo_vista_obj" =>"modelo")) . "' class='basico'>"; 
	echo recurso::imagen_apl('objetos/met_modelo.gif',true,null,null,"Desarrollo sobre el MODELO"); 
	echo "</a>";
	echo "</td><td  class='lista-obj-titcol'>";
	//OBJETOS en el PORTAFOLIO
	echo "<a href='" . $this->vinculador->generar_solicitud("toba",null,array("tipo_vista_obj" =>"portafolio")) . "' class='basico'>"; 
	echo recurso::imagen_apl('portafolio.gif',true,null,null,"Vista Portafolio"); 
	echo "</a>";
?>          
</td>
 	<td width="2%" >
	<a href="<? echo $this->vinculador->generar_solicitud("toba","/admin/objetos/propiedades") ?>" target="<? echo  apex_frame_centro ?>" class="list-obj">
