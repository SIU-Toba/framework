...
<? echo recurso::imagen_apl($rs->fields["cla_icono"],true,null,null,trim( "CLASE: " . $rs->fields["cla_id"])."  ID: ". $rs->fields['pro_id'] . "-" . $rs->fields["obj_id"]) ?>
		 ...
		 <a href="<? echo $this->vinculador->generar_solicitud("toba","/admin/objetos/checkouts",array( apex_hilo_qs_zona => $rs->fields['pro_id'] .apex_qs_separador. $rs->fields["obj_id"])) ?>" target="<? echo  apex_frame_centro ?>" class="list-obj">
