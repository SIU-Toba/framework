<?
	...
	$vinculo_ut_formulario = $this->vinculador->obtener_vinculo_a_item("toba",
															"/admin/apex/clase_autodoc",
															$clase_ut_formulario );
