...
class dbr_apex_objeto_plan_hito extends db_registros_s
//db_registros especifico de la tabla 'apex_objeto_plan_hito'
{
	function __construct($fuente=null, $min_registros=0, $max_registros=0 )
	{
		$def['tabla']='apex_objeto_plan_hito';
		...
		$def['columna'][6]['nombre']='anotacion';
