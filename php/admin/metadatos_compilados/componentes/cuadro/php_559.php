...
class php_559
{
  ...
  array (
    'titulo' => NULL,
    'subtitulo' => NULL,
    'sql' => 'SELECT tarea_tipo,
descripcion FROM apex_ap_tarea_tipo %w%',
    'columnas_clave' => 'tarea_tipo',
