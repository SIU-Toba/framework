...
class php_561
{
  ...
  array (
    'titulo' => NULL,
    'subtitulo' => NULL,
    'sql' => 'SELECT tarea_estado, descripcion FROM apex_ap_tarea_estado',
    'columnas_clave' => 'tarea_estado',
