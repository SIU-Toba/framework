...
class php_573
{
  ...
  array (
    'titulo' => NULL,
    'subtitulo' => NULL,
    'sql' => 'SELECT objeto_msg, indice, descripcion_corta
FROM apex_objeto_msg  %w%;',
    'columnas_clave' => 'objeto_msg',
    ...
    'tamano_pagina' => NULL,
    'eof_invisible' => NULL,
    'eof_customizado' => 'No existen mensajes asociados al objeto',
