...
class php_581
{
  ...
  array (
    ...
    'nombre' => 'ENTORNO - Checkout ITEMs',
    'titulo' => 'El ITEM se encuentra en los portafolios de',
    'colapsable' => NULL,
    'descripcion' => NULL,
  ...
  array (
    'titulo' => NULL,
    'subtitulo' => NULL,
    'sql' => 'SELECT item_proyecto, item,usuario,creacion FROM apex_et_item %w%',
    'columnas_clave' => 'item, item_proyecto,  usuario',
    ...
    'tamano_pagina' => NULL,
    'eof_invisible' => NULL,
    'eof_customizado' => 'EL ITEM no se encuentra en ningún portafolio.',
