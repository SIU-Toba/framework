...
class php__admin_datos_fuente_sql
{
  ...
  array (
    'item_proyecto' => 'toba',
    'item' => '/admin/datos/fuente_sql',
    'item_nombre' => 'Editor SQL de la fuente',
    ...
    'item_act_accion_script' => 'acciones/admin/datos/fuentes_editor_sql.php',
    ...
    'item_zona_archivo' => 'nucleo/browser/zona/zona_fuente.php',
    'item_publico' => NULL,
