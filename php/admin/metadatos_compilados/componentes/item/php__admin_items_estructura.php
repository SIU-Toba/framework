...
class php__admin_items_estructura
{
  ...
  array (
    'item_proyecto' => 'toba',
    'item' => '/admin/items/estructura',
    'item_nombre' => 'Estructura del ITEM',
    ...
    'item_act_accion_script' => 'acciones/admin/items/estructura.php',
  ...
  array (
    ...
    array (
      ...
      'objeto' => '1401',
      'objeto_nombre' => 'Composicion de un item',
      'objeto_subclase' => 'ci_composicion_item',
      'objeto_subclase_archivo' => 'admin/catalogo/ci_composicion_item.php',
      'orden' => '0',
      'clase_proyecto' => 'toba',
      'clase' => 'objeto_ci',
