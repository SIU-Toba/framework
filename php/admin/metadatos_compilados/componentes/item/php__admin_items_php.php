...
class php__admin_items_php
{
  ...
  array (
    'item_proyecto' => 'toba',
    'item' => '/admin/items/php',
    'item_nombre' => 'ITEM de catalogo',
    'item_descripcion' => 'Codigo PHP de la ACTIVIDAD asociada',
    'item_act_buffer_proyecto' => 'toba',
    'item_act_buffer' => '0',
    'item_act_patron_proyecto' => 'toba',
    'item_act_patron' => 'especifico',
    'item_act_patron_script' => 'NO APLICABLE',
    'item_act_accion_script' => 'acciones/admin/items/php.php',
