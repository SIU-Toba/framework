...
class php__admin_objetos_editores_abms
{
  ...
  array (
    'item_proyecto' => 'toba',
    'item' => '/admin/objetos/editores/abms',
    'item_nombre' => 'OBJETO - Editor MT ABMS',
    ...
    'item_act_accion_script' => 'acciones/admin/objetos/editores/editor_abms.php',
  ...
  array (
    ...
    array (
      'objeto_proyecto' => 'toba',
      'objeto' => '431',
      'objeto_nombre' => 'OBJETO - Editor UT Formulario (ABMS)',
      'objeto_subclase' => NULL,
      'objeto_subclase_archivo' => NULL,
      'orden' => '0',
      'clase_proyecto' => 'toba',
