...
class php__admin_objetos_editores_ut_formulario_bl
{
  ...
  array (
    'item_proyecto' => 'toba',
    'item' => '/admin/objetos/editores/ut_formulario_bl',
    'item_nombre' => 'OBJETOS - Editor de Formulario BL',
    ...
    'item_act_accion_script' => 'acciones/admin/objetos/editores/editor_ut_formulario_bl.php',
  ...
  array (
    ...
    array (
      ...
      'objeto' => '412',
      'objeto_nombre' => 'OBJETO - Editor UT Formulario - EF',
    ...
    array (
      'objeto_proyecto' => 'toba',
      'objeto' => '440',
      'objeto_nombre' => 'OBJETO - Editor UT Formulario (BL)',
      'objeto_subclase' => NULL,
      'objeto_subclase_archivo' => NULL,
      'orden' => '0',
      'clase_proyecto' => 'toba',
