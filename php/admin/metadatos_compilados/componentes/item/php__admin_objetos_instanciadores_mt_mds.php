...
class php__admin_objetos_instanciadores_mt_mds
{
  ...
  array (
    'item_proyecto' => 'toba',
    'item' => '/admin/objetos/instanciadores/mt_mds',
    'item_nombre' => 'OBJETO - Editor de MT Maestro Detalle Simple (MDS)',
    ...
    'item_act_accion_script' => 'acciones/admin/objetos/instanciadores/instanciador_mt_mds.php',
