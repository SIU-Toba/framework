...
class php__admin_usuarios_grupo
{
  ...
  array (
    ...
    'item_act_accion_script' => 'acciones/admin/usuarios/grupo2.php',
    ...
    'item_zona_archivo' => 'nucleo/browser/zona/zona_grupo_acceso.php',
    'item_publico' => NULL,
