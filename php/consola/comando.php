...
class comando
{
     ...
     */
    public function __construct($manejador_interface)
    {
     ...
     * @return string
     */
    public function get_argumentos_string()
    {
        $salida = '';
     ...
     */
    public function set_argumentos($argumentos)
    {
     ...
     * @return null
     */
    public function procesar($opcion = null, $argumentos = null)
    {
        if (! isset($opcion)) {
