...
class comando_base extends comando_toba
{
     ...
     * @return boolean
     */
    public function tiene_definido_base()
    {
     ...
     */
    public function opcion__listar()
    {
     ...
     */
    public function opcion__registrar($parametros = null)
    {
        if (isset($parametros)) {
     ...
     * @gtk_separador 1
     */
    public function opcion__desregistrar()
    {
    ...
    */
    public function opcion__ejecutar_sql($archivo = null)
    {
        if (! isset($archivo)) {
            $param = $this->get_parametros();
    ...
    */
    public function opcion__test_conexion()
    {
        $def = $this->get_id_base_actual();
     ...
     *
     */
    public function opcion__actualizar_secuencias()
    {
    ...
    */
    ...
    public function recuperar_contenido_archivo($nombre)
    {
        $resultado = '';
