...
class comando_instalacion extends comando_toba
{
    ...
    public function recuperar_parametro($lista, $parametro, $leyenda_alternativa)
    {
    ...
    public function mostrar_ayuda_desatendida()
    {
     ...
     */
    public function opcion__instalar()
    {
    ...
    */
    public function opcion__crear_instancia($datos)
    {
     ...
     */
    public function opcion__cambiar_permisos()
    {
     ...
     */
    public function opcion__eliminar_logs()
    {
     ...
     */
    public function opcion__cambiar_id_desarrollador()
    {
