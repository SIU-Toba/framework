...
class comando_instancia extends comando_toba
{
    ...
    * @gtk_no_mostrar 1
    */
    public function opcion__crear($datos = null)
    {
        if (isset($datos)) {
    ...
    */
     ...
     * @return boolean
     */
    public function opcion__verifica_existencia()
    {
        $id_instancia = $this->get_id_instancia_actual();
    ...
    */
    public function opcion__crear_proyecto()
    {
    ...
    */
    public function opcion__cargar_proyecto($datos = null)
    {
    ...
    */
    public function opcion__importar_proyecto($datos = null)
    {
    ...
    */
     ...
     * @gtk_icono exportar.png
     */
    public function opcion__exportar_local()
    {
    ...
    * @gtk_icono importar.png
    */
    public function opcion__cargar()
    {
        try {
    ...
    */
     ...
     */
    public function opcion__crear_usuario($datos = null, $asociar_previsualizacion_admin = true, $id_instancia = null)
    {
        $instancia = $this->get_instancia($id_instancia);
        if (!isset($datos)) {
     ...
     * @param array $datos
     */
    public function opcion__cambiar_clave_usuario($datos = \NULL)
    {
        if (! isset($datos)) {
     ...
     */
    public function opcion__editar_acceso()
    {
        ...
        if (isset($param['-u']) &&  (trim($param['-u']) != '')) {
            ...
            $usuario = $this->consola->dialogo_lista_opciones(
                $usuarios,
                'Seleccionar Usuario',
                false,
                'Nombre de usuario',
     ...
     */
    public function opcion__desbloquear_ips()
    {
        $instancia = $this->get_instancia();
    ...
    public function get_tipo_instancia()
    {
        $tipo = 'normal';
        $param = $this->get_parametros();
