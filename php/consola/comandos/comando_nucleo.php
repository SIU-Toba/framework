...
class comando_nucleo extends comando_toba
{
    ...
    */
    public function opcion__parsear_ddl()
    {
    ...
    * @gtk_icono exportar.png
    */
    public function opcion__migrar_ddl()
    {
    ...
    * @gtk_icono exportar.png
    */
    public function opcion__exportar_datos()
    {
     ...
     * @gtk_icono exportar.png
     */
    public function opcion__parsear_editores()
    {
        //Tomo la referencia a la instancia
        $instancia = $this->get_instancia();
    ...
    * @gtk_icono extension_zip.png
     */
    public function opcion__comprimir_js()
    {
        //Tomo la referencia a la instancia
     ...
     * @gtk_icono tilde.gif
     */
    public function opcion__validar_js()
    {
    ...
    * @gtk_icono compilar.png
     ...
     */
    public function opcion__zipversion()
    {
     ...
     * @consola_parametros -r release -u usuario_svn [-s url_svn] [-t path temporal] [-d path destino]
     */
    public function opcion__versionar()
    {
        $error = null;
        $salida = null;
        $url_svn = 'https://repositorio.siu.edu.ar/svn/toba';
     ...
     */
    public function opcion__comprimir_versiones()
    {
        $error = null;
        $salida = null;
...
//	 			'extends_excluidos' => array() <-- opcional. Las clases que extienden de las clases enumeradas acá no serán incluidas
    ...
    public static function get_path_comparacion()
    {
        return toba_dir().'/temp/sql/resultado.txt';
    }

    public function opcion__foto_schema($parametro = null)
    {
     ...
     */
    public function opcion__compara_foto_schema()
    {
        $base   = $this->consola->dialogo_ingresar_texto('Introduzca la base donde se encuentra el schema');
     ...
     */
    public function opcion__crear_caso_test()
    {
