...
class comando_proyecto extends comando_toba
{
    ...
    public function inspeccionar_opciones($clase = null)
    {
        $opciones = array();
     ...
     * @consola_no_mostrar
     */
    public function opcion__extender_clases_toba()
    {
        $proyecto = $this->get_proyecto();
    ...
    public function opcion__actualizar_proyecto()
    {
        $proyecto = $this->get_proyecto();
     ...
     */
    public function opcion__personalizable()
    {
        $proyecto = $this->get_proyecto();
     ...
     */
    public function opcion__revincular()
    {
     ...
     */
    public function opcion__autoload()
    {
        $params = $this->get_parametros();
        $proyecto = $this->get_proyecto();
    ...
    * @gtk_no_mostrar 1
    */
    public function opcion__cargar($datos = null)
    {
    ...
    */
    public function opcion__exportar()
    {
        $p = $this->get_proyecto();
        $p->exportar();
    ...
    * @gtk_icono importar.png
    */
    public function opcion__regenerar()
    {
    ...
    */
    public function opcion__eliminar()
    {
        $id_proyecto = $this->get_id_proyecto_actual();
        if ($id_proyecto == 'toba') {
     ...
     */
    public function opcion__actualizar()
    {
    ...
    */
    public function opcion__compilar()
    {
     ...
     */
    public function opcion__compilar_perfiles()
    {
        $param = $this->get_parametros();
    ...
    */
    public function opcion__publicar()
    {
        $param = $this->get_parametros();
        $url = '';
        if (isset($param['-u'])) {
    ...
    */
    public function opcion__despublicar()
    {
        if ($this->get_proyecto()->esta_publicado()) {
    ...
    */
    public function opcion__empaquetar()
    {
     ...
     */
    public function opcion__actualizar_login()
    {
        $pm = null;
        $param = $this->get_parametros();
        $proyecto = $this->get_proyecto();
    ...
    * @gtk_no_mostrar 1
    */
    public function opcion__importar($datos = null)
    {
        $destino = null;
        if (isset($datos)) {
            list($id_proyecto, $dir_toba_viejo, $destino) = $datos;
        } else {
            $param = $this->get_parametros();
     ...
     */
    public function opcion__ejecutar_tareas()
    {
        $param = $this->get_parametros();
     ...
     * @gtk_separador 1
     */
    public function opcion__migrar_toba()
    {
        $proyecto = $this->get_proyecto();
        //--- Parametros
        $param = $this->get_parametros();
    ...
    */
    public function opcion__ver_log()
    {
        $param = $this->get_parametros();
     ...
     */
    public function opcion__roles_script()
    {
        $proyecto = $this->get_proyecto();
        try {
