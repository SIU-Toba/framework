...
class comando_servicios_web extends comando_toba
{
     ...
     */
    public function opcion__serv_generar_doc()
    {
     ...
     */
    public function opcion__serv_configurar()
    {
     ...
     *
     */
    public function opcion__generar_cert()
    {
        $parametros = $this->get_parametros();
     ...
     */
    public function opcion__cli_configurar()
    {
        $parametros = $this->get_parametros();
        $tipo = (isset($parametros['--tipo_ws'])) ? $parametros['--tipo_ws'] : 'soap';
