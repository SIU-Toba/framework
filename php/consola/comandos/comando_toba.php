...
class comando_toba extends comando
{
    ...
    public function __construct($manejador_interface, $interprete = null)
    {
    ...
    */
    protected function get_proyecto($id_proy = null)
    {
        ...
        return toba_modelo_catalogo::instanciacion()->get_proyecto(
    ...
    */
    ...
    public function set_id_instancia_actual($id)
    {
    ...
    */
    protected function seleccionar_base()
    {
        ...
        if (count($bases) > 0) {
            ...
            $defecto = key($bases);
            return $this->consola->dialogo_lista_opciones(
                $bases,
                $titulo,
                false,
                $cabecera_tabla,
    ...
    */
    protected function seleccionar_proyectos($seleccion_multiple = true, $obligatorio = false)
    {
        ...
        if (count($proyectos) > 0) {
            $sel = $this->consola->dialogo_lista_opciones(
                $proyectos,
                $titulo,
                $seleccion_multiple,
                'Nombre real del proyecto',
                $obligatorio,
                array_keys($proyectos),
                'todos'
            );
