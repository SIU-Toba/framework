...
class consola implements toba_proceso_gui
{
    ...
    public function __construct($ubicacion_comandos, $clase_menu)
    {
    ...
    public function get_ubicacion_comandos()
    {
    ...
    public function invocar_comando($nombre_comando, $argumentos)
    {
    ...
    */
    public function coleccion($coleccion)
    {
    ...
    *	Dumpea un ARBOL
    */
    public function dump_arbol($arbol, $titulo)
    {
        $this->enter();
    ...
    */
    ...
    public function lista_asociativa($lista, $titulo = null)
    {
        if (count($lista) > 0) {
            $i = 0;
    ...
    public function tabla($tabla, $titulos)
    {
        if (count($tabla) > 0) {
    ...
    public function dialogo_simple($texto, $defecto = null, $extra = null)
    {
    ...
    public function dialogo_ingresar_texto($categoria, $obligatorio = true)
    {
        do {
    ...
    */
    public function dialogo_lista_opciones(
        $opciones,
        $texto,
    ...
    public function get_formulario($titulo)
    {
