...
class formulario_consola
{
    ...
    public function __construct($manejador_interface, $titulo)
    {
        $this->interface = $manejador_interface;
        $this->titulo = $titulo;
    }

    public function agregar_campo($parametros)
    {
    ...
    public function corregir_valores()
    {
    }

    public function tiene_campos()
    {
        return (isset($this->campos) && is_array($this->campos) && !empty($this->campos));
    }

    public function desactivar_confirmacion_datos()
    {
