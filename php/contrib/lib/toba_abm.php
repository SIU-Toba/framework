...
class toba_abm
{
    protected static function get_valor_sql($valor)
    {
        if ($valor === null) {
            return 'NULL';
    ...
    public static function get_sql_alta($tabla, $datos)
    {
    ...
    public static function get_sql_baja($tabla, $clave)
    {
    ...
    public static function get_sql_modificacion($tabla, $datos, $clave)
    {
        $where = self::get_where_de_clave($clave);
        $valores = array();
     ...
     */
    public static function get_sql_cant_registros($tabla, $clave, $clave_excluir = null)
    {
        $where = self::get_where_de_clave($clave);
    ...
    public static function get_where_de_clave($clave)
    {
        $where = 'TRUE';
        if (! empty($clave)) {
            $where = array();
