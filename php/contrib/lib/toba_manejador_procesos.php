...
class toba_manejador_procesos
{
     ...
     * @return type
     */
    public static function buscar_pids($match)
    {
        if (strtoupper(substr(PHP_OS, 0, 3)) === 'WIN') {
     ...
     * @return string
     */
    public static function crear_identificador($id)
    {
     ...
     * @return mixed
     */
    public static function quitar_identificador($cadena)
    {
     ...
     * @ignore
     */
    public static function background_linux($command)
    {
     ...
     * @ignore
     */
    public static function is_running_linux($PID)
    {
     ...
     * @ignore
     */
    public static function kill_linux($PID)
    {
     ...
     * @ignore
     */
    public static function buscar_pids_linux($match)
    {
     ...
     * @ignore
     */
    public static function background_win($command)
    {
     ...
     * @ignore
     */
    public static function is_running_win($pid)
    {
        //NO IMPLEMENTADO
        return false;
    }
     ...
     * @ignore
     */
    public static function kill_win($pid)
    {
        //NO IMPLEMENTADO
        return false;
    }
     ...
     * @ignore
     */
    public static function buscar_pids_win($match)
    {
        //NO IMPLEMENTADO
        return array();
    }
