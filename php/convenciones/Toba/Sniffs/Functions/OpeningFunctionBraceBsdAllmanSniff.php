...
/**
 * Toba_Sniffs_Functions_OpeningFunctionBraceBsdAllmanSniff.
 *
...
class Toba_Sniffs_Functions_OpeningFunctionBraceBsdAllmanSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if ($braceIndent !== $startColumn) {
            $error = '[Indentacion] Opening brace indented incorrectly; expected '.($startColumn - 1).' tabs, found '.($braceIndent - 1). ' spaces';
            $phpcsFile->addError($error, $openingBrace);
        }
