...
class toba_gtk_admin
{
    ...
    public function __construct($toba_instalador, $progreso)
    {
    ...
    public function construir_dialogo($id_proyecto = null)
    {
     ...
     */
    public function cargar_comandos($seleccionar_proyecto = null)
    {
    ...
    public function evt__mostrar_opciones()
    {
    ...
    public function evt__seleccionar_comando($seleccion)
    {
        if ($this->inicial) {
    ...
    public function evt__ejecutar($item, $opcion, $atributos)
    {
    ...
    public function evt__progreso__cancelar()
    {
        $this->evt__progreso__cerrar();
    }

    public function evt__progreso__cerrar()
    {
        $this->progreso->cerrar();
        unset($this->progreso);
    ...
    public function dialogo_registrar_base()
    {
