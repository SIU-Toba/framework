...
class toba_gtk_registrar_base
{
    ...
    public function __construct($toba_instalador)
    {
    ...
    public function evt__cambiar_instancia()
    {
    ...
    public function evt__cambiar_proyecto()
    {
        $combo = $this->comp['combo_instancia'];
        $iter = $combo->get_active_iter();
        $modelo = new GtkListStore(Gtk::TYPE_STRING);
    ...
    public function evt__cambiar_fuente()
    {
    ...
    public function evt__cambiar_reutilizar()
    {
        $combo = $this->comp['combo_reutilizar'];
        $iter = $combo->get_active_iter();
        $modelo = new GtkListStore(Gtk::TYPE_STRING);
    ...
    public function evt__cambiar_tipo()
    {
    ...
    public function evt__tomar_definicion()
    {
