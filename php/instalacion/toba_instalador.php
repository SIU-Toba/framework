...
{
    protected static $indice_archivos;
    protected $progreso;

    public function __construct($progreso = null)
    {
        if (! isset($progreso)) {
    ...
    public function set_conexion($base)
    {
        toba_modelo_instalacion::set_conexion_externa($base);
    }


    public function set_progreso($progreso)
    {
        if (isset($progreso)) {
    ...
    public static function cargador_clases($clase)
    {
    ...
    public function cargar_includes_basicos()
    {
    ...
    public function get_comp_administracion($id_proyecto = null)
    {
     ...
     */
    public function instalacion_exportar($excluir_internos = true)
    {
     ...
     */
    public function instalacion_regenerar()
    {
        $instalacion = $this->get_instalacion();
        foreach ($instalacion->get_lista_instancias() as $id_inst) {
            $instancia = $instalacion->get_instancia($id_inst);
     ...
     */
    public function instalacion_eliminar_instancias()
    {
        $instalacion = $this->get_instalacion();
        foreach ($instalacion->get_lista_instancias() as $id_inst) {
            $instancia = $instalacion->get_instancia($id_inst);
    ...
    public function instalacion_migrar($version)
    {
     ...
     */
    public function crear_instalacion_e_instancia($nombre_instancia, $datos_motor, $grupo)
    {
        $instalacion = $this->get_instalacion();
    ...
    public function crear_instancia($nombre_instancia, $datos_motor)
    {
        $nombre_toba = 'toba_'.toba_modelo_instalacion::get_version_actual()->get_string_partes();
     ...
     */
    public function proyecto_cargar_e_instalar($proy_id, $proy_path, $nombre_instancia, $datos_motor, $url = null)
    {
        $instalacion = $this->get_instalacion();
     ...
     */
    public function proyecto_exportar_local($proy_id)
    {
        $instalacion = $this->get_instalacion();
     ...
     * @param string $proy_id
     */
    public function proyecto_exportar($proy_id)
    {
        $instalacion = $this->get_instalacion();
        foreach ($instalacion->get_lista_instancias() as $id_instancia) {
            $instancia = $this->get_instancia($id_instancia);
     ...
     * @param string $proy_id
     */
    public function proyecto_eliminar($proy_id, $desinstalar)
    {
        $instalacion = $this->get_instalacion();
        foreach ($instalacion->get_lista_instancias() as $id_instancia) {
            $instancia = $this->get_instancia($id_instancia);
     ...
     * @param string $proy_id
     */
    public function proyecto_regenerar($proy_id)
    {
        $instalacion = $this->get_instalacion();
        foreach ($instalacion->get_lista_instancias() as $id_instancia) {
            $instancia = $this->get_instancia($id_instancia);
     ...
     * @param string $proy_id
     */
    public function proyecto_migrar($proy_id, $version_numero)
    {
