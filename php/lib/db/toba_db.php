...
class toba_db
{
     ...
     */
    public function __construct($profile, $usuario, $clave, $base, $puerto = null, $server = '', $sslmode = '', $cert_path = '', $key_path = '', $crl_path = '', $cacert_path = '')
    {
     ...
     */
    public function set_parser_errores(toba_parser_error_db $parser)
    {
    ...
    */
     ...
     * @return string
     */
    public function dsn_parameters_implode($delimitador, $arreglo)
    {
        $text = '';
     ...
     */
    public function set_modo_debug($debug = true, $loguear = true)
    {
        $this->debug = $debug;
     ...
     */
    public function reset_info_debug()
    {
     ...
     */
    public function set_logger($log)
    {
        $this->logger = $log;
    }
     ...
     * @return array
     */
    public function get_info_debug()
    {
     ...
     */
    public function activar_registro_ejecucion($desactivar_ejecucion = false, $activar = true)
    {
     ...
     * @param boolean $activar TRUE activa el resgistro, FALSE desactiva el registro. Por defecto TRUE
     */
    public function activar_registro_consulta($desactivar_consulta = false, $activar = true)
    {
     ...
     */
    public function exportar_registro($archivo_ejecucion = '', $archivo_consulta = '')
    {
        try {
            // Validaciones
    ...
    *	@throws toba_error_db en caso de que algun comando falle
    */
    public function sentencia($sql, $parametros = null)
    {
        $afectados = 0;
        $sql = $this->pegar_estampilla_log($sql);
        try {
    ...
    *	@throws toba_error_db en caso de error
    */
    public function consultar($sql, $tipo_fetch = toba_db_fetch_asoc)
    {
        if (is_null($sql)) {
    ...
    *	@throws toba_error_db en caso de error
    */
    public function consultar_fila($sql, $tipo_fetch = toba_db_fetch_asoc, $lanzar_excepcion = true)
    {
        if (is_null($sql)) {
            //toba::logger()->error(' En el parametro donde se esperaba la SQL llego un null, verificar');
            $this->log(' En el parametro donde se esperaba la SQL llego un null, verificar', 'error');
    ...
    */
    public function ejecutar_archivo($archivo)
    {
    ...
    *	@throws toba_error_db en caso de error
    */
    public function sentencia_preparar($sql, $opciones = array())
    {
     ...
     */
    public function sentencia_agregar_binarios($id, $binarios = array())
    {
     ...
     */
    public function sentencia_eliminar($id)
    {
    ...
    *	@throws toba_error_db en caso de error
    */
    public function sentencia_ejecutar($id, $parametros = null)
    {
        if (!isset($this->sentencias[$id]['id'])) {
            throw new toba_error("La sentencia solicitada no existe.");
        }
    ...
    *	@throws toba_error_db en caso de error
    */
    public function sentencia_consultar($id, $parametros = null, $tipo_fetch = toba_db_fetch_asoc)
    {
        if (!isset($this->sentencias[$id]['id'])) {
            throw new toba_error("La sentencia solicitada no existe.");
        }
    ...
    *	@throws toba_error_db en caso de error
    */
    public function sentencia_consultar_fila($id, $parametros = null, $tipo_fetch = toba_db_fetch_asoc, $lanzar_excepcion = true)
    {
        if (!isset($this->sentencias[$id]['id'])) {
            throw new toba_error("La sentencia solicitada no existe.");
        }
    ...
    *	@return array Resultado de la consulta en formato recordset (filas x columnas)
    */
    public function sentencia_datos($id, $tipo_fetch = toba_db_fetch_asoc)
    {
        if (!isset($this->sentencias[$id]['id'])) {
            throw new toba_error("La sentencia solicitada no existe.");
        }
    ...
    *	@return integer Cantidad de registros afectados
    */
    public function sentencia_cantidad_afectados($id)
    {
        if (!isset($this->sentencias[$id]['id'])) {
            throw new toba_error("La sentencia solicitada no existe.");
        }
     ...
     *	@throws toba_error_db en caso de error
     */
    public function consultar_sentencia(string $sql, array $parametros): mixed
    {
     ...
     *	@throws toba_error_db en caso de error
     */
    public function ejecutar_sentencia(string $sql, array $parametros): mixed
    {
        $id = $this->sentencia_preparar($sql, []);
    ...
    */
    public function ejecutar_transaccion($sentencias_sql)
    {
     ...
     * @return string
     */
    public function recuperar_secuencia($secuencia)
    {
        throw new toba_error("No implementado para el motor: $this->motor");
    }
     ...
     */
    public function retrazar_constraints()
    {
     ...
     */
    public function get_definicion_columnas($tabla)
    {
        throw new toba_error("No implementado para el motor: $this->motor");
    }
    ...
    *	Adaptado de ADOdb
    */
    public function get_tipo_datos_generico($tipo)
    {
     ...
     */
    public function get_sql_carga_tabla($tabla)
    {
     ...
     * @return array(sql, campo_clave, campo_descripcion)
     */
    public function get_sql_carga_descripciones($tabla)
    {
     ...
     * @return array
     */
    public function get_opciones_sql_campo_externo($campo)
    {
    ...
    * @throws toba_error si no esta implementado
    */
    public function get_error_toba($codigo, $descripcion)
    {
        throw new toba_error("No implementado para el motor: $this->motor");
    }
