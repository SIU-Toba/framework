...
class toba_db_postgres7 extends toba_db
{
     ...
     */
    public function __construct($profile, $usuario, $clave, $base, $puerto, $server = '', $sslmode = '', $cert_path = '', $key_path = '', $crl_path = '', $cacert_path = '')
    {
     ...
     * @return array
     */
    public function get_config_certificados()
    {
        $certs = array();
    ...
    * @return mixed
    */
    public function set_schema($schema, $ejecutar = true, $fallback_en_public = false)
    {
        $this->schema = $schema;
     ...
     */
    public function set_encoding($encoding, $ejecutar = true)
    {
     ...
     */
    public function set_datestyle_iso()
    {
     ...
     */
    public function crear_lenguaje_procedural()
    {
    ...
    */
    public function recuperar_secuencia($secuencia, $ejecutar = true)
    {
     ...
     */
    public function recuperar_nuevo_valor_secuencia($secuencia, $ejecutar = true)
    {
     ...
     */
    public function retrazar_constraints($retrazar = true)
    {
     ...
     */
    public function retrasar_constraints($retrasar = true)
    {
     ...
     */
    public function abortar_transaccion()
    {
     ...
     * @return boolean
     */
    public function transaccion_abierta()
    {
     ...
     * @param string $nombre
     */
    public function agregar_savepoint($nombre)
    {
     ...
     * @param string $nombre
     */
    public function abortar_savepoint($nombre)
    {
     ...
     * @param string $nombre
     */
    public function liberar_savepoint($nombre)
    {
    ...
    */
    public function insert_masivo($tabla, $datos, $delimitador = "\t", $valor_nulo = "\\N")
    {
        $funciono = true;
     ...
     * @return resource
     */
    public function get_pg_connect_nativo()
    {
        $puerto = ($this->puerto != '') ? "port={$this->puerto}" : '';
     ...
     * @return boolean
     */
    public function existe_schema($esquema)
    {
     ...
     */
    public function borrar_schema($schema, $ejecutar = true)
    {
     ...
     * @param mixed $schema
     */
    public function borrar_schema_si_existe($schema)
    {
     ...
     * @return mixed				Estado de la ejecucion o sentencia generada
     */
    public function crear_schema($schema, $ejecutar = true)
    {
     ...
     * @return mixed				Estado de la ejecucion o sentencia generada
     */
    public function renombrar_schema($actual, $nuevo, $ejecutar = true)
    {
     ...
     * @return array
     */
    public function get_lista_schemas_disponibles()
    {
     ...
     * @return boolean
     */
    public function existe_lenguaje($lang)
    {
     ...
     */
    public function crear_lenguaje($lang)
    {
     ...
     * @return string
     */
    public function get_rol_actual()
    {
        $sql = 'SHOW ROLE;';
     ...
     * @return mixed
     */
    public function set_rol($rol, $ejecutar = true)
    {
        $sql = "SET ROLE $rol;";
        if (! $ejecutar) {
            return $sql;
     ...
     * @return boolean
     */
    public function existe_rol($rol)
    {
     ...
     * @return array
     */
    public function listar_roles($rol = null)
    {
     ...
     * @return mixed
     */
    public function crear_rol($rol, $ejecutar = true)
    {
     ...
     * @return mixed
     */
    public function crear_usuario($rol, $password, $ejecutar = true)
    {
     ...
     * @return mixed
     */
    public function borrar_rol($rol, $ejecutar = true)
    {
     ...
     * @return mixed
     */
    public function grant_rol($usuario, $rol, $ejecutar = true)
    {
     ...
     * @return mixed
     */
    public function grant_schema($usuario, $schema, $permisos = 'USAGE', $ejecutar = true)
    {
     ...
     * @return mixed
     */
    public function revoke_schema($usuario, $schema, $permisos = 'ALL PRIVILEGES', $ejecutar = true)
    {
        $sql = array();
    ...
    public function revoke_tablas($usuario, $schema, $tablas, $permisos = 'ALL PRIVILEGES', $ejecutar = true)
    {
        $sql = array();
     ...
     * @return mixed
     */
    public function revoke_rol($usuario, $rol, $ejecutar = true)
    {
     ...
     */
    public function grant_tablas_schema($usuario, $schema, $privilegios = 'ALL PRIVILEGES')
    {
        $sql = "SELECT
					relname
				FROM pg_class c
     ...
     * @return mixed
     */
    public function grant_tablas($usuario, $schema, $tablas, $privilegios = 'ALL PRIVILEGES', $ejecutar = true)
    {
        $sql = array();
        foreach ($tablas as $tabla) {
     ...
     * @return string
     */
    public function grant_sp_schema($usuario, $schema, $privilegios = 'ALL PRIVILEGES', $ejecutar = true)
    {
     ...
     * @return string
     */
    public function revoke_sp_schema($usuario, $schema, $privilegios = 'ALL PRIVILEGES', $ejecutar = true)
    {
        $stored_procedures = $this->get_sp_schema($schema);				//Busco todos los stored procedures del schema
     ...
     * @return array
     */
    public function get_sp_schema($schema)
    {
        $sql = "SELECT
											proname
						 FROM pg_proc p
     ...
     * @return array
     */
    public function get_lista_tablas_y_vistas()
    {
        $esquema = null;
        if (isset($this->schema)) {
            $esquema = $this->schema;
     ...
     * @return array
     */
    public function get_lista_tablas($incluir_vistas = false, $esquema = null)
    {
     ...
     * @return array
     */
    public function get_lista_tablas_bd($incluir_vistas = false, $esquema = null)
    {
        $sql_esquema = '';
        if (! is_null($esquema)) {
            $esquema = $this->quote($esquema);
     ...
     * @return boolean
     */
    public function existe_tabla($schema, $tabla)
    {
     ...
     * @return boolean
     */
    public function existe_columna($columna, $tabla)
    {
        $tabla = $this->quote($tabla);
        $sql = "
    ...
    * @throws toba_error
    */
    public function get_definicion_columnas($tabla, $esquema = null)
    {
        $where = '';
        if (isset($esquema)) {
            $esquema = $this->quote($esquema);
     ...
     * @return string
     */
    public function get_semantica_valor_defecto()
    {
        return 'DEFAULT';
    }
     ...
     * @param string $schema
     */
    public function get_secuencia_tabla($tabla, $schema = null)
    {
     ...
     * @return array
     */
    public function get_secuencia_tablas($tablas, $schema = null)
    {
        $secuencias = array();
     ...
     * @return array
     */
    public function get_triggers_schema($schema, $nombre = '', $estado = 'O', $tablas = array())
    {
        $where = array();
     ...
     * @return array
     */
    public function pgdump_get_tabla($bd, $schema, $tabla, $host, $usuario, $pass = null)
    {
        $exito = 0;
     ...
     * @return object
     */
    public function get_manejador_auditoria($schema_modelo = 'public', $schema_auditoria = 'public_auditoria', $schema_toba = null)
    {
