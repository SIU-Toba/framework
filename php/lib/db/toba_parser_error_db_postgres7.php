...
class toba_parser_error_db_postgres7 extends toba_parser_error_db
{
     ...
     */
    public function set_mostrar_nombres_campos($mostrar)
    {
     ...
     * @return mixed
     */
    public function parsear($sql, $sqlstate, $mensaje)
    {
     ...
     * @return array
     */
    public function get_comentario_campos($tabla, $posiciones = null)
    {
     ...
     * @ignore
     */
    public function parsear_sqlstate_23505($accion, $sql, $mensaje)
    {
     ...
     * @ignore
     */
    public function get_mensaje_pk($accion, $pk)
    {
     ...
     * @ignore
     */
    public function get_datos_pk($pk)
    {
     ...
     * @ignore
     */
    public function parsear_sqlstate_23503($accion, $sql, $mensaje)
    {
     ...
     * @ignore
     */
    public function get_mensaje_fk($es_alta, $accion, $tabla_local, $fk, $tabla_foranea = null)
    {
     ...
     * @ignore
     */
    public function get_datos_fk($tabla_local, $fk, $tabla_foranea)
    {
     ...
     * @ignore
     */
    public function parsear_sqlstate_23502($accion, $sql, $mensaje)
    {
        if (preg_match("/.*{$this->sep_ini}(.*){$this->sep_fin}.*/", $mensaje, $partes)) {
     ...
     * @return string
     */
    public function get_mensaje_not_null($accion, $campo)
    {
        $mensaje = "Error $accion. ";
