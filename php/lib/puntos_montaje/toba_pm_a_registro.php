...
{
    public static function insert(toba_punto_montaje $punto, $db)
    {
    ...
    public static function update(toba_punto_montaje $punto, $db)
    {
    ...
    public static function delete(toba_punto_montaje $punto, $db)
    {
