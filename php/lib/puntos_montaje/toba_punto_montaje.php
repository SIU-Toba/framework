...
{
    public const tipo_proyecto		= 'proyecto_toba';
    public const tipo_pers		= 'pers_proyecto_toba';
     ...
     */
    public function set_proyecto($proyecto_id)
    {
     ...
     */
    public function set_instancia_toba($obj_instancia)
    {
     ...
     */
    public function instancia_toba()
    {
     ...
     * @ignore
     */
    public function set_etiqueta_anterior($etiqueta)
    {
     ...
     * @ignore
     */
    public function get_etiqueta_anterior()
    {
     ...
     * @ignore
     */
    public function tiene_etiqueta_anterior()
    {
    ...
    public function get_path()
    {
        if (empty($this->path)) {
            ...
            if (!isset($datos[$nombre])) {
                ...
                throw new toba_error('Punto de montaje: el punto de montaje no existe en la configuración. Revise el log');
            }
     ...
     * @return boolean
     */
    public function es_de_proyecto()
    {
