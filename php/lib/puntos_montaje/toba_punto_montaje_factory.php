...
class toba_punto_montaje_factory
{
     ...
     */
    public static function construir($registro)
    {
        $tipo = $registro['tipo'];
     ...
     */
    protected static function construir_indefinido($registro)
    {
     ...
     */
    protected static function construir_proyecto($registro)
    {
     ...
     */
    protected static function construir_pers($registro)
    {
