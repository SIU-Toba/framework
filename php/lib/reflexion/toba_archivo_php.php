...
class toba_archivo_php
{
     ...
     * @return boolean
     */
    public function contiene_codigo_php()
    {
        $macheos = array();
     ...
     * @return boolean
     */
    public function contiene_clase($nombre)
    {
     ...
     * @return boolean
     */
    public function contiene_metodo($nombre)
    {
        $contenido = file_get_contents($this->nombre);
    ...
    public function get_codigo_php_puro()
    {
     ...
     */
    public function edicion_inicio()
    {
     ...
     */
    public function insertar_al_inicio($codigo)
    {
     ...
     */
    public function insertar_al_final($codigo)
    {
    ...
    */
    public static function reemplazar_metodo(String $codigo, String $nombre_metodo_a_extraer, String $codigo_a_insertar)
    {
        $contenido = explode("\n", $codigo);
        ...
        foreach ($contenido as $linea => $codigo) {
            ...
            if ($encontrado) {
                if (!$comenzo_cuerpo && (strpos($codigo, '{') !== false)) {
                    $comenzo_cuerpo = true;
                }
     ...
     */
    public static function codigo_get_metodo(String $codigo, $nombre_metodo_a_extraer)
    {
        $contenido = explode("\n", $codigo);
        $encontrado = false;
        $comenzo_cuerpo = false;
     ...
     */
    public static function codigo_tiene_metodo(String $codigo, String $nombre)
    {
     ...
     * Determina si una porción de código tiene un método específico
     */
    public static function codigo_tiene_metodo_js(String $codigo, String $nombre)
    {
     ...
     * Determina si una porción de código tiene un método específico
     */
    public static function codigo_tiene_codigo(String $actual, String $codigo)
    {
     ...
     */
    public static function codigo_tiene_clase(String $codigo, String $nombre)
    {
     ...
     */
    public static function codigo_get_nombre_metodos(String $codigo, $solo_publicos = true)
    {
        $no_publicos = '';
        if ($solo_publicos) {
            $no_publicos = '';
     ...
     */
    public static function codigo_agregar_metodo(String $codigo_actual, String $metodo)
    {
    ...
    public static function codigo_quitar_identacion(String $codigo, $identacion = 1)
    {
        $salida = array();
        foreach (explode("\n", $codigo) as $linea) {
            $linea_salida = '';
     ...
     */
    public static function codigo_sacar_tags_php(String $codigo)
    {
        $codigo = str_replace('<?php', '', $codigo);
        return trim(str_replace('?>', '', $codigo));
    }

    public static function convertir_formato_interno($nombre_archivo)
    {
    ...
    public static function convertir_formato_so(String $contenido_archivo)
    {
