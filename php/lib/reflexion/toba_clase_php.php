...
class toba_clase_php
{
    ...
    public function __construct($archivo, $meta_clase)
    {
    ...
    */
    public function get_lista_metodos_posibles()
    {
    ...
    *	Genera la clase
    */
    public function generar($opciones, $incluir_comentarios, $incluir_separadores = true)
    {
    ...
    public function get_codigo($opciones, $incluir_comentarios, $incluir_separadores = true)
    {
        $existente = null;
