...
{
    public const registro_insert = 'registro_insert';
    public const registro_update = 'registro_update';
    public const registro_delete = 'registro_delete';
     ...
     * @param string $param
     */
    public function set_conversion_auto_latin1($param)
    {
    ...
    public function add_columna($columna, $valor)
    {
        if (empty($columna)) {
     ...
     * @return mixed
     */
    public function get_valor($columna)
    {
    ...
    public function analizar_conflictos()
    {
     ...
     */
    public function get_conflictos()
    {
    ...
    public function tiene_conflictos()
    {
        return count($this->get_conflictos()) > 0;
    }

    public function get_conflicto_irresoluble()
    {
    ...
    public function get_conflictos_solubles()
    {
        $conflictos = $this->get_conflictos();
        $acumulador = array();
        foreach ($conflictos as $conflicto) {
