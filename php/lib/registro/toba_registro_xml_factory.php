...
{
    public static function construir($db, $nombre_tabla, $registro_xml)
    {
    ...
    protected static function get_estado($registro_xml)
    {
    ...
    protected static function construir_insert($db, $nombre_tabla, $registro_xml)
    {
    ...
    protected static function construir_update($db, $nombre_tabla, $registro_xml)
    {
    ...
    protected static function construir_delete($db, $nombre_tabla, $registro_xml)
    {
    ...
    protected static function add_columnas($registro, $registro_xml)
    {
    ...
    protected static function init_valores_originales($registro, $registro_xml)
    {
        $tag_nombre	= toba_pers_xml_atributos::nombre;
    ...
    protected static function init_claves($registro, $registro_xml)
    {
