...
class toba_asercion
{
    public static function no_es_nulo($variable, $texto = "ATENCION, el elemento es NULO")
    {
        if (!isset($variable)) {
    ...
    public static function es_objeto($instancia, $texto = "ATENCION, el elemento no es un OBJETO")
    {
    ...
    public static function es_array($array, $texto = "ATENCION, el elemento no es un ARRAY", $en_lugar_de = false)
    {
        if (!is_array($array)) {
            if ($en_lugar_de) {
    ...
    public static function arrays_igual_largo($array_1, $array_2, $texto = "ATENCION, los arrays no tienen el mismo tamaño")
    {
    ...
    public static function es_array_dimension($array, $dimension, $texto = "ERROR: ")
    {
        if (!is_array($array)) {
    ...
    public static function es_array_o_null($array, $texto = "ATENCION, el elemento no es un ARRAY y no es NULO")
    {
        if (is_null($array)) {
            return;
        }
