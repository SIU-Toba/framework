...
class toba_config
{
    ...
    protected static $pattern_gral = '~(\$env\()(.*?)(\)\$)~';
     ...
     * @param path $file
     */
    public function add_config_file($index, $file): void
    {
        if (file_exists($file)) {
     ...
     * @return mixed
     */
    public function get_parametro($seccion = null, $subseccion = null, $parametro = null)
    {
     ...
     * @return mixed
     */
    public function get_subseccion($seccion, $subseccion)
    {
     ...
     * @return boolean
     */
    public function existe_valor($seccion = null, $subseccion = null, $parametro = null): bool
    {
