...
class toba_editor_texto
{
     ...
     */
    public function agregar_sustitucion($texto_buscado, $texto_reemplazo)
    {
...
class toba_editor_archivos extends toba_editor_texto
{
     ...
     */
    public function procesar_archivo($archivo, $archivo_resultado = null)
    {
     ...
     */
    public function procesar_archivos($archivos)
    {
