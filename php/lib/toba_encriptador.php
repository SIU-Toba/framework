...
class toba_encriptador
{
     ...
     */
    public function cifrar($no_encriptado, $clave = "get")
    {
     ...
     * @deprecated desde version 3.0.11
     */
    public function descifrar($encriptado, $clave = "get")
    {
     ...
     * @return mixed
     */
    public function cifrar_para_web($no_encriptado, $clave)
    {
     ...
     * @return mixed
     */
    public function descifrar_para_web($encriptado, $clave)
    {
     ...
     * @return mixed
     */
    public function encriptar($dato, $clave)
    {
     ...
     * @return mixed
     */
    public function desencriptar($dato, $clave)
    {
        if (! extension_loaded('php_openssl') && ! extension_loaded('Openssl')) {
            throw new toba_error('La extensión para openssl no se encuentra cargada, verifique la instalación.');
        }
     ...
     * @param type $algo
     */
    public function set_algoritmo($algo)
    {
     ...
     * @param type $formato
     */
    public function set_formato_retorno($formato)
    {
