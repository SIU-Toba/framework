...
class toba_extractor_clases
{
    ...
    public function __construct($puntos_montaje)
    {
     ...
     * encontrados
     */
    public function get_pms_no_encontrados()
    {
     ...
     * @return array
     */
    public function get_clases_repetidas()
    {
     ...
     */
    public function set_extends_excluidos($extends)
    {
