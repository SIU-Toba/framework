...
class toba_fecha
{
     ...
     * @return toba_fecha
     */
    public static function desde_pantalla($fecha)
    {
    ...
    public function get_fecha_desplazada_años($anios)
    {
    ...
    public function diferencia_dias($fecha2)
    {
    ...
    public static function convertir_fecha_a_timestamp($fecha)
    {
    ...
    public static function convertir_timestamp_a_fecha($timestamp)
    {
    ...
    public static function convertir_timestamp_a_hora($timestamp)
    {
    ...
    public function get_diferencia($fecha2)
    {
