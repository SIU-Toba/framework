...
class toba_ini
{
     ...
     * @return mixed
     */
    public function existe_entrada($seccion, $nombre = null)
    {
        if (! isset($nombre)) {
     ...
     * @param mixed $datos
     */
    public function agregar_entrada($nombre, $datos)
    {
     ...
     * @throws toba_error
     */
    public function eliminar_entrada($nombre)
    {
     ...
     * @throws toba_error
     */
    public function get_datos_entrada($nombre)
    {
        if (isset($this->entradas[ $nombre ])) {
     ...
     * @throws toba_error
     */
    public function get($seccion, $clave = null, $defecto = null, $obligatorio = true)
    {
     ...
     * @throws toba_error
     */
    public function set_datos_entrada($nombre, $datos)
    {
        if (isset($this->entradas[ $nombre ])) {
            $this->entradas[ $nombre ] = $datos;
        } else {
     ...
     * @param array $datos
     */
    public function set_entradas($datos)
    {
        $this->entradas = $datos;
    }
