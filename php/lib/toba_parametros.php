...
class toba_parametros
{
     ...
     * @return mixed
     */
    public static function get_redefinicion_parametro($proyecto, $parametro, $obligatorio)
    {
     ...
     * @return mixed
     */
    public static function get_redefinicion_parametro_runtime($proyecto, $seccion, $parametro = null, $obligatorio = true)
    {
     ...
     * @return integer
     */
    public static function get_largo_pwd($proyecto)
    {
     ...
     * @return integer
     */
    public static function get_clave_validez_minima($proyecto)
    {
     ...
     * @return integer
     */
    public static function get_clave_validez_maxima($proyecto)
    {
     ...
     * @return integer
     */
    public static function get_nro_claves_no_repetidas($proyecto)
    {
     ...
     * @return integer
     */
    public static function get_session_no_interaccion($proyecto)
    {
     ...
     * @return integer
     */
    public static function get_session_tiempo_maximo($proyecto)
    {
     ...
     * @return integer
     */
    public static function get_intentos_validacion($proyecto)
    {
     ...
     * @return integer
     */
    public static function get_debe_bloquear_usuario($proyecto)
    {
     ...
     * @return integer
     */
    public static function get_ventana_intentos($proyecto)
    {
