...
class toba_sincronizador_archivos
{
    ...
    public function __construct($dir, $patron_archivos = null)
    {
        $this->dir = $dir;
    ...
    {
        $this->archivos_originales = toba_manejador_archivos::get_archivos_directorio(
            $this->dir,
    ...
    */
    ...
    public function sincronizar_agregados()
    {
        if (! $this->activado) {
            return array("El directorio '$this->dir' no existe.");
        }
