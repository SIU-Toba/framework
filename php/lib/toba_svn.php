...
class toba_svn
{
    ...
    public function ejecucion_mensaje($datos)
    {
        if ($datos != '') {
    ...
    public function ejecucion_error($datos)
    {
        $datos = $this->desde_consola($datos);
    ...
    public function ejecucion_cancelar()
    {
        $this->cancelado = true;
    ...
    public function probar_conexion($url, $usuario, $clave)
    {
    ...
    public function hay_cliente_svn()
    {
        $cmd = "svn --version";
        try {
            $ok = $this->ejecutar($cmd, false, true, false);
    ...
    public function verificar_cliente_svn()
    {
    ...
    public function get_estado($path)
    {
        try {
            $cmd = "svn st \"$path\" --xml";
    ...
    public function get_revision($path)
    {
        $cmd = "svn info \"$path\" --xml";
        try {
            $xml_rs = $this->ejecutar($cmd, true, true);
    ...
    public function get_revisiones_dir_recursivos($path)
    {
        $revs = array();
    ...
    public function reducir_url($url)
    {
        $base = $this->url_base;
        $pos = strpos($url, $base);
        if ($pos === false) {
    ...
    public static function es_copia_trabajo($path)
    {
        $salida = null;
        $hubo_error = null;
        $cmd = "svn info \"$path\" --xml";
    ...
    public function update($path, $revision = 'HEAD')
    {
        $cmd = "svn up \"$path\" -r $revision";
        return $this->ejecutar($cmd);
    }

    public function do_switch($url, $path)
    {
    ...
    public function do_merge($url, $path, $desde, $hacia)
    {
     ...
     */
    public function descargar($url, $path)
    {
        /*$checkout = true;
        if (file_exists($path)) {
            $borrar = false;
    ...
    public function get_revision_origen($url)
    {
    ...
    public function existe_url($url)
    {
        $salida = array();
        $valor_retorno = null;
        $cmd = "svn ls \"$url\"";
    ...
    public function crear_directorio($url, $mensaje)
    {
        $cmd = "svn mkdir \"$url\"  -m \"$mensaje\"";
        $this->ejecutar($cmd);
    }

    public function copy($origen, $destino, $mensaje)
    {
