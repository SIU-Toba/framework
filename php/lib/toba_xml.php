...
class toba_xml
{
     ...
     * @param mixed $nombre
     */
    public function abrir_elemento($nombre)
    {
     ...
     * Cierra un elemento
     */
    public function cerrar_elemento()
    {
        $this->xml->endElement();
    }
     ...
     */
    public function add_atributo($nombre, $valor, $conv_utf8 = false)
    {
     ...
     */
    public function cerrar_documento()
    {
