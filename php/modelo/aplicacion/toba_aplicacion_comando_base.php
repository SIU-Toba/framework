...
class toba_aplicacion_comando_base implements toba_aplicacion_comando
{
     ...
     */
    public function opcion__crear_auditoria($parametros)
    {
     ...
     */
    public function opcion__borrar_auditoria()
    {
     ...
     */
    public function opcion__purgar_auditoria()
    {
     ...
     * @consola_separador 1
     */
    public function opcion__migrar_auditoria_2_4()
    {
    ...
    /**
     * Hace compatible la estructura del esquema con los cambios en la version 3.1.0
     * @consola_separador 1
     */
    public function opcion__migrar_auditoria_3_1()
    {
        $this->modelo->migrar_auditoria_3_1();				//Modifico la estructura de las tablas
        $this->modelo->crear_auditoria();					//Regenero los triggers y SPs
    }
     ...
     * @consola_separador 1
     */
    public function opcion__migrar_auditoria_3_4()
    {
     ...
     * @throws Exception
     */
    public function opcion__exportar_usuarios_arai($parametros)
    {
