...
class toba_aplicacion_modelo_base implements toba_aplicacion_modelo
{
     ...
     *
     */
    public function set_entorno($manejador_interface, toba_modelo_instalacion $instalacion, toba_modelo_instancia $instancia, toba_modelo_proyecto $proyecto, $default_schema = 'public')
    {
     ...
     */
    public function get_servidor_defecto()
    {
    ...
    public function cargar_modelo_datos($base)
    {
     ...
     */
    public function regenerar_modelo_datos($base, $id_def_base)
    {
     ...
     * @param toba_db $base
     */
    public function estructura_creada(toba_db $base)
    {
        $tablas = $base->get_lista_tablas(false, $this->schema_modelo);
        return ! empty($tablas);
    }

    public function crear_estructura(toba_db $base)
    {
    ...
    public function cargar_datos(toba_db $base)
    {
    ...
    public function get_fuente_defecto()
    {
     ...
     */
    public function crear_auditoria($tablas = array(), $prefijo_tablas = null, $con_transaccion = true, $fuente = null, $lista_schemas = array(), $guardar_datos = false, $fuerza_eliminacion_triggers = false)
    {
        if (! is_null($fuente)) {
     ...
     */
    public function borrar_auditoria($tablas = array(), $prefijo_tablas = null, $con_transaccion = true)
    {
    ...
    public function purgar_auditoria($tiempo = 0, $tablas = array(), $prefijo_tablas = null, $con_transaccion = true)
    {
    ...
    public function migrar_auditoria_2_4($tablas = array(), $prefijo_tablas = null)
    {
        $auditoria = $this->preparar_migracion_estructura($tablas, $prefijo_tablas);
        $auditoria->migrar_estructura_campos_toba_2_4();
    }

    public function migrar_auditoria_3_1($tablas = array(), $prefijo_tablas = null)
    {
        $auditoria = $this->preparar_migracion_estructura($tablas, $prefijo_tablas);
        $auditoria->migrar_estructura_campos_toba_3_1();
    }

    public function migrar_auditoria_3_4($tablas = array(), $prefijo_tablas = null)
    {
        $auditoria = $this->preparar_migracion_estructura($tablas, $prefijo_tablas);
     ...
     */
    public function crear_lenguaje_procedural(toba_db $base)
    {
