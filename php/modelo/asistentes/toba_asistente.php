...
abstract class toba_asistente
{
    ...
    public function __construct($molde = null, $dr_molde = null)
    {
        if (isset($molde)) {
    ...
    public function registrar_molde(toba_molde_elemento $molde)
    {
        $this->moldes[] = $molde;
    }
    ...
    */
    public function posee_informacion_completa()
    {
    ...
    */
    public function preparar_molde()
    {
        $this->generar_base();
        $this->generar();
    }
    ...
    public function get_opciones_generacion()
    {
        return $this->envio_opciones_generacion;
    }

    public function get_bloqueos()
    {
    ...
    */
    ...
    public function crear_item($nombre, $padre)
    {
        try {
            abrir_transaccion();
    ...
    public function registrar_elemento_creado($tipo, $proyecto, $id)
    {
        static $a = 0;
    ...
    */
    public function get_valor_predefinido($opcion)
    {
    ...
    */
    public function agregar_opcion_generacion($id, $texto, $ayuda = null)
    {
    ...
    */
    public function consultar_opcion_generacion($opcion)
    {
     ...
     */
    public function asumir_confirmaciones()
    {
    ...
    */
    public function agregar_bloqueo_generacion($bloqueo)
    {
    ...
    public function generar_efs($form, $filas, $es_filtro = false)
    {
                ...
                switch ($fila['ef_carga_origen']) {
                    ...
                    case 'consulta_php':
                        ...
                        if ($fila['ef_carga_php_metodo']) {
                            ...
                            $ef->set_propiedad('carga_col_desc', $fila['ef_carga_col_desc']);
                            if (isset($fila['ef_carga_sql'])) {
                                $this->crear_consulta_php(
                                    $fila['ef_carga_php_include'],
     ...
     */
    public function generar_datos_tabla($molde_dt, $tabla, $filas)
    {
     ...
     */
    public function get_molde_datos_tabla($tabla, $fuente = null)
    {
        $molde = null;
        if (isset($fuente)) {
    ...
    public function generar_datos_relacion($molde_dr)
    {
        $molde_dr->crear($this->molde['nombre']);
        $molde_dr->crear_relaciones();
    }

    public function get_molde_datos_relacion($fuente = null)
    {
        if (isset($fuente)) {
            $this->molde['fuente'] = $fuente;
        }
    ...
    public function get_carpeta_archivos()
    {
    ...
    public function get_carpeta_archivos_datos()
    {
        return 'datos';
    }

    public function get_id_elemento()
    {
    ...
    public function tiene_fuente_definida()
    {
     ...
     */
    public function crear_metodo_consulta($nombre, $sql, $parametros = null)
    {
    ...
    public function crear_consulta_php($include, $clase, $metodo, $sql, $parametros = null)
    {
        $metodo_php = $this->crear_metodo_consulta($metodo, $sql, $parametros);
        $this->agregar_archivo($include, $clase, $metodo_php);
    }

    public function agregar_archivo($include, $clase, $metodo_php)
    {
    ...
    public function generar_archivos_consultas()
    {
     ...
     * @ignore
     */
    public function directorio_absoluto()
    {
