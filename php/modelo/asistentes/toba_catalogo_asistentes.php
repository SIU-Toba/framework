...
class toba_catalogo_asistentes
{
    ...
    */
    public static function cargar_por_molde($id_molde_proyecto, $id_molde, $dr_molde)
    {
        $tipo_molde = self::get_asistente_molde($id_molde_proyecto, $id_molde);
        $datos = toba_cargador::instancia()->get_metadatos_extendidos(
            array('proyecto' => $id_molde_proyecto,
                                                                'componente' => $id_molde),
            $tipo_molde
        );
    ...
    public static function cargar_por_tipo_operacion($tipo_operacion, $dr_molde)
    {
        $clase = self::get_clase_asistente($tipo_operacion);
        return new $clase(null, $dr_molde);
    }

    public static function get_asistente_molde($id_molde_proyecto, $id_molde)
    {
    ...
    public static function get_ci_molde($id_molde_proyecto, $id_molde)
    {
        $id_molde = quote($id_molde);
        $id_molde_proyecto = quote($id_molde_proyecto);
    ...
    public static function get_clase_asistente($tipo_operacion)
    {
    ...
    public static function get_lista_tipo_dato($mapeo_obligatorio = false)
    {
        $where = '';
    ...
    public static function tipo_dato_referencia()
    {
        return '1000008';
    }

    public static function tipo_dato_caracter()
    {
        return '1000001';
    }
    ...
    public static function get_campo_opciones_para_cuadro($tipo)
    {
     ...
     */
    public static function get_fila_opciones_de_tipo($tipo)
    {
     ...
     */
    public static function get_lista_filas_tabla($tabla, $fuente)
    {
