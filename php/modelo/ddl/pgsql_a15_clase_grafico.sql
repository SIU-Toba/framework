...
(
   ...
   CONSTRAINT  "apex_obj_grafico_fk_objeto" FOREIGN KEY ("objeto_grafico_proyecto","objeto_grafico") REFERENCES "apex_objeto" ("proyecto","objeto") ON DELETE CASCADE ON UPDATE NO ACTION DEFERRABLE INITIALLY IMMEDIATE
);
--###################################################################################################