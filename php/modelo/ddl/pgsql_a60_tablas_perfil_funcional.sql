...
(
	...
	CONSTRAINT	"apex_perfil_funcional_ef_fk_ef"	FOREIGN KEY	("proyecto","objeto_ei_formulario","objeto_ei_formulario_fila") 
			...
			ON DELETE	NO	ACTION ON UPDATE NO ACTION	DEFERRABLE	INITIALLY IMMEDIATE,
	CONSTRAINT	"perfil_funcional_ef_fk_item"	 FOREIGN KEY	("proyecto","item")
...
(
	...
	CONSTRAINT	"apex_perfil_funcional_pantalla_fk_pantalla"	FOREIGN KEY	("proyecto","objeto_ci","pantalla") 
			...
			ON DELETE	NO	ACTION ON UPDATE NO ACTION	DEFERRABLE	INITIALLY IMMEDIATE,
	CONSTRAINT	"perfil_funcional_pantalla_fk_item"	 FOREIGN KEY	("proyecto","item")
			REFERENCES "apex_item" ("proyecto","item")	ON	DELETE CASCADE ON UPDATE
			CASCADE  DEFERRABLE INITIALLY IMMEDIATE
...
(
	...
	no_visible						smallint			NULL,
	CONSTRAINT	"apex_perfil_funcional_evt_pk" PRIMARY	KEY ("proyecto","perfil_funcional","evento_id"),
	...
	CONSTRAINT	"apex_perfil_funcional_evt_fk_evt"	FOREIGN KEY	("proyecto","evento_id") 
			...
			ON DELETE	NO	ACTION ON UPDATE NO ACTION	DEFERRABLE	INITIALLY IMMEDIATE,
	CONSTRAINT	"perfil_funcional_evt_fk_item"	 FOREIGN KEY	("proyecto","item")
			REFERENCES "apex_item" ("proyecto","item")	ON	DELETE CASCADE ON UPDATE
			CASCADE  DEFERRABLE INITIALLY IMMEDIATE
);
--#################################################################################################

CREATE TABLE apex_perfil_funcional_ei
---------------------------------------------------------------------------------------------------
--: proyecto: toba
--: dump: multiproyecto
...
(
	...
	no_visible						smallint			NULL,
	CONSTRAINT	"apex_perfil_funcional_ei_pk" PRIMARY	KEY ("proyecto","perfil_funcional","objeto"),
	CONSTRAINT	"apex_perfil_funcional_ei_fk_pf"	FOREIGN KEY	("proyecto","perfil_funcional") 
			REFERENCES	"apex_perfil_funcional" ("proyecto","perfil_funcional") 
			ON DELETE	NO	ACTION ON UPDATE NO ACTION	DEFERRABLE	INITIALLY IMMEDIATE,
	CONSTRAINT	"apex_perfil_funcional_ei_fk_evt"	FOREIGN KEY	("proyecto","objeto") 
			REFERENCES	"apex_objeto" ("proyecto","objeto") 
			ON DELETE	NO	ACTION ON UPDATE NO ACTION	DEFERRABLE	INITIALLY IMMEDIATE,
	CONSTRAINT	"perfil_funcional_ei_fk_item"	 FOREIGN KEY	("proyecto","item")
			REFERENCES "apex_item" ("proyecto","item")	ON	DELETE CASCADE ON UPDATE
			CASCADE  DEFERRABLE INITIALLY IMMEDIATE
);
--#################################################################################################

CREATE TABLE apex_perfil_funcional_cols
---------------------------------------------------------------------------------------------------
--: proyecto: toba
--: dump: multiproyecto
...
(
	...
	no_visible						smallint			NULL,
	CONSTRAINT	"apex_perfil_funcional_cols_pk" PRIMARY	KEY ("proyecto","perfil_funcional","objeto_cuadro_col"),
	CONSTRAINT	"apex_perfil_funcional_cols_fk_pf"	FOREIGN KEY	("proyecto","perfil_funcional") 
			REFERENCES	"apex_perfil_funcional" ("proyecto","perfil_funcional") 
			ON DELETE	NO	ACTION ON UPDATE NO ACTION	DEFERRABLE	INITIALLY IMMEDIATE,
	CONSTRAINT	"apex_perfil_funcional_cols_fk_evt"	FOREIGN KEY	("proyecto","objeto_cuadro","objeto_cuadro_col") 
			REFERENCES	"apex_objeto_ei_cuadro_columna" ("objeto_cuadro_proyecto","objeto_cuadro","objeto_cuadro_col") 
			ON DELETE	NO	ACTION ON UPDATE NO ACTION	DEFERRABLE	INITIALLY IMMEDIATE,
	CONSTRAINT	"perfil_funcional_cols_fk_item"	 FOREIGN KEY	("proyecto","item")
			REFERENCES "apex_item" ("proyecto","item")	ON	DELETE CASCADE ON UPDATE
			CASCADE  DEFERRABLE INITIALLY IMMEDIATE
);
--#################################################################################################