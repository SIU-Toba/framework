...
class toba_ci_info extends toba_ei_info
{
    ...
    */
    ...
    public function get_pantalla($id)
    {
        for ($i = 0 ; $i < count($this->datos['_info_ci_me_pantalla']) ; $i++) {
            if ((string) $this->datos['_info_ci_me_pantalla'][$i]['pantalla'] === (string) $id) {
                return new toba_ci_pantalla_info(
                    $this->datos['_info_ci_me_pantalla'][$i],
                    $this->subelementos,
                    $this->proyecto,
                    $this->id,
                    $this->datos['_info_obj_pantalla']
                );
            }
        }
    ...
    public function get_cant_pantallas()
    {
        ...
        if (count($this->subelementos)>0) {
            foreach ($this->subelementos as $id => $elemento) {
                ...
                if ($es_ei) {
                    ...
                    $metodo = new toba_codigo_metodo_php(
                        'conf__' . $rol,
