...
class toba_ci_pantalla_info implements toba_nodo_arbol, toba_meta_clase
{
    ...
    public function __construct($datos, $dependencias_posibles, $proyecto, $id, $info_dep_asociadas = array())
    {
        $this->datos = $datos;
    ...
    public function set_info_objetos_asociados($obj)
    {
    ...
    public function clonar_subclase($dr, $dir_subclases, $proyecto_dest)
    {
