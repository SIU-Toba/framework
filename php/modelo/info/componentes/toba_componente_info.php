...
abstract class toba_componente_info implements toba_nodo_arbol, toba_meta_clase
{
    ...
    public function set_consumidor($consumidor, $datos_consumidor)
    {
        $this->consumidor = $consumidor;
        $this->datos_consumidor = $datos_consumidor;
    }

    public function tiene_consumidor()
    {
        return isset($this->datos_consumidor['identificador']);
    }

    public function rol_en_consumidor()
    {
        return $this->datos_consumidor['identificador'];
    }

    public function get_metadatos_subcomponente()
    {
        return array();
    }

    public function acceso_zona($parametros = array())
    {
        $parametros[apex_hilo_qs_zona] = $this->proyecto . apex_qs_separador . $this->id;
        return $parametros;
    }

    public function vinculo_editor($parametros = array())
    {
        ...
        return toba::vinculador()->get_url(
            $editor_proyecto,
            $editor_item,
            $this->acceso_zona($parametros),
            array(	'menu' => true,
                                        'celda_memoria' => 'central')
        );
    }

    public function get_fuente_datos()
    {
    ...
    public function clonar($nuevos_datos, $dir_subclases=false, $con_transaccion = true)
    {
        ...
        foreach ($this->subelementos as $hijo) {
            ...
            $dr->tabla('dependencias')->modificar_fila(
                current($id_fila),
    ...
    public function set_info_extra($info)
    {
     ...
     */
    public function get_clase_nombre_final()
    {
    ...
    public function get_clase_extendida_nombre()
    {
    ...
    public function cambiar_clase_origen($nombre_clase)
    {
