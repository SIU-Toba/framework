...
class toba_item_info implements toba_nodo_arbol
{
    ...
    */
    ...
    public function es_publico()
    {
        return $this->datos['basica']['publico'];
    }

    public function puede_redireccionar()
    {
        return $this->datos['basica']['redirecciona'];
    }

    public function retrasa_envio_headers()
    {
        return ($this->datos['basica']['retrasar_headers'] == '1');
    }

    public function generado_con_wizard()
    {
        return isset($this->datos['basica']['molde']);
    }

    public function tipo_asistente_utilizado()
    {
        $tipo = toba_catalogo_asistentes::get_asistente_molde($this->proyecto, $this->datos['basica']['molde']);
        return $tipo;
    }

    public function vinculo_editor()
    {
        if ($this->es_carpeta()) {
            $item_editor = "1000238";
        } else {
        ...
        return toba::vinculador()->get_url(
            toba_editor::get_id(),
            $item_editor,
    ...
    */
    public function vinculo_ejecutar()
    {
     ...
     */
    public function contiene_objeto($id)
    {
    ...
    public function get_nivel_prof()
    {
        return $this->nivel;
    }

    public function get_camino()
    {
        return $this->camino;
    }
    ...
    {
        return $this->datos['basica']['usuario'];
    }

    public function grupos_acceso()
    {
    ...
    public function grupo_tiene_permiso($grupo)
    {
    ...
    public function es_hijo_de($carpeta)
    {
        if ($this->es_raiz()) {
            return false;
        }
     ...
     */
    public function es_inaccesible()
    {
    ...
    public function posee_accion_predefinida()
    {
        return ($this->datos['basica']['item_act_accion_script'] != '');
    }

    public function existe_php_accion()
    {
    ...
    public function otorgar_permiso($grupo)
    {
    ...
    public function asignar_componente($id_componente)
    {
