...
class toba_rf_ci extends toba_rf_componente
{
    ...
    public function __construct($restriccion, $proyecto, $item, $componente, $padre, $primer_nivel = false, $expande_deps_sin_pantalla = false)
    {
        ...
        //-----------------------------------------------------------------------------------------------//
        $deps_en_pantalla = array();
        $lista_deps = array();										//clasifico las dependencias por pantallas y hago una lista completa de las usadas
    ...
    public function armar_rama_deps($deps, $deps_pantalla, $pantalla_actual, &$p, $expande_deps_sin_pantalla)
    {
        foreach ($deps as $dep) {
    ...
    public function cargar_datos_pantallas()
    {
    ...
    public function cargar_datos_dependencias()
    {
        $componente = quote($this->componente);
        $proyecto = quote($this->proyecto);
    ...
    public function cargar_datos_objetos_pantalla()
    {
        $proyecto = quote($this->proyecto);
        $componente = quote($this->componente);
