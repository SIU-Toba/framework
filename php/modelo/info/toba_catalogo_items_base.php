...
class toba_catalogo_items_base
{
    ...
    public function cantidad_items()
    {
    ...
    public function cargar_todo($opciones = array())
    {
        $this->cargar_todo = true;
        $this->cargar($opciones);
    }

    public function cargar($opciones, $id_item_inicial = null, $incluidos_forzados = array())
    {
    }
    ...
    public function debe_cargar_todo($opciones)
    {
    ...
    public function buscar_carpeta_inicial()
    {
        foreach ($this->items as $item) {
    ...
    */
    ...
    public function ordenar_recursivo($carpeta, $nivel)
    {
    ...
    public function filtrar($opciones)
    {
    ...
    //---------------------------FILTRADO DE ITEMS------------------------------------------
    public function set_carpeta_inicial($id_item)
    {
        $this->carpeta_inicial = $id_item;
    }

    public function sacar_publicos()
    {
     ...
     */
    public function dejar_grupo_acceso($grupo)
    {
        $keys_i = array_keys($this->items);
        foreach ($keys_i as $posicion) {
    ...
    public function filtrar_items_en_menu($en_menu)
    {
        $encontrados = array();
        foreach ($this->items as $item) {
    ...
    public function dejar_items_con_nombre($nombre)
    {
        $encontrados = array();
        foreach ($this->items as $item) {
    ...
    public function dejar_items_con_id($id)
    {
        $encontrados = array();
        foreach ($this->items as $item) {
    ...
    public function dejar_items_inaccesibles()
    {
        $encontrados = array();
        foreach ($this->items as $item) {
    ...
    public function dejar_items_sin_objetos()
    {
        $encontrados = array();
        foreach ($this->items as $item) {
    ...
    public function dejar_items_con_objeto($id_objeto)
    {
    ...
    public function dejar_items_con_tipo_solicitud($tipo)
    {
        $encontrados = array();
        foreach ($this->items as $item) {
    ...
    public function dejar_items_con_zona($zona)
    {
        $encontrados = array();
        foreach ($this->items as $item) {
    ...
    public function dejar_items_con_asistente($asistente)
    {
        $encontrados = array();
        foreach ($this->items as $item) {
