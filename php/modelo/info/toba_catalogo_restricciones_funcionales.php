...
class toba_catalogo_restricciones_funcionales extends toba_catalogo_items_base
{
    ...
    public function __construct($proyecto, $id_restriccion_funcional = '')
    {
    ...
    */
    ...
    public function get_lista_items()
    {
    ...
    public function set_expandir_dependencias_sin_pantalla($expandir = false)
    {
