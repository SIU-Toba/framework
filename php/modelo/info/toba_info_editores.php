...
class toba_info_editores
{
    ...
    */
    public static function get_info_tipos_componente($contenedor = null, $excluir_internos = true, $id_contenedor = null)
    {
        $where = '';
        if (isset($contenedor)) {
    ...
    public static function get_lista_tipo_componentes($excluir_internos = true)
    {
        $datos = array();
    ...
    public static function get_clases_validas_contenedor($contenedor, $id = null)
    {
    ...
    */
    public static function get_lista_componentes_validos_en_contenedor($contenedor, $categorias = null)
    {
        $where = '';
        if (isset($categorias)) {
    ...
    public static function get_contenedores_validos($componente)
    {
        switch ($componente) {
            case 'toba_ci':
    ...
    public static function get_lista_componentes_contenedores($tipo_componente_contenido)
    {
    ...
    */
    public static function get_lista_clases_toba($todas = false, $especificas = null)
    {
        if ($todas) {
            $sql_todas = "";
        } else {
    ...
    */
    public static function get_ci_editor_clase($proyecto, $clase)
    {
    ...
    */
    public static function get_dr_de_clase($clase)
    {
        if ($clase == 'toba_item') {
    ...
    public static function get_clases_con_fuente_datos()
    {
        $sql = 'SELECT clase
				FROM apex_clase
     ...
     */
    public static function get_lista_tipos_clase()
    {
        $sql = 'SELECT
					clase_tipo, 
					descripcion_corta
     ...
     */
    public static function get_proyectos_accesibles()
    {
    ...
    public static function get_descripcion_proyecto($id_proyecto)
    {
    ...
    public static function get_clases_extendidas_proyecto($id_proyecto)
    {
        $proyecto = toba_contexto_info::get_db()->quote($id_proyecto);
    ...
    */
    public static function get_proyectos_con_items_exportables()
    {
        $usuario = toba_contexto_info::get_db()->quote(toba::usuario()->get_id());
        $sql = "
			SELECT 	
    ...
    */
    public static function get_items_exportables($proyecto = null)
    {
    ...
    */
    public static function get_items_servicios_web($proyecto = null)
    {
        $proyecto = isset($proyecto) ?
                    toba_contexto_info::get_db()->quote($proyecto) :
                    toba_contexto_info::get_db()->quote(toba_contexto_info::get_proyecto());
    ...
    public static function get_item_raiz($proyecto = null)
    {
        $proyecto = isset($proyecto) ?
                        toba_contexto_info::get_db()->quote($proyecto) :
                        toba_contexto_info::get_db()->quote(toba_contexto_info::get_proyecto());
    ...
    */
    public static function get_lista_items($proyecto = null, $sin_carpetas = true)
    {
        $proyecto = isset($proyecto) ?
                        toba_contexto_info::get_db()->quote($proyecto) :
                        toba_contexto_info::get_db()->quote(toba_contexto_info::get_proyecto());
    ...
    */
    public static function existe_item($item, $proyecto = null)
    {
    ...
    */
    public static function get_items_para_combo($proyecto = null, $incluir_carpetas = false)
    {
        if (! isset($proyecto)) {
            $proyecto = toba_contexto_info::get_proyecto();
        }
    ...
    */
    public static function get_carpetas_posibles($proyecto = null)
    {
        if (! isset($proyecto)) {
            $proyecto = toba_contexto_info::get_proyecto();
        }
    ...
    */
    public static function get_items_carpeta($carpeta, $proyecto = null)
    {
        if (! isset($proyecto)) {
            $proyecto = toba_contexto_info::get_proyecto();
        }
    ...
    public static function get_carpeta_de_item($item, $proyecto)
    {
        $sql = "
			SELECT 
				padre
    ...
    */
    public static function get_clase_de_objeto($id)
    {
    ...
    public static function get_lista_objetos_toba($clase)
    {
        $clase = explode(",", $clase);
    ...
    public static function get_info_dependencia($objeto_proyecto, $objeto)
    ...
    */
    public static function get_arbol_componentes_item($proyecto, $item)
    {
     ...
     */
    public static function get_subclase_componente($id, $proyecto = null)
    {
        if (! isset($proyecto)) {
            $proyecto = toba_contexto_info::get_proyecto();
        }
    ...
    *	Devuelve la lista de dependencias de un ITEM
    */
    public static function get_arbol_componentes_componente($proyecto, $componente, $componente_padre = null)
    {
        static $id = 1;
    ...
    public static function get_pantallas_de_ci($objeto)
    {
    ...
    public static function get_lista_objetos_dr()
    ...
    public static function get_lista_objetos_dt()
    ...
    public static function get_tabla_fuente_de_dt($id = null, $proyecto = null)
    {
        if (!isset($proyecto)) {
            $proyecto = toba_contexto_info::get_proyecto();
        }
    ...
    public static function get_dt_de_tabla_fuente($tabla, $fuente, $proyecto = null)
    {
        if (!isset($proyecto)) {
            $proyecto = toba_contexto_info::get_proyecto();
        }
    ...
    public static function get_lista_dt_columnas($objeto)
    /*
    ...
    */
    ...
    public static function get_puntos_de_control($filtro, $id_contenedor = null, $id_objeto = null, $campos = null)
    {
        $proyecto = toba_contexto_info::get_db()->quote(toba_contexto_info::get_proyecto());
    ...
    * Tipos de pagina
    */
    public static function get_tipos_pagina($proyecto = null)
    {
        if (!isset($proyecto)) {
            $proyecto =  toba_contexto_info::get_db()->quote(toba_contexto_info::get_proyecto());
        } else {
    ...
    public static function get_tipos_pagina_proyecto()
    {
        $proyecto = toba_contexto_info::get_db()->quote(toba_contexto_info::get_proyecto());
     ...
     */
    public static function get_tipo_pagina_defecto($proyecto = null)
    {
        if (!isset($proyecto)) {
            $proyecto = toba_contexto_info::get_proyecto();
        }
    ...
    * BUFFERs
    */
    public static function get_buffers()
    {
        $proyecto = toba_contexto_info::get_db()->quote(toba_contexto_info::get_proyecto());
    ...
    * Patrones
    */
    public static function get_comportamientos()
    {
        $proyecto = toba_contexto_info::get_db()->quote(toba_contexto_info::get_proyecto());
    ...
    * Zonas
    */
    public static function get_zonas()
    {
        $proyecto = toba_contexto_info::get_db()->quote(toba_contexto_info::get_proyecto());
    ...
    * Tipos de solicitud
    */
    public static function get_tipo_observaciones_solicitud()
    {
        $proyecto = toba_contexto_info::get_db()->quote(toba_contexto_info::get_proyecto()) ;
    ...
    */
    public static function get_fuentes_datos($proyecto = null)
    {
        if (!isset($proyecto)) {
            $proyecto = toba_contexto_info::get_proyecto();
        }
    ...
    public static function get_fuente_datos_defecto($proyecto = null)
    {
        if (!isset($proyecto)) {
            $proyecto = toba_contexto_info::get_proyecto();
        }
     ...
     */
    public static function get_lista_motores()
    {
        $sql = 'SELECT
					fuente_datos_motor, 
					nombre
    ...
    public static function get_puerto_motor($motor = null)
    {
        $resultado = 0;
        switch ($motor) {
    ...
    */
    public static function get_info_fuente_datos($id_fuente, $proyecto = null)
    {
        if (!isset($proyecto)) {
            $proyecto = toba_contexto_info::get_proyecto();
        }
     ...
     */
    public static function hay_fuente_definida($proyecto)
    {
        $proyecto = toba_contexto_info::get_db()->quote($proyecto);
     ...
     */
    public static function get_schemas_fuente($proyecto, $fuente)
    {
        $proyecto = toba_contexto_info::get_db()->quote($proyecto);
        $fuente = toba_contexto_info::get_db()->quote($fuente);
    ...
    *	Lista de Skins
    */
    public static function get_lista_skins()
    {
        $proyecto = toba_contexto_info::get_db()->quote(toba_contexto_info::get_proyecto());
        $sql = "SELECT
					estilo, 
    ...
    public static function get_lista_estilos_columnas($id_estilo = null)
    {
    ...
    public static function get_nombre_clase_css($id_estilo)
    {
        $nombre = '';
    ...
    public static function get_estilo_defecto_formateo_columna($formateo)
    {
    ...
    public static function get_mensajes($proyecto = null)
    {
        if (!isset($proyecto)) {
            $proyecto = toba_contexto_info::get_proyecto();
        }
    ...
    public static function get_mensajes_filtrados($clausulas = array())
    {
    ...
    public static function get_mensajes_objeto($objeto, $proyecto = null)
    {
        if (!isset($proyecto)) {
            $proyecto = toba_contexto_info::get_proyecto();
        }
    ...
    public static function get_mensajes_objeto_filtrados($clausulas = array())
    {
    ...
    public static function get_puntos_control($proyecto = null)
    {
        if (!isset($proyecto)) {
            $proyecto = toba_contexto_info::get_proyecto();
        }
    ...
    public static function get_filtro_tipo_columnas()
    {
        $proyecto = toba_contexto_info::get_db()->quote(toba_contexto_info::get_proyecto());
    ...
    public static function get_filtro_efs($tipo_col, $es_multiple)
    {
    ...
    */
    public static function get_log_modificacion_componentes()
    {
        $proyecto = toba_contexto_info::get_db()->quote(toba_contexto_info::get_proyecto()) ;
    ...
    public static function get_opciones_predefinidas_molde($proyecto = null)
    {
        if (!isset($proyecto)) {
            $proyecto = toba_contexto_info::get_proyecto();
        }
    ...
    public static function get_lista_tipo_molde($operacion_tipo = null)
    {
        $where_operacion = '';
    ...
    public static function get_lista_moldes_existentes($proyecto = null, $tipo_operacion = null)
    {
        if (!isset($proyecto)) {
            $proyecto = toba_contexto_info::get_proyecto();
        }
    ...
    public static function get_lista_ejecuciones_molde($proyecto, $molde)
    {
    ...
    public static function get_info_molde($proyecto, $molde)
    {
        if (!isset($proyecto)) {
            $proyecto = toba_contexto_info::get_proyecto();
        }
    ...
    public static function get_consultas_php($proyecto = null)
    {
        if (!isset($proyecto)) {
            $proyecto = toba_contexto_info::get_proyecto();
        }
    ...
    public static function get_consulta_php($consulta, $proyecto)
    {
        if (!isset($proyecto)) {
            $proyecto = toba_contexto_info::get_proyecto();
        }
    ...
    public static function get_metodos_consulta_php($consulta_php, $proyecto = null)
    {
        if (is_null($proyecto)) {
            $proyecto = toba_contexto_info::get_proyecto();
        }
    ...
    public static function get_dimensiones($proyecto = null)
    {
        if (!isset($proyecto)) {
            $proyecto = toba_contexto_info::get_proyecto();
        }
    ...
    public static function get_datos_dimension($proyecto, $dimension)
    {
        $proyecto = toba_contexto_info::get_db()->quote($proyecto);
    ...
    public static function get_cantidad_dimensiones_fuente($fuente, $proyecto = null)
    {
        if (!isset($proyecto)) {
            $proyecto = toba_contexto_info::get_proyecto();
        }
    ...
    public static function get_relaciones_tablas($fuente_datos, $proyecto = null)
    {
        if (!isset($proyecto)) {
            $proyecto = toba_contexto_info::get_proyecto();
        }
    ...
    public static function get_servicios_web_acc($proyecto = null, $tipo = null)
    {
        if (!isset($proyecto)) {
            $proyecto = toba_contexto_info::get_proyecto();
        }
    ...
    public static function get_lista_tipos_grafico()
    {
    ...
    public static function get_pms($proyecto = null)
    {
        if (!isset($proyecto)) {
            $proyecto = toba_contexto_info::get_proyecto();
        }
