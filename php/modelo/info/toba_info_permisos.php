...
{
    public static function get_lista_permisos($condiciones = null)
    {
    ...
    public static function get_perfiles_funcionales($proyecto = null)
    {
        if (!isset($proyecto)) {
            $proyecto = toba_contexto_info::get_proyecto();
        }
    ...
    public static function get_perfiles_funcionales_miembros($proyecto, $perfil, $conexion = null)
    {
        if (! isset($conexion)) {
     ...
     */
    public static function get_perfiles_funcionales_pueden_ser_miembros($proyecto, $perfil = null)
    {
        $where = '';
        if (isset($perfil)) {
     ...
     */
    public static function get_grupos_acceso($proyecto = null)
    {
        return self::get_perfiles_funcionales($proyecto);
    }

    public static function get_perfiles_datos($proyecto = null)
    {
        if (!isset($proyecto)) {
            $proyecto = toba_contexto_info::get_proyecto();
        }
    ...
    public static function get_lista_usuarios($proyecto = null)
    {
        if (!isset($proyecto)) {
            $proyecto = toba_contexto_info::get_proyecto();
        }
    ...
    public static function get_restricciones_proyecto($proyecto)
    {
        $proyecto = toba_contexto_info::get_db()->quote($proyecto);
        $sql = "SELECT 	proyecto,
