...
{
    public static function abrir_browser($browser, $url = null)
    {
    ...
    public static function login($session1, $usuario = 'toba', $password = 'toba')
    {
    ...
    public static function inicio($session1)
    {
    ...
    public static function salida_cabecera($texto)
    {
        echo "<ul style=\"list-style-type:circle\">";
        echo "<li> $texto " ;
    }

    public static function salida_cuerpo($texto)
    {
        echo "<font color =\"green\">OK!  </font></li>";
        echo "<li> $texto" ;
    }

    public static function salida_pie()
    {
        echo "<font color =\"green\">OK!  </font></li>";
        echo "</ul>";
    }
