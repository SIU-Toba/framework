...
{
    public static $selectores = array(
    ...
    public static function setear_campo($session1, $tipo, $selector, $id, $texto = null)
    {
    ...
    public static function click_element($session1, $selector, $value)
    {
    ...
    public static function setear_opcion_combo($session1, $selector, $ident, $id_opcion = null, $texto_opcion = null, $deseleccionar = false)
    {
        //Busco el campo
        $par = self::get_selector($selector);
    ...
    //						AUXILIARES							     //
    //------------------------------------------------------------------------------------------------------------//
    public static function get_selector($selector)
    {
    ...
    public static function typear_texto($session, $elemento, $texto)
    {
    ...
    public static function push_click($session, $elemento)
    {
    ...
    public static function set_busqueda($session, $elemento, $texto)
    {
    ...
    public static function clear_busqueda($session, $elemento)
    {
        $campo = self::push_click($session, $elemento);
        $campo->clear();
    }

    public static function get_elementos($session, $selector, $value)
    {
        $par = self::get_selector($selector);
