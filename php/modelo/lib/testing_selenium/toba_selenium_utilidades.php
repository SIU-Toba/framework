...
{
    public static $proyecto_id = 'toba_usuarios';
    public static $id_campo_usuario = 'usuario';
    public static $id_campo_pwd = 'password';
    public static $id_button_login = 'submit';
    public static $item_inicio = 1000228;

    public static function get_url_proyecto()
    {
    ...
    public static function get_path_proyecto()
    {
        $id_proy = self::get_proyecto_id();
        $instalacion = new toba_modelo_instalacion();
        $proyecto = $instalacion->get_instancia('desarrollo')->get_proyecto($id_proy);
