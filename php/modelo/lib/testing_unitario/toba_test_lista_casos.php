...
class toba_test_lista_casos
{
    ...
    public static $path_base = '/php/testing';
    public static $tipo;

    public static function set_tipo($tipo_test)
    {
        self::$tipo = $tipo_test;
    }

    public static function get_path($ultimo_nivel = '', $personalizacion = false)
    {
    ...
    public static function comparar($x, $y)
    {
    ...
    public static function get_categorias($tipo = null)
    {
    ...
    public static function traer_todo($handle, $path)
    {
        $categorias = array();
    ...
    public static function get_casos($categoria = 'nopar')
    {
    ...
    public static function get_archivos($handle, $path)
    {
        $casos = array();
        while (false !== ($file = readdir($handle))) {
            $path_completo = $path . "/" . $file;
