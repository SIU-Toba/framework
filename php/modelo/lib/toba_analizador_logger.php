...
class toba_analizador_logger_fs
{
    ...
    public function procesar_entidades_html($activar = true)
    {
        $this->procesar_entidades_html = $activar;
    }

    public function analizar_cuerpo($log)
    {
        $cuerpo = array();
    ...
    public function analizar_encabezado($log)
    {
    ...
    public function get_pedido($seleccion)
    {
    ...
    public function get_logs_archivo()
    {
    ...
    public function cumple_criterio_filtro($datos)
    {
    ...
    public function existen_filtros_extra()
    {
