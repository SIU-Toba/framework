...
{
    //protected $ini_file;
    public const ARCHIVO_CONFIG = 'proyecto.ini';
    public const FRAMEWORK_VENDOR_DIR = 'siu-toba/framework';
     ...
     */
    public function __construct($m_interface, $proyecto)
    {
     ...
     * @throws toba_error
     */
    public function inicializar($dir_proyecto, $dir_destino, $dir_instalador, $paquete_legacy = false)
    {
     ...
     */
    public function forzar_empaquetado_legacy()
    {
