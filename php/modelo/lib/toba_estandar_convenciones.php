...
class toba_estandar_convenciones
{
    ...
    public function __construct($estandar = 'Toba', $warnings = true)
    {
    ...
    public function get_consola_sumario($path_relativo = null)
    {
        ob_start();
     ...
     */
    public function parsear_mensaje($mensaje)
    {
        $resultado = array();
        $expresion = '/^\[(.*)\](.*)/';
