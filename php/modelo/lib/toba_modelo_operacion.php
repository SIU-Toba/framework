...
class toba_modelo_operacion
{
    ...
    public function __construct($proyecto, $item)
    {
    ...
    public function hay_componentes_eliminar()
    {
     ...
     */
    public function get_info_eliminacion()
    {
        $datos = array();
        $a = 0;
     ...
     */
    public function eliminar_componentes_propios($con_transaccion = true)
    {
        $arbol_componentes = array_slice($this->arbol, 1);
        $opciones = array();
        foreach ($arbol_componentes as $arbol) {
     ...
     */
    public function eliminar($borrar_item, $opciones, $con_transaccion = true)
    {
    ...
    public function get_path_archivo($datos)
    {
