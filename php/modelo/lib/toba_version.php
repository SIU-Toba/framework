...
class toba_version
{
    ...
    public function path_migraciones()
    {
        return $this->path_migraciones;
    }

    public function set_path_migraciones($path)
    {
    ...
    public function get_string_partes($separador = '_')
    {
        if ($this->build == 'trunk') {
            return 'trunk';
        }
    ...
    public function get_release($separador = '.')
    {
        if ($this->build == 'trunk') {
            return 'trunk';
        }
    ...
    public function get_builds_intermedios($hasta)
    {
        $intermedios = array();
    ...
    public function es_igual($version)
    {
        return $this->comparar($version) == 0;
    }

    public function es_menor($version)
    {
        return $this->comparar($version) < 0;
    }

    public function es_mayor($version)
    {
        return $this->comparar($version) > 0;
    }

    public function es_mayor_igual($version)
    {
        return ($this->comparar($version) >= 0);
    }

    public function es_menor_igual($version)
    {
        return ($this->comparar($version) <= 0);
    }
     ...
     */
    public function comparar($otra_version)
    {
        if ($this->build == 'trunk') {
    ...
    public static function comparar_versiones($v1, $v2)
    {
        return $v1->comparar($v2);
    }

    public function es_cambio_menor_version(toba_version $otra_version)
    {
     ...
     * @return toba_version
     */
    public function get_siguiente_menor()
    {
        if ($this->build == 'trunk') {
            return $this;
        }
     ...
     */
    public function get_secuencia_migraciones($hasta, $path_migraciones = null)
    {
    ...
    public function ejecutar_migracion($prefijo, $elemento, $metodo_part = null, $interface = null)
    {
