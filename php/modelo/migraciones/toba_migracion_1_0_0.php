...
class toba_migracion_1_0_0 extends toba_migracion
{
     ...
     */
    public function instancia__cambio_proyecto_editor()
    {
    ...
    public function instancia__cambio_estructura()
    {
        //--- Cambios a efs
    ...
    public function instancia__cambios_metadatos_nucleo()
    {
     ...
     */
    public function proyecto__parametros_efs()
    {
        $cant = 0;
        $sql = "
			SELECT 
     ...
     *
     */
    public function proyecto__parametros_combo_lista_c()
    {
        $cant = 0;
        $sql = "
			SELECT 
     ...
     */
    public function proyecto__parametros_multiseleccion()
    {
        $cant = 0;
        $sql = "
			SELECT 
     ...
     */
    public function proyecto__arbol_herencia_efs()
    {
        $sql = "
			UPDATE 
				apex_objeto_ei_formulario_ef
     ...
     */
    public function proyecto__ef_textarea()
    {
        $sql = "
			UPDATE 
				apex_objeto_ei_formulario_ef
     ...
     */
    public function proyecto__ef_parametros_editable_numero()
    {
        $cant = 0;
        $sql = "
			SELECT 
    ...
    public function proyecto__ef_normalizacion_parametros()
    {
        $cant = 0;
        $correlacion = array(
    ...
    public function proyecto__ef_clave_nuevo_parametro()
    {
        $sql = " 
    ...
    */
    public function proyecto__eliminar_includes()
    {
    ...
    */
    public function proyecto__cambiar_nombres_clases_componentes()
    {
        $editor = new toba_editor_archivos();
     ...
     */
    public function proyecto__migracion_estilos()
    {
        $sql = "
     ...
     */
    public function proyecto__migracion_css_cuadro()
    {
        $sql = " 
     ...
     */
    public function proyecto__migracion_css_botones_evt()
    {
        $cant = 0;
        $sql = " 
    ...
    public function proyecto__cambios_tipo_pagina()
    {
        $cant = 0;
    ...
    public function proyecto__eliminar_tablas_objetos_obsoletos()
    {
        $sql = array();
    ...
    public function proyecto__eliminar_objetos_obsoletos()
    {
    ...
    public function proyecto__migrar_solicitud_browser()
    {
    ...
    public function proyecto__migrar_tipo_solicitud_carpetas()
    {
     ...
     */
    public function proyecto__cambio_api_ci()
    {
        $editor = new toba_editor_archivos();
    ...
    public function proyecto__fuente_no_obligatoria()
    {
        $sql = "
    ...
    */
    public function proyecto__fuente_por_defecto()
    {
        $sql = "
     ...
     */
    public function proyecto__namespace_toba()
    {
        $editor = new toba_editor_archivos();
     ...
     */
    public function proyecto__cambio_convenciones_clase_toba()
    {
        $editor = new toba_editor_archivos();
    ...
    public function proyecto__notificacion_js()
    {
        $editor = new toba_editor_archivos();
     ...
     */
    public function proyecto__cambio_api_varios()
    {
     ...
     */
    public function proyecto__cambio_api_hilo()
    {
        $editor = new toba_editor_archivos();
    ...
    public function proyecto__cambio_memoria_por_hilo()
    {
        $editor = new toba_editor_archivos();
     ...
     */
    public function proyecto__id_item_raiz()
    {
        $sql = array();
