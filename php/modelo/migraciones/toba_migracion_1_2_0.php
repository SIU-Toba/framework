...
EOF;
    ...
    public function instancia__preparar_modelo_para_mysql()
    {
        try {
    ...
    public function proyecto__migrar_datos_para_mysql()
    {
        /*
     ...
     */
    public function proyecto__borrar_perfiles_datos_actuales()
    {
     ...
     */
    public function proyecto__migrar_filtro_viejo()
    {
     ...
     */
    public function proyecto__datos_relacion_bug_campos()
    {
