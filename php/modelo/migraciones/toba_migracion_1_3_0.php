...
class toba_migracion_1_3_0 extends toba_migracion
{
    ...
    */
    public function proyecto__tiempo_no_interac_por_defecto()
    {
    ...
    */
    public function proyecto__tiempo_espera()
    {
        $sql = "UPDATE apex_proyecto 
    ...
    */
    public function proyecto__ef_fijo_permite_html()
    {
     ...
     */
    public function proyecto__celda_memoria_popup()
    {
        $sql = array();
        //Vinculos en Cuadros
     ...
     */
    public function proyecto__vinculos_a_carpeta_padre()
    {
        //Vinculos en Cuadros
