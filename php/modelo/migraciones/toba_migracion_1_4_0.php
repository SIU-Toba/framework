...
class toba_migracion_1_4_0 extends toba_migracion
{
     ...
     */
    public function proyecto__normalizar_suma_cortes_cuadro()
    {
     ...
     */
    public function proyecto__normalizar_dependencias_pantallas()
    {
     ...
     */
    public function proyecto__normalizar_eventos_pantallas()
    {
     ...
     */
    public function proyecto__normalizar_columnas_relaciones()
    {
     ...
     */
    public function proyecto__cambio_api_cn()
    {
     ...
     */
    public function proyecto__restringir_carga_col_ext()
    {
     ...
     */
    public function proyecto__configuraciones_ini()
    {
     ...
     */
    public function proyecto__lock_optimista_relaciones()
    {
        $sql = "
     ...
     */
    public function proyecto__agregar_botonera_eis()
    {
     ...
     */
    public function proyecto__migrar_retraso_headers()
    {
     ...
     */
    public function proyecto__permite_estado_no_seteado()
    {
