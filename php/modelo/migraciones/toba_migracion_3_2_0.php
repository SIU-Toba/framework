...
{
    public function proyecto__copiar_imagen_calendario()
    {
    ...
    public function proyecto__agregar_ws_reportes()
    {
        ...
        $sql = "INSERT INTO apex_servicio_web ( proyecto, servicio_web, descripcion, tipo, param_to, param_wsa) VALUES (
			   $proyecto, 'rest_arai_reportes', 'Servicio Web para acceder a Arai-Reportes', 'rest', NULL, 0);";
