...
class toba_codigo_clase
{
    ...
    public function __construct($nombre, $nombre_ancestro = null)
    {
        $this->nombre = $nombre;
    ...
    public function agregar(toba_codigo_elemento $elemento)
    {
    ...
    public function ultimo_elemento()
    {
        return $this->ultimo_elemento;
    }

    public function agregar_bloque($elementos)
    {
    ...
    */
    public function metodo_php($nombre)
    {
    ...
    */
    public function metodo_js($nombre)
    {
    ...
    public function get_lista_metodos($codigo_existente = '')
    {
        $plan = array();
    ...
    */
    public function generar_lista_elementos($elementos, $prefijo, $codigo_existente = '')
    {
        $lista = array();
        $titulo = '';
        $subtitulo = '';
    ...
    public function agregar_archivo_requerido($require)
    {
        $this->archivos_requeridos[] = $require;
    }

    public function existe_elemento($id)
    {
        return isset($this->indices_php[$id]);
    }

    public function get_indice_metodos_php()
    {
        $indice = array();
    ...
    public function get_codigo($codigo_existente = null, $elementos_a_utilizar = null, $incluir_comentarios = true, $incluir_separadores = true)
    {
    ...
    public function filtrar_contenido($elementos_a_utilizar)
    {
    ...
    */
    public function filtrar_metodos(&$elementos, $elementos_a_utilizar)
    {
    ...
    */
    public function colapsar_separadores(&$elementos)
    {
    ...
    public function filtrar_comentarios()
    {
        // PHP
    ...
    public function filtrar_separadores()
    {
        // PHP
        foreach (array_keys($this->elementos_php) as $id) {
    ...
    public function generar_codigo($codigo_existente)
    {
     ...
     */
    public function generar_propiedades($codigo_existente)
    {
    ...
    public function generar_codigo_php($codigo_existente = '')
    {
        ...
        foreach ($this->elementos_php as $elemento) {
            ...
            if ($elemento instanceof toba_codigo_metodo_php &&
                ...
                //Reemplaza el metodo
                $this->codigo_php = toba_archivo_php::reemplazar_metodo(
                    $this->codigo_php,
                    $elemento->get_nombre(),
                    $elemento->get_codigo()
                );
     ...
     */
    public function generar_codigo_js($codigo_existente = '')
    {
    ...
    public function set_muestra_analisis(ReflectionClass $muestra)
    {
    ...
    public function analizar_php()
    {
        foreach ($this->analisis_muestra->getMethods() as $metodo) {
            $n = $metodo->getName();
            if ($n == 'extender_objeto_js') {
                continue;
            }
    ...
    public function analizar_js()
    {
    }

    public function get_ventanas_utilizadas()
    {
        return $this->analisis_ventanas_utilizadas;
    }

    public function get_ventanas_no_utilizadas()
    {
        return $this->analisis_ventanas_no_utilizadas;
    }

    public function get_metodos_usuario()
    {
