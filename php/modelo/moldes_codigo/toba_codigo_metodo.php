...
abstract class toba_codigo_metodo extends toba_codigo_elemento
{
    ...
    public function __construct($nombre, $parametros = array(), $comentarios = array(), $descripcion = null)
    {
        $this->nombre = $nombre;
    ...
    public function set_mostrar_comentarios($activado = true)
    {
    ...
    public function set_tipo_funcion($tipo)
    {
        $this->tipo_funcion = $tipo;
    }

    public function get_tipo_funcion()
    {
    ...
    abstract public function get_declaracion();
