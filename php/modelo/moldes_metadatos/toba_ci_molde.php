...
class toba_ci_molde extends toba_molde_elemento_componente_ei
{
    ...
    public function asociar_pantalla_dep($pantalla, $dep)
    {
    ...
    public function asociar_pantalla_evento($pantalla, $evento)
    {
        if (!isset($this->mapeo_pantallas[$pantalla])) {
            throw new toba_error_asistentes('Molde CI, asociando a pantallas: La pantalla solicitada no existe.');
        }
    ...
    public function agregar_dep($tipo, $id)
    {
        $clase = $tipo . '_molde';
    ...
    public function asociar_dependencias_a_pantalla()
    {
    ...
    public function asociar_eventos_a_pantallas()
    {
