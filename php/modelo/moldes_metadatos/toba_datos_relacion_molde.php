...
class toba_datos_relacion_molde extends toba_molde_elemento_componente_datos
{
    ...
    //----------------------------------------------------------------------------------------------------------------//
    public function set_ap($ap_clase, $ap_archivo)
    {
    ...
    //----------------------------------------------------------------------------------------------------------------//
    public function agregar_tabla($nombre_tabla)
    {
    ...
    public function agregar_relacion_tablas($tabla_padre, $tabla_hija)
    {
     ...
     */
    public function agregar_columnas_relacionadas($tabla_padre, $tabla_hija, $columna_padre, $columna_hija)
    {
    ...
    public function agregar_definicion_tabla($tabla, $def_fila)
    {
