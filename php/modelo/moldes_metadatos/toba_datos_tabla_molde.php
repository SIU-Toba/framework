...
class toba_datos_tabla_molde extends toba_molde_elemento_componente_datos
{
    ...
    public function get_tabla_nombre()
    {
    ...
    public function set_ap($subclase, $archivo)
    {
    ...
    public function permitir_modificar_pks()
    {
