...
class toba_item_molde extends toba_molde_elemento
{
    ...
    {
        if (!isset($this->ci)) {
            $this->ci = new toba_ci_molde($this->asistente);
        }
        return $this->ci;
    }
    ...
    {
        if (!isset($this->cn)) {
            $this->cn = new toba_cn_molde($this->asistente);
        }
        return $this->cn;
    }
    ...
    public function set_carpeta_item($id)
    {
        $this->datos->tabla('base')->set_fila_columna_valor(0, 'padre', $id);
    }

    public function set_tipo_solicitud($id)
    {
    ...
    public function set_accion($archivo)
    {
    ...
    public function asociar_objeto($clave)
    {
        static $a = 0;
