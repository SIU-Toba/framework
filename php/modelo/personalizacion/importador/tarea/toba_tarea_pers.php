...
abstract class toba_tarea_pers
{
     ...
     */
    public function __construct(toba_importador_plan_item $item_plan, $db)
    {
     ...
     * la personalización
     */
    public function registrar_conflictos($save_to_log = true)
    {
     ...
     * @return boolean
     */
    public function ejecuta_en_transaccion_global()
    {
     ...
     */
    public function set_ejecuta_transaccion_global()
    {
     ...
     */
    public function ejecutar(consola $consola = null)
    {
        ...
        foreach ($this->datos as $registro) {
            ...
            try {
                ...
                if ($this->ejecuta_en_transaccion_global()) {
                    throw $e;
                }		//Si la transaccion esta afuera tiro para arriba la excepcion.
    ...
    public function elegir_camino_accion($usuario_elige_seguir)
    {
