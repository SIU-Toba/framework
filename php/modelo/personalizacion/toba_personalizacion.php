...
class toba_personalizacion
{
    ...
    public const archivo_ini			= 'personalizacion.ini';
    public const dir_personalizacion	= 'personalizacion';

    // Directorios y archivos generados
    public const dir_nuevos		= 'nuevos/';
    public const dir_modificados	= 'modificados/';
    public const dir_borrados		= 'borrados/';
    public const dir_tablas		= 'tablas/';
    public const dir_componentes	= 'componentes/';
    public const dir_metadatos_xml		= 'metadatos/';
    public const dir_metadatos_originales = 'metadatos_originales/';
    public const dir_logs			= 'logs/';
    public const dir_php			= 'php/';
    public const dir_www           = 'www/';
    public const nombre_plan		= 'plan.xml';
    public const template_archivo_componente	= 'comp_%id%.xml';
    public const template_archivo_tabla		= 'tabla_%id%.xml';

    // Nombres de variables en el .ini
    public const iniciada			= 'iniciada';
    public const schema_original	= 'schema_original';
    public const schema_temporal	= 'schema_personalizado';
    public const conf_chequeados	= 'conflictos_chequeados';

    // Estados de los registros
    public const registro_inserted = 1;
    public const registro_updated	= 2;
    public const registro_deleted	= 3;

    // Cadena que representa nulos en los xml de exportación
    public const nulo = '###$$$NULL$$$###';
     ...
     */
    public static function get_registro_conflictos()
    {
    ...
    public static function get_personalizacion_iniciada($proyecto)
    {
    ...
    public function __construct(toba_modelo_proyecto $proyecto, $consola = null)
    {
     ...
     */
    public function chequear_conflictos()
    {
    ...
    public function get_dir_metadatos()
    {
        return $this->dir_metadatos;
    }

    public function get_schema_original()
    {
    ...
    public function get_schema_personalizacion()
    {
    ...
    public function set_ejecucion_con_transaccion_global()
    {
        $this->modo_ejecucion_transcaccional = true;
    }

    public function ejecutar_en_transaccion_global()
    {
