...
class toba_modelo_catalogo
{
    ...
    */
    public static function instanciacion($refrescar = false)
    {
    ...
    */
    public function get_instalacion($manejador_interface = null)
    {
    ...
    */
    public function get_instancia($id_instancia, $manejador_interface = null)
    {
        if (! isset($manejador_interface)) {
            $manejador_interface = new toba_mock_proceso_gui();
        }
    ...
    */
    public function get_proyecto($id_instancia, $id_proyecto, $manejador_interface = null)
    {
     ...
     */
    public function get_pms(toba_modelo_proyecto $proyecto)
    {
    ...
    */
    public function get_nucleo($manejador_interface = null)
    {
    ...
    public static function get_servicio_web($proyecto, $identificador, $manejador_interface = null, $tipo = null)
    {
    ...
    public function get_rdi(toba_modelo_proyecto $proyecto, $manejador_interface = null)
    {
