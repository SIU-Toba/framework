...
{
    public const dir_prefijo = 'i__';
    public const toba_instancia = 'instancia.ini';
    public const toba_instancia_titulo = 'Configuracion de la INSTANCIA';
    public const prefijo_dir_proyecto = 'p__';
    public const dir_datos_globales = 'global';
    public const archivo_datos = 'datos.sql';
    public const archivo_usuarios = 'usuarios.sql';
    public const archivo_logs = 'logs_acceso.sql';
    public const cantidad_seq_grupo = 1000000;
    public const ddl_archivo_tablas_log = 'pgsql_a04_tablas_log_instancia';
    public const archivo_lista_secuencias = '.sequence_list';
    ...
    public function __construct(toba_modelo_instalacion $instalacion, $identificador)
    {
    ...
    public function cargar_info_ini()
    {
    ...
    public function get_parametro_seccion_proyecto($proyecto, $parametro)
    {
    ...
    * @return toba_db
    */
    public function get_db($forzar_recarga = false)
    {
    ...
    */
    public function get_parametros_db()
    {
        return $this->instalacion->get_parametros_base($this->ini_base);
    }

    public function get_schema_db()
    {
     ...
     */
    public function get_dir_instalacion_proyecto($id_proyecto)
    {
     ...
     */
    public function get_ini_base()
    {
        return $this->ini_base;
    }

    public function get_path_proyecto($proyecto)
    {
        if (isset($this->datos_ini[$proyecto]) && isset($this->datos_ini[$proyecto]['path'])) {
    ...
    public function get_url_proyecto($proyecto)
    {
    ...
    public function set_url_proyecto($id_proyecto, $url, $url_full = null)
    {
        $ini = $this->get_ini();
    ...
    public function get_url_proyecto_pers($proyecto)
    {
    ...
    public function set_url_proyecto_pers($id_proyecto, $url)
    {
        $ini = $this->get_ini();
        if ($ini->existe_entrada($id_proyecto)) {
            $conf_proy = $ini->get_datos_entrada($id_proyecto);
    ...
    public function get_fecha_exportacion_local()
    {
     ...
     * @param type $dir
     */
    public function set_dir_carga_proyecto($proyecto, $dir)
    {
     ...
     * @return type
     */
    public function get_dir_carga_proyecto($proyecto)
    {
    ...
    public function vincular_proyecto($proyecto, $path = null, $url = null)
    {
        if (isset($path) || toba_modelo_proyecto::existe($proyecto, false)) {
            ...
            toba_logger::instancia()->error("El proyecto '$proyecto' no existe.");
            throw new toba_error('El proyecto solicitado no existe o no tiene acceso.');
        }
    }
     ...
     */
    public function set_proyectos_vinculados($id_proyectos)
    {
        $ini = $this->get_ini();
    ...
    public function set_proyecto_usar_perfiles_propios($proyecto, $usar_perfiles_propios)
    {
        $ini = $this->get_ini();
    ...
    public function get_proyecto_usar_perfiles_propios($proyecto)
    {
    ...
    public function desvincular_proyecto($proyecto)
    {
        $ini = $this->get_ini();
        $datos =  explode(',', $ini->get_datos_entrada('proyectos'));
     ...
     */
    public function eliminar_proyecto($proy_id, $desinstalar = false)
    {
    ...
    */
    public function exportar($excluir = array())
    {
    ...
    */
    ...
    public function exportar_secuencias()
    {
    ...
    */
    public function exportar_proyectos()
    {
    ...
    public function exportar_local_proyecto($proyecto)
    {
    ...
    public function eliminar_archivos_log()
    {
    ...
    public function generar_ini_rest($id_proyecto)
    {
        try {
    ...
    */
    public function cargar($forzar_carga = false, $forzar_crear_db = false)
    {
    ...
    public function cargar_tablas_minimas($forzar_carga = false)
    {
    ...
    */
    public function crear_modelo_datos_toba()
    {
        $this->crear_tablas();
     ...
     */
    public function crear_modelo_logs_toba()
    {
    ...
    public function get_sql_crear_tablas()
    {
        $directorio = toba_modelo_nucleo::get_dir_ddl();
        $archivos = toba_manejador_archivos::get_archivos_directorio($directorio, '|.*\.sql|');
        sort($archivos);
    ...
    public function eliminar_tablas_minimas()
    {
    ...
    public function get_sql_carga_datos_nucleo()
    {
        $directorio = toba_modelo_nucleo::get_dir_metadatos();
        $archivos = toba_manejador_archivos::get_archivos_directorio($directorio, '|.*\.sql|');
        $salida = "--------------------------------------------------\n";
    ...
    */
    ...
    public function get_sql_carga_proyectos($proyectos)
    {
        $salida = "--------------------------------------------------\n";
    ...
    */
    ...
    public function cargar_informacion_instancia_proyecto($proyecto)
    {
    ...
    public function cargar_informacion_instancia_logs()
    {
     ...
     *
     */
    public function importar_informacion_instancia($instancia_origen, $path_origen, $reemplazar_actuales)
    {
    ...
    */
    public function actualizar_secuencias()
    {
    ...
    public function actualizar_secuencias_tablas_log()
    {
        $seq_data = array();
        $archivo_lista_secuencias = $this->get_dir().'/'. self::archivo_lista_secuencias;
        if (file_exists($archivo_lista_secuencias)) {
    ...
    protected function get_lista_secuencias_basicas()
    {
        ...
        foreach ($tmpsec as $fila) {
            $nombre = $fila['nombre'] ?? $fila['secuencia'] ?? '';
            if ('' != trim($nombre)) {
                $indx = str_replace('"', '', $nombre);
                $secbd[$indx] = $fila;
            }
        }
    ...
    public function ejecutar_sql_actualizacion_secuencias($id_grupo_de_desarrollo, $datos, $seq, $old_seq = null)
    {
    ...
    public function get_sql_actualizar_secuencias()
    {
        $salida = "--------------------------------------------------\n";
     ...
     */
    public function get_grupo_desarrollo_de_valor($valor)
    {
        if (! is_numeric($valor)) {
            return null;
        }
     ...
     */
    public function get_campo_secuencia_de_tabla($tabla)
    {
    ...
    */
    ...
    public function eliminar_schema()
    {
    ...
    */
    ...
    public function get_lista_usuarios($proyecto = null)
    {
        if (isset($proyecto)) {
            $proyecto = $this->get_db()->quote($proyecto);
    ...
    public function get_usuarios_administradores($proyecto, $grupo = 'admin')
    {
        $proyecto = $this->get_db()->quote($proyecto);
    ...
    public function get_registros_tablas()
    {
        $registros = array();
    ...
    public function agregar_usuario($usuario, $nombre, $clave, $email = null, $atributos = array())
    {
    ...
    public function desbloquear_ips()
    {
        $schema_log = $this->get_schema_db(). '_logs';
     ...
     */
    public function cambiar_acceso_usuario($usuario, $accesos)
    {
    ...
    */
    public static function crear_instancia($nombre, $base, $lista_proyectos, $tipo = 'normal')
    {
        //Creo la carpeta
    ...
    public static function dir_instancia($nombre)
    {
        return toba_modelo_instalacion::dir_base() . '/' . self::dir_prefijo . $nombre;
    }

    public static function existe_carpeta_instancia($nombre)
    {
    ...
    */
    public static function get_lista($instalacion = null)
    {
    ...
    public function crear_alias_proyectos()
    {
        foreach ($this->get_lista_proyectos_vinculados() as $id_proyecto) {
            if ($id_proyecto != 'toba') {
                $proyecto = $this->get_proyecto($id_proyecto);
    ...
    //--------------------------  Manejo de Versiones ------------------------
    //------------------------------------------------------------------------
    public function migrar_version($version, $recursivo, $con_transaccion = true)
    {
    ...
    public function ejecutar_ventana_migracion_version($con_transaccion = true)
    {
    ...
    //----------------------------------------------------------------------------
    public function set_revision_proyecto($proyecto, $revision)
    {
    ...
    public function get_revision_proyecto($proyecto)
    {
        $proy_qtd = $this->get_db()->quote($proyecto);
    ...
    public function get_checksum_proyecto($proyecto)
    {
        $proy_qtd = $this->get_db()->quote($proyecto);
    ...
    public function set_checksum_proyecto($proyecto, $checksum)
    {
        $proy_qtd = $this->get_db()->quote($proyecto);
