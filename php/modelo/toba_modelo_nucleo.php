...
class toba_modelo_nucleo extends toba_modelo_elemento
{
    ...
    public static function get_dir_ddl()
    {
        return toba_dir() . '/php/modelo/ddl';
    }

    public static function get_dir_estructura_db()
    {
        return toba_dir() . '/php/modelo/estructura_db';
    }

    public static function get_dir_metadatos()
    {
    ...
    */
    public function exportar(toba_modelo_instancia $instancia)
    {
    ...
    public function exportar_tablas_nucleo(toba_modelo_instancia $instancia)
    {
        try {
    ...
    public function parsear_editores(toba_modelo_instancia $instancia)
    {
    ...
    public function get_archivos_js_propios($patron_incl = null, $patron_excl = null)
    {
    ...
    public function validar_js($patron_incl = null, $patron_excl = null)
    {
    ...
    public function resumir_nucleo()
    {
    ...
    public function cargar_lista_archivos()
    {
