...
{
    public const prefijo_ini = 'pm_';
    public const pm_php  = 'proyecto';
    public const pm_pers = 'personalizacion';
    ...
    public function get_listado($excluir_predefinidos = true)
    {
     ...
     * @return boolean
     */
    public function existe(toba_punto_montaje $punto)
    {
        $id = $punto->get_id();
        if (empty($id)) {
            return false;
     ...
     * @param toba_punto_montaje $punto
     */
    public function guardar(toba_punto_montaje $punto)
    {
     ...
     * @param toba_punto_montaje $punto
     */
    public function baja(toba_punto_montaje $punto)
    {
     ...
     */
    public function crear_pm_proyecto()
    {
     ...
     */
    public function crear_pm_personalizacion()
    {
        $id_proyecto = $this->proyecto->get_id();
     ...
     * @param string $id
     */
    public static function get_pm($id, $proyecto)
    {
        $id = toba::db()->quote($id);
