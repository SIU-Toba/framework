...
class toba_modelo_proyecto extends toba_modelo_elemento
{
    ...
    public const dump_prefijo_componentes = 'dump_';
    public const dump_prefijo_permisos = 'grupo_acceso__';
    public const compilar_archivo_referencia = 'tabla_tipos';
    public const template_proyecto = '/php/modelo/template_proyecto';
    public const patron_nombre_autoload = '%id_proyecto%_autoload';
    public const patron_nombre_autoload_pers = '%id_proyecto%_pers_autoload';
    private static $clases_exc_autoload = array();
    public const tipo_paquete_produccion = 'p';
    public const tipo_paquete_desarrollo = 'd';
    public const tabla_membresias = 'apex_usuario_grupo_acc_miembros';

    public static function set_clases_excluidas_autoload($clases)
    {
        self::$clases_exc_autoload = $clases;
    }

    public static function get_clases_excluidas_autoload()
    {
        return self::$clases_exc_autoload;
    }

    public function __construct(toba_modelo_instancia $instancia, $identificador)
    {
    ...
    public function get_sincronizador()
    {
     ...
     */
    public function get_aplicacion_comando()
    {
     ...
     */
    public function get_aplicacion_modelo()
    {
     ...
     * @param type $dir
     */
    public function set_dir_metadatos($dir = null)
    {
    ...
    public function get_lista_tablas_perfil_datos()
    {
        return array('apex_usuario_perfil_datos',
                     'apex_usuario_perfil_datos_dims');
    }

    public function get_lista_tablas_restricciones()
    {
    ...
    public function get_lista_tablas_menu()
    {
     ...
     */
    public function get_estandar_convenciones()
    {
     ...
     */
    public function get_db($refrescar = false)
    {
     ...
     * @return toba_db
     */
    public function get_db_negocio($fuente = null)
    {
        if (! isset($fuente)) {
     ...
     * @return array
     */
    public function get_parametros_db_negocio()
    {
        $fuentes = $this->get_indice_fuentes();
        if (empty($fuentes)) {
            return;
     ...
     *
     */
    public function maneja_perfiles_produccion()
    {
     ...
     */
    public function construir_id_def_base($nombre_fuente)
    {
        return $this->get_instancia()->get_id().' '.$this->get_id().' '.$nombre_fuente;
    }

    public function get_parametro($seccion, $parametro = null, $obligatorio = true)
    {
    ...
    public function get_descripcion_items($datos)
    {
    ...
    */
    ...
    public function exportar_item($item)
    {
    ...
    public function exportar_componentes_item($item)
    {
    ...
    public function exportar_perfiles()
    {
    ...
    public function exportar_perfiles_produccion()
    {
        ...
        foreach ($this->get_indice_grupos_acceso() as $permiso) {
            ...
            if (!empty($datos)) {
                if (isset($datos[self::tabla_membresias]) && !empty($datos[self::tabla_membresias])) { //Separar las membresias en un archivo aparte
    ...
    //------------------------------------------------------------------------------------------------------------------------------------------------//
    //------------------------------------------------------------------------------------------------------------------------------------------------//
    public static function get_usuario_prueba_db($fuente)
    {
        return "temp_".$fuente;
    }

    public static function get_rol_prueba_db($fuente, $id_operacion)
    {
        return "temp_".$fuente.'_'.$id_operacion;
    }

    public static function get_rol_prueba_db_basico($fuente)
    {
     ...
     */
    public function generar_roles_db($id_operacion = null)
    {
    ...
    public function generar_roles_db_auditoria($conexion, $fuente, $schema, $rol)
    {
    ...
    public function revocar_rol_db_auditoria($conexion, $fuente, $schema, $rol)
    {
        $schema_auditoria = $schema . '_auditoria';
        if ($fuente['tiene_auditoria'] == '1' && $conexion->existe_schema($schema_auditoria)) {		//Le doy permisos al esquema de auditoria, sino no se puede usar en el desarrollo
     ...
     */
    public function crear_script_generacion_roles_db($dir = '', $perfiles_eliminados = array())
    {
        $sentencias = array();
        $fuentes = array();
        $sql = array();
     ...
     * @return array
     */
    public function get_tablas_permitidas_x_fuente($fuente, $operaciones)
    {
    ...
    */
    public function cargar_autonomo()
    {
    ...
    */
    ...
    public function get_sql_cargar_tablas()
    {
        $salida = '';
        $archivos = toba_manejador_archivos::get_archivos_directorio($this->get_dir_tablas(), '|.*\.sql|');
        foreach ($archivos as $archivo) {
    ...
    public function get_sql_cargar_componentes()
    {
        $salida = '';
        $subdirs = toba_manejador_archivos::get_subdirectorios($this->get_dir_componentes());
        foreach ($subdirs as $dir) {
    ...
    public function get_sql_carga_reducida()
    {
    ...
    */
    public function cargar_informacion_reducida()
    {
    ...
    public function publicar($url = null, $full_url = null)
    {
        if (! $this->esta_publicado()) {
            ...
            toba_modelo_instalacion::agregar_alias_apache(
                $url,
                $this->get_dir(),
    ...
    public function publicar_pers($url = null)
    {
    ...
    public function esta_publicado()
    {
        return toba_modelo_instalacion::existe_alias_apache($this->get_id());
    }

    public function esta_publicado_pers()
    {
    ...
    */
    public function eliminar_autonomo()
    {
        try {
            $this->db->abrir_transaccion();
            $this->db->retrasar_constraints();
    ...
    */
    public function compilar_componentes()
    {
    ...
    */
    public function compilar_componente($tipo, $id, $directorio)
    {
    ...
    */
    public function compilar_metadatos_generales()
    {
    ...
    */
    public function compilar_metadatos_generales_grupos_acceso($limpiar_existentes = false)
    {
        toba_proyecto_db::set_db($this->db);
    ...
    */
    public function compilar_metadatos_generales_mensajes()
    {
    ...
    */
        ...
        foreach (toba_info_editores::get_lista_items() as $item) {
            ...
            foreach ($arbol as $componente) {
                ...
                if (! in_array($nombre_clase, $clases_creadas)) {
                    $clase = new toba_clase_datos($nombre_clase);
                    $metadatos = toba_cargador::instancia()->get_metadatos_extendidos(
                        $componente,
                        $tipo,
                        $this->db
                    );
     ...
     */
    public function generar_autoload(consola $consola, $generar_vacio = false, $ret_obj_autoload = false, $generar_solo_pers = false)
    {
     ...
     * @return boolean
     */
    public function es_personalizable()
    {
     ...
     * @return boolean
     */
    public function tiene_clases_extendidas($de)
    {
        if ($de == 'toba') {
    ...
    public function tiene_clases_toba_extendidas()
    {
        $db	= $this->get_db();
    ...
    public function tiene_clases_proyecto_extendidas()
    {
        $db	= $this->get_db();
        $id_proyecto = $db->quote($this->get_id());
    ...
    public function get_clases_componentes_proyecto()
    {
    ...
    public function get_clases_componentes_personalizacion()
    {
        $comp_de_toba = $this->get_componentes_toba();
        $id_proyecto = $this->get_id();
        $clases = array();
    ...
    public function set_pm_defecto($punto)
    {
        $db = $this->get_db();
    ...
    public function agregar_dependencia($id_proyecto)
    {
    ...
    public function quitar_dependencia($id_proyecto)
    {
        $deps  = $this->get_dependencias();
     ...
     * @return boolean
     */
    public function cumple_dependencias()
    {
        return count($this->get_dependencias_faltantes()) > 0;
    }

    public function get_dependencias_faltantes()
    {
        $deps = $this->get_dependencias();
    ...
    public function get_lista_grupos_acceso()
    {
    ...
    public function get_resumen_componentes_utilizados()
    {
    ...
    public function get_indice_grupos_acceso()
    {
    ...
    public function get_indice_fuentes()
    {
    ...
    public function get_indice_permisos()
    {
    ...
    public function get_indice_zonas()
    {
    ...
    public function get_indice_mensajes($proyecto = null)
    {
    ...
    public function get_indice_mensajes_objeto($objeto)
    {
    ...
    public function get_indice_dimensiones()
    {
    ...
    public function get_indice_consultas_php()
    {
    ...
    */
    public function get_lista_tipo_componentes()
    {
    ...
    */
    public function get_lista_componentes($tipo_componente)
    {
    ...
    */
    public function get_grupo_acceso_admin()
    {
    ...
    public function vincular_usuario($usuario, $perfil_acceso, $perfil_datos = array(), $set_previsualizacion = true)
    {
        //-- Perfiles Funcionales
    ...
    public function desvincular_usuario($usuario)
    {
    ...
    public function get_item_login()
    {
        $proyecto = $this->db->quote($this->identificador);
     ...
     */
    public function actualizar_login($pisar_anterior = false, $pm_destino = null)
    {
    ...
    //-------------------------- Manejo de Versiones --------------------------
    //------------------------------------------------------------------------
    public function migrar_rango_versiones($desde, $hasta, $recursivo, $con_transaccion = true)
    {
    ...
    public function migrar_version($version)
    {
    ...
    public function ejecutar_migracion_particular(toba_version $version, $metodo)
    {
        $this->get_db()->abrir_transaccion();
     ...
     * @return toba_version
     */
    public function get_version_proyecto()
    {
        $modelo = $this->get_aplicacion_modelo();
        if (! isset($modelo)) {
            $path_ini = $this->get_dir().'/proyecto.ini';
     ...
     */
    public function empaquetar($tipo_paquete, $es_legacy = false)
    {
        $nombre_ini = 'proyecto.ini';
        $path_ini = $this->get_dir().'/'.$nombre_ini;
        if (! file_exists($path_ini)) {
     ...
     */
    public function migrar_datos_negocio(toba_version $desde, toba_version $hasta)
    {
        $aplicacion = $this->get_aplicacion_modelo();
        if (isset($aplicacion)) {
    ...
    */
    public static function get_lista($usar_cache = true)
    {
    ...
    */
    public static function existe($nombre, $cache = true)
    {
    ...
    */
    public static function crear(toba_modelo_instancia $instancia, $nombre, $usuarios_a_vincular, $dir_inst_proyecto = null)
    {
        //- 1 - Controles
        $dir_template = toba_dir() . self::template_proyecto;
        if ($nombre == 'toba') {
        ...
        try {
            ...
            try {
                ...
                $sql_version = self::get_sql_actualizar_version(
                    toba_modelo_instalacion::get_version_actual(),
                    $nombre
                );
    ...
    */
    public static function get_sql_metadatos_basicos($id_proyecto)
    {
        // Creo el proyecto
    ...
    public static function do_vincular_usuario($db, $proyecto, $usuario, $perfiles_acceso = array(), $perfiles_datos = array(), $set_previsualizacion = true, $url = null)
    {
        $sql = array();
    ...
    public function chequear_actualizacion_prematura()
    {
    ...
    public function generar_estado_codigo()
    {
    ...
    public function generar_checksum()
    {
        $checksum_actual = toba_manejador_archivos::get_checksum_directorio($this->get_dir_dump());
        $this->instancia->set_checksum_proyecto($this->identificador, $checksum_actual);
    }

    public function eliminar_permisos_editables()
    {
    ...
    public function get_servicios_web_ofrecidos()
    {
        $sql = "
			SELECT
    ...
    public function desactivar_servicios_web()
    {
        $desactivados = array();
    ...
    public function get_documentacion_rest()
    {
        ...
        $es_produccion = (bool) $this->get_instalacion()->es_produccion();
