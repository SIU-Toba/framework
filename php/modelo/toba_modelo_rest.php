...
{
    public const CARPETA_REST_BASE = '/rest';
    public const CARPETA_REST_PROVEEDOR = '/api_servidor';
    public const CARPETA_REST_CLIENTE = '/api_cliente';

    public const ARCHIVO_CLIENTE = '/cliente.ini';
    public const ARCHIVO_USUARIOS = '/servidor_usuarios.ini';
    public const ARCHIVO_SERVER = '/servidor.ini';

    public const CARPETA_REST =  '/rest';

    public const TIPO_SERVER = 'SERVER';
    public const TIPO_SERVER_USR = 'SERVER_USUARIO';
    ...
    public static function get_path_archivo(toba_modelo_proyecto $proyecto, $tipo_archivo, $nombre_api = '')
    {
        $archivo = '';
        switch ($tipo_archivo) {
     ...
     * @return toba_ini
     */
    public static function get_ini_server(toba_modelo_proyecto  $proyecto, $nombre_api = '')
    {
     ...
     * @return toba_ini
     */
    public static function get_ini_cliente(toba_modelo_proyecto  $proyecto, $nombre_api = '')
    {
     ...
     * @return boolean
     */
    public static function existe_ini_server(toba_modelo_proyecto  $proyecto, $nombre_api = '')
    {
        $archivo = self::get_path_archivo($proyecto, self::TIPO_SERVER, $nombre_api);
     ...
     * @return boolean
     */
    public static function existe_ini_usuarios(toba_modelo_proyecto  $proyecto, $nombre_api = '')
    {
        $archivo = self::get_path_archivo($proyecto, self::TIPO_SERVER_USR);
        return file_exists($archivo);
    }
     ...
     * @return boolean
     */
    public static function existe_ini_cliente(toba_modelo_proyecto  $proyecto, $nombre_api = '')
    {
        $archivo = self::get_path_archivo($proyecto, self::TIPO_CLIENTE, $nombre_api);
        return file_exists($archivo);
    }
     ...
     * @param string $nombre_api
     */
    public static function cp_ini_cliente($path_origen, toba_modelo_proyecto  $proyecto, $nombre_api = '')
    {
     ...
     * @param string $nombre_api
     */
    public static function cp_ini_server($path_origen, toba_modelo_proyecto  $proyecto, $nombre_api = '')
    {
     ...
     * @param string $nombre_api
     */
    public static function cp_ini_usuarios($path_origen, toba_modelo_proyecto  $proyecto, $nombre_api = '')
    {
        $archivo = self::get_path_archivo($proyecto, self::TIPO_SERVER_USR);
        copy($path_origen, $archivo);
    }
     ...
     * @return string
     */
    public static function get_dir_proveedor($path, $nombre_api = '')
    {
     ...
     * @return string
     */
    public static function get_dir_consumidor($path, $nombre_api = '')
    {
        $dir = $path . self::CARPETA_REST_BASE;
    ...
    public static function inicializar_archivos_config_servidor($proyecto, $id_proyecto)
    {
    ...
    public static function inicializar_archivos_config_cliente($proyecto, $id_servicio)
    {
    ...
    public function generar_configuracion_cliente($id_servicio, $cert_CA, $url, $cert_cli, $key_cli, $cert_pwd, $usr, $usr_pwd, $tipo_auth, $api_version)
    {
        ...
        if (! is_null($usr)) {
            ...
            if (! is_null($cert_pwd)) {
                $datos['cert_pwd'] =  $cert_pwd;
            }
            if (! is_null($cert_CA)) {
                $datos['ca_cert'] = $cert_CA;
            }
            if ($auth_basica === true) {
                $this->manejador_interface->mensaje("El tipo de autenticacion no coincide con los parametros entregados");
                die;
    ...
    public function generar_configuracion_servidor($usr, $usr_pwd, $cert_file = null, $tipo_auth = 'digest', $encoding = 'utf-8')
    {
