...
class toba_modelo_servicio_web extends toba_modelo_elemento
{
    ...
    public function __construct(toba_modelo_proyecto $proyecto, $identificador, $tipo = 'soap')
    {
    ...
    public function set_tipo_ws($tipo)
    {
        $this->rest = (strtolower($tipo) == 'rest');
    }
     ...
     */
    public function set_ws_addressing($estado)
    {
        $this->wsa = $estado;
    }
     ...
     */
    public function agregar_parametros($parametros = array())
    {
        $this->parametros_ws = $parametros;
    }

    //--------------------------------------------------------------------------------------------------------------------//
    public static function path_clave_privada(toba_modelo_proyecto $proyecto)
    {
        return toba_modelo_soap::path_clave_privada($proyecto);
    }

    public static function path_clave_publica(toba_modelo_proyecto $proyecto)
    {
        return toba_modelo_soap::path_clave_publica($proyecto);
    }

    public static function existe_archivo_certificado(toba_modelo_proyecto $proyecto)
    {
     ...
     */
    public function crear_servicio_web()
    {
        if (! $this->rest) {
     ...
     */
    public function generar_configuracion_cliente($cert_servidor, $url_sistema, $cert_cli = null, $key_cli = null, $cert_pwd = null, $usr = null, $usr_pwd = null, $tipo_auth = null, $api_version = null)
    {
        if (! $this->rest) {
            $soap = new toba_modelo_soap($this->proyecto);
     ...
     * @param cert_cliente
     */
    public function generar_configuracion_servidor($cert_cliente, $headers = array())
    {
        if (! $this->rest) {
            $soap = new toba_modelo_soap($this->proyecto);
     ...
     */
    public static function generar_certificados(toba_modelo_proyecto $proyecto, $directorio = null, $rest = false)
    {
