...
{
    public const ARCHIVO_CLIENTE = '/cliente.ini';
    public const ARCHIVO_SERVER = '/servicio.ini';
    public const ARCHIVO_CLAVE = '/privada.key';
    public const ARCHIVO_CERT = '/publica.crt';
    public const ARCHIVO_CERT_SERVER = '/cert_servidor.crt';

    public const CARPETA_SOAP_BASE = '';
    public const CARPETA_SOAP_PROVEEDOR = '/servicios_serv';
    public const CARPETA_SOAP_CLIENTE = '/servicios_cli';
    public const URL_BASE = '/servicios.php/';

    protected $proyecto;
    protected $db;

    public function __construct(toba_modelo_proyecto $proyecto)
    {
     ...
     * @return string
     */
    public static function path_clave_privada($proyecto)
    {
     ...
     * @return string
     */
    public static function path_clave_publica($proyecto)
    {
     ...
     * @return array
     */
    public static function get_lista_servicios_consumibles(toba_modelo_proyecto $proyecto)
    {
     ...
     * @return toba_ini
     */
    public static function get_ini_server(toba_modelo_proyecto  $proyecto, $id_servicio = '')
    {
     ...
     * @return toba_ini
     */
    public static function get_ini_cliente(toba_modelo_proyecto  $proyecto, $id_servicio = '')
    {
    ...
    public static function get_clave_privada(toba_modelo_proyecto $proyecto, $id_servicio = '')
    {
     ...
     * @return toba_ini
     */
    public static function get_ini_usuarios(toba_modelo_proyecto  $proyecto)
    {
    }
     ...
     * @return boolean
     */
    public static function existe_ini_server(toba_modelo_proyecto  $proyecto, $id_servicio = '')
    {
        $directorio = self::get_dir_proveedor($proyecto->get_dir_instalacion_proyecto(), $id_servicio);
     ...
     * @return boolean
     */
    public static function existe_ini_cliente(toba_modelo_proyecto  $proyecto, $id_servicio = '')
    {
        $directorio = self::get_dir_consumidor($proyecto->get_dir_instalacion_proyecto(), $id_servicio);
     ...
     * @return boolean
     */
    public static function existe_archivo_certificado(toba_modelo_proyecto $proyecto, $id_servicio = '')
    {
     ...
     * @return boolean
     */
    public static function existe_ini_usuarios(toba_modelo_proyecto  $proyecto, $id_servicio = '')
    {
    }
     ...
     * @param string $id_servicio
     */
    public static function cp_ini_cliente($path_origen, toba_modelo_proyecto  $proyecto, $id_servicio = '')
    {
        $directorio =  self::get_dir_consumidor($proyecto->get_dir_instalacion_proyecto(), $id_servicio);
     ...
     * @param string $id_servicio
     */
    public static function cp_ini_server($path_origen, toba_modelo_proyecto  $proyecto, $id_servicio = '')
    {
        $directorio = self::get_dir_proveedor($proyecto->get_dir_instalacion_proyecto(), $id_servicio);
        toba_manejador_archivos::crear_arbol_directorios($directorio);
     ...
     * @param string $id_servicio
     */
    public static function cp_ini_usuarios($path_origen, toba_modelo_proyecto  $proyecto, $id_servicio = '')
    {
    }
     ...
     * @return string
     */
    public static function get_dir_proveedor($path, $id_servicio = '')
    {
        $dir = $path . self::CARPETA_SOAP_BASE  . self::CARPETA_SOAP_PROVEEDOR;
        if (trim($id_servicio) != '') {
            $dir = $dir . '/' . trim($id_servicio);
        }
        return $dir;															//BC
    }
     ...
     * @return string
     */
    public static function get_dir_consumidor($path, $id_servicio = '')
    {
     ...
     * @param string $dir
     */
    public static function crear_directorio_destino($dir, $id_proyecto = '')
    {
     ...
     * @return string
     */
    public static function get_url_base($proyecto)
    {
     ...
     * @return string
     */
    public static function get_dir_api_base($proyecto)
    {
     ...
     * @return string
     */
    public static function get_dir_api_personalizacion($proyecto)
    {
     ...
     */
    public static function set_estado_activacion(toba_modelo_proyecto $proyecto, $id_servicio, $estado = 0)
    {
     ...
     * @return boolean
     */
    public static function esta_activo(toba_modelo_proyecto $proyecto, $id_servicio)
    {
        $activo = false;
        $ini = self::get_ini_server($proyecto, $id_servicio);
     ...
     * @return string
     */
    public static function generar_id_entrada_cliente($headers)
    {
        $nombre = array();
        ksort($headers);
     ...
     */
    public function crear_servicio_web($identificador, $wsa, $parametros_ws)
    {
        $sqls = array();
     ...
     */
    public function generar_configuracion_cliente($cert_servidor, $url_sistema, $id_servicio)
    {
     ...
     * @param cert_cliente
     */
    public function generar_configuracion_servidor($cert_cliente, $headers = array(), $id_servicio = '')
    {
        $this->crear_directorio_destino($this->proyecto->get_dir_instalacion_proyecto());
     ...
     * @return string
     */
    public function generar_documentacion($carpeta_doc, $forzar_reemplazo = false)
    {
    ...
    public function get_encabezado_doc($proyecto)
    {
        $html = "<html><head>
