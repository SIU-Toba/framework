...
class util_modelo_proyecto
{
     ...
     */
    public static function extender_componentes(toba_modelo_proyecto $proyecto, $path, $tipo = 'toba')
    {
    ...
    public static function get_componentes_toba(toba_modelo_proyecto $proyecto)
    {
     ...
     */
    public static function revincular_componentes(toba_modelo_proyecto $proyecto, $de = 'toba', $a = 'proyecto')
    {
    ...
    public static function get_clases_componentes_toba(toba_modelo_proyecto $proyecto)
    {
        $db = $proyecto->get_db();
    ...
    private static function get_clases(toba_modelo_proyecto $proyecto, $de, $a, &$clases_de, &$clases_a)
    {
     ...
     * @param string $tipo valores posibles: toba | proyecto
     */
    public static function marcar_clases_extendidas(toba_modelo_proyecto $proyecto, $tipo = 'toba')
    {
        $db	= $proyecto->get_db();
    ...
    public static function crear_arbol_personalizacion($path_proyecto)
    {
    ...
    public static function extender_clases(toba_modelo_proyecto $proyecto, $consola, $de)
    {
        $seguir = true;
