...
class tp_logon extends tp_basico
{
	...
	{
		echo "<div style='padding-top: 25px;' class='portada-comentario'>Desarrollado por el programa 
			<b><a href='http://www.siu.edu.ar' style='text-decoration: none' target='_blank'>SIU<a/><b></div>
