...
class toba_boton
{
    ...
    public function __construct($datos = null, $contenedor = null)
    {
        if (isset($datos)) {
            $this->datos = $datos;
        } else {
     ...
     * @return boolean
     */
    public function posee_confirmacion()
    {
     ...
     */
    public function get_imagen_url_rel()
    {
     ...
     */
    public function get_msg_confirmacion()
    {
     ...
     */
    public function set_etiqueta($texto)
    {
     ...
     */
    public function set_msg_ayuda($texto)
    {
    ...
    public function set_imagen($url_relativa, $origen = 'apex')
    {
        if ($origen != 'apex' &&  $origen != 'proyecto') {
            ...
            throw new toba_error_def('EVENTO: El origen de la imagen no es válido, revise el log');
        }
     ...
     */
    public function set_msg_confirmacion($texto)
    {
     ...
     * @param string $estilo
     */
    public function set_estilo_css($estilo)
    {
    ...
    public function set_en_botonera($en_botonera = true)
    {
        $this->datos['en_botonera'] = $en_botonera;
    }

    public function set_nivel_de_fila($a_nivel_fila = false)
    {
