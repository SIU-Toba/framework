...
class toba_evento_usuario extends toba_boton
{
    ...
    * @return toba_vinculo
    */
    public function vinculo($forzar_instancia = false)
    {
     ...
     */
    public function get_id_metadato()
    {
    ...
    public function es_seleccion_multiple()
    {
        return (isset($this->datos['es_seleccion_multiple']) && $this->datos['es_seleccion_multiple'] == '1');
    }

    public function tiene_alineacion_pre_columnas()
    {
        return $this->tiene_alineacion_pre_columnas;
    }

    public function posee_accionar_diferido()
    {
        return $this->accion_disparo_diferido;
    }
    //--------- Seters ---------------------

    public function set_parametros($parametros = null)
    {
        $this->parametros = $parametros;
    }

    public function set_vista_previa_impresion($estado = true)
    {
        $this->datos['accion_imphtml_debug'] = $estado;
    }

    public function set_maneja_datos($maneja)
    {
     ...
     */
    public function set_seleccion_multiple()
    {
     ...
     */
    public function set_accion_respuesta_popup($accion)
    {
        if (($accion == '') || ($accion == 'P')) {
     ...
     */
    public function set_accion_xslfo()
    {
        $this->datos['accion'] = 'xslfo';
    }

    public function set_accion_imprimir()
    {
        $this->datos['accion'] = 'H';
    }

    public function set_accion_jasperreports()
    {
        $this->datos['accion'] = 'jasperreports';
    }

    public function set_accion_araireportes()
    {
        $this->datos['accion'] = 'araireportes';
    }

    public function set_check_activo($activo)
    {
        $this->es_check_activo = $activo;
    }

    public function set_alineacion_pre_columnas($valor = true)
    {
        $this->tiene_alineacion_pre_columnas = $valor;
    }

    public function set_disparo_diferido($disparo_diferido)
    {
     ...
     */
    public function get_html($id_submit, $objeto_js, $id_componente)
    {
     ...
     */
    public function get_html_evento_diferido($id_submit, $fila, $objeto_js, $id_componente)
    {
        if ($this->anulado) {
            return null;
        }
     ...
     *	Genera el evento JS
     */
    public function get_evt_javascript()
    {
        $evento = array();
     ...
     */
    public function get_invocacion_js($objeto_js = null, $id_componente = null)
    {
        if (! isset($objeto_js)) {
