...
class toba_carga_opciones_ef
{
     ...
     */
    public function __construct($componente, $efs, $parametros_carga)
    {
        if (! isset($efs)) {
            $efs = array();
        }
     ...
     * @ignore
     */
    public function registrar_cascadas()
    {
    ...
    public function get_cascadas_esclavos()
    {
        return $this->_cascadas_esclavos;
    }

    public function get_cascadas_maestros()
    {
     ...
     * @ignore
     */
    public function ejecutar_metodo_carga_ef($id_ef, $maestros = array())
    {
     ...
     * @ignore
     */
    public function ajustar_descripciones($id_ef, $datos)
    {
     ...
     * @ignore
     */
    public function ejecutar_metodo_carga_descripcion_ef($id_ef, $maestros = array())
    {
    ...
    protected function ef_metodo_carga_php($id_ef, $parametros, $maestros)
    {
        ...
        if (isset($parametros['carga_include']) || isset($parametros['carga_clase'])) {
            ...
            return call_user_func_array($metodo, array_values($maestros));
        } else {
            ...
            $dato = call_user_func_array(array($this->_controlador->controlador(), $parametros['carga_metodo']), array_values($maestros));
            return $dato;
        }
    }
    ...
    protected function ef_metodo_carga_consulta_php($id_ef, $parametros, $maestros)
    {
        if (isset($parametros['carga_consulta_php_clase'])) {
            ...
            return call_user_func_array(array($objeto, $metodo), array_values($maestros));
        }
    }
    ...
    protected function ef_metodo_carga_dt($id_ef, $parametros, $maestros)
    {
        ...
        return call_user_func_array(array($dt, $parametros['carga_metodo']), array_values($maestros));
    }
