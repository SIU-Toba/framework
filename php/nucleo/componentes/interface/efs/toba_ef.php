...
abstract class toba_ef
{
    ...
    protected static $_excepciones;
    protected static $maximo_descripcion;


    public static function set_maximo_descripcion($maximo)
    {
        self::$maximo_descripcion = $maximo;
    }

    public static function get_maximo_descripcion()
    {
     ...
     * @ignore
     */
    public static function get_lista_parametros_carga()
    {
        return array();
    }
     ...
     * @ignore
     */
    public static function get_lista_parametros_carga_basico()
    {
        return array(
            'carga_metodo',
            'carga_clase',
     ...
     * @return boolean
     */
    public function es_seleccionable()
    {
        return false;
    }
    /**
     ...
     * @return boolean
     */
    public function permite_seleccion_multiple()
    {
        return false;
    }
     ...
     * @return boolean
     */
    public function es_estado_unico()
    {
        return true;
    }
     ...
     * @return boolean
     */
    public function carga_depende_de_estado()
    {
        return false;
    }
    ...
    public static function set_excepciones($excepciones)
    {
        self::$_excepciones = $excepciones;
    }

    public static function get_excepciones()
    {
     ...
     * @return array
     */
    public function get_campos_clave()
    {
     ...
     */
    public function get_campo_valor()
    {
     ...
     * @return boolean
     */
    public function son_campos_posicionales()
    {
     ...
     * @ignore
     */
    public function quitar_maestro($maestro)
    {
    ...
    public function clave_memoria($multiplexado = true)
    {
        if ($multiplexado) {
     ...
     * @return boolean
     */
    public function tiene_opciones_cargadas()
    {
     ...
     * @return string
     */
    public function get_estilo_etiqueta()
    {
     ...
     * @see set_expandido
     */
    public function esta_expandido()
    {
     ...
     * @return string
     */
    public function get_id_form_orig()
    {
     ...
     * @return string
     */
    public function get_descripcion_estado($tipo_salida)
    {
     ...
     */
    public function set_estado_defecto($estado)
    {
     ...
     * @return mixed
     */
    public function normalizar_parametro_cascada($parametro)
    {
        return $parametro;
    }
     ...
     */
    public function ir_a_fila($agregado = "")
    {
     ...
     */
    public function set_solo_lectura($solo_lectura = true)
    {
    ...
    public function es_solo_lectura()
    {
     ...
     */
    public function set_obligatorio($obligatorio = true)
    {
     ...
     * @param string $estilo
     */
    public function set_estilo_etiqueta($estilo)
    {
     ...
     */
    public function set_permitir_html($permitir)
    {
     ...
     */
    public function set_tamano($tamanio)
    {
        $this->tamano = $tamanio;
    }
     ...
     */
    public function set_iconos_utilerias($iconos)
    {
        $this->iconos = array();
     ...
     */
    public function agregar_icono_utileria(toba_ef_icono_utileria $icono)
    {
        $this->iconos[] = $icono;
    }

    public function get_html_iconos_utilerias()
    {
        $salida = '';
     ...
     */
    public function cargar_estado_post()
    {
    ...
    public function guardar_dato_sesion($dato, $multiplexado = false)
    {
        if (isset($dato)) {
     ...
     */
    public function crear_objeto_js()
    {
     ...
     */
    public function set_cuando_cambia_valor($js)
    {
     ...
     */
    abstract public function get_input();
