...
class toba_ef_combo_editable extends toba_ef_seleccion
{
    ...
    public function set_opciones($descripcion, $maestros_cargados = true, $tiene_maestros = false)
    {
    ...
    public function set_modo_filtrado($estado)
    {
        $this->habilitar_modo_filtrado = $estado;
    }

    public function set_modo_solo_selecciones($estado)
    {
