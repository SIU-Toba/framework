...
class toba_ef_cuit extends toba_ef
{
    ...
    protected static $_prefijos_validos = [20, 23, 24, 27, 30, 33, 34];
     ...
     */
    public static function set_prefijos(array $prefijos)
    {
        if (! empty($prefijos)) {
    ...
    public function desactivar_validacion($desactivar)
    {
        $this->_desactivar_validacion = $desactivar;
    }

    public function get_desactivar_validacion()
    {
    ...
    public static function validar_cuit($cuit_rearmado)
    {
        if (isset(self::$_excepciones)) {
