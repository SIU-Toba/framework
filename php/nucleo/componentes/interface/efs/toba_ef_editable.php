...
class toba_ef_editable extends toba_ef
{
    ...
    public static function set_callback_errores_validacion(toba_callback_errores_validacion $callback)
    {
     ...
     */
    public static function set_tamano_multiplicado_pixels($porcentaje = 1)
    {
        self::$ratio_pixel = $porcentaje;
    }

    public static function set_limite_minimo_caracteres($cantidad)
    {
    ...
    public function set_expreg($expreg)
    {
        $this->expreg = $expreg;
    }
     ...
     */
    public function set_opciones($opciones, $maestros_cargados = true)
    {
    ...
    public function set_placeholder($msj)
    {
    ...
    public function get_estilo_visualizacion_pixeles()
    {
...
class toba_ef_editable_numero extends toba_ef_editable
{
     ...
     */
    public function cambiar_rango($rango)
    {
        //Parseo del rango
        $limitadores = array('[', ']', '(', ')');
...
{
    protected static $rango_fechas_global;
    ...
    */
    public static function set_rango_valido_global($desde, $hasta)
    {
     ...
     */
    public function set_rango_valido($desde, $hasta)
    {
