...
class toba_ef_editable_captcha extends toba_ef_editable
{
    ...
    */
    ...
    public function set_permite_refrescar_codigo($permite = true)
    {
        $this->permite_refrescar_codigo = $permite;
    }

    public function set_permite_generar_audio($permite = true)
    {
        $this->permite_generar_audio = $permite;
    }

    public function set_longitud_codigo($longitud)
    {
        $this->longitud = $longitud;
    }

    public function es_legacy_ef(): bool
    {
        return $this->legacyEf;
    }

    public function set_antispam_obj($obj)
    {
        $this->antispam = $obj;
    }
     ...
     */
    public function generar_texto_aleatorio()
    {
        if ($this->es_legacy_ef()) {
    ...
    public function get_input_legacy()
    {
