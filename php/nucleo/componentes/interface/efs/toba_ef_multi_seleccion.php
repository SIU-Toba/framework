...
abstract class toba_ef_multi_seleccion extends toba_ef
{
    ...
    public function set_opciones($datos, $maestros_cargados = true, $tiene_maestros = false)
    {
    ...
    public function get_estado()
    {
        if ($this->tiene_estado()) {
            if ($this->serializar !== false) {
                return implode($this->serializar, $this->estado);
            } else {
                return $this->estado;
            }
        } else {
...
class toba_ef_multi_seleccion_check extends toba_ef_multi_seleccion
{
    ...
    public function set_cantidad_columnas($cantidad)
    {
        $this->cantidad_columnas = $cantidad;
    }

    public function es_multicolumna()
    {
