...
class toba_ef_popup extends toba_ef_editable
{
    ...
    public function set_opciones($descripcion, $maestros_cargados = true)
    {
    ...
    public function set_puede_borrar_estado($puede = true)
    {
        $this->no_oblig_puede_borrar = $puede;
    }

    public function set_imagen_editar($url)
    {
    ...
    public function get_imagen_abrir()
    {
    ...
    public function set_img_editar($img, $tooltip = "Seleccionar un elemento")
    {
        $this->img_editar = toba_recurso::imagen_proyecto($img, true, null, null, $tooltip);
    }

    public function get_imagen_limpiar()
    {
    ...
    public function set_img_limpiar($img, $tooltip = "Limpia la selección actual")
    {
