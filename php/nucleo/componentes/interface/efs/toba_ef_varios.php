...
class toba_ef_fijo extends toba_ef_oculto
{
    ...
    public function set_estado($estado = null)
    {
        /*
...
class toba_ef_html extends toba_ef
{
    ...
    protected static $config_global;
     ...
     * @return fckeditor
     */
    public function get_editor($valor)
    {
        $name = $this->id_form;
        $attr = '';
    ...
    public function set_barra_colapsada($colapsada)
    {
        $this->colapsada = $colapsada;
    }

    public function set_botonera($botonera)
    {
    ...
    public function set_path_template($path)
    {
        $this->templates_ck = $path;
    }

    public function set_config_file($path)
    {
        $this->config_file = $path;
    }

    public static function set_global_cfg_file($path)
    {
        self::$config_global = $path;
    }

    public static function set_skin($eskin)
    {
        self::$skin = $eskin;
    }
