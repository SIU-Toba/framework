...
abstract class toba_filtro_columna
{
     ...
     * @param toba_ei $padre
     */
    public function __construct($datos, $padre)
    {
        $this->_datos = $datos;
        $this->_padre = $padre;
     ...
     * @param string $campo
     */
    public function set_expresion($campo)
    {
     ...
     */
    public function agregar_condicion($id, toba_filtro_condicion $condicion)
    {
     ...
     * @param mixed $id
     */
    public function borrar_condicion($id)
    {
     ...
     * @param mixed $funcion
     */
    public function set_formateo($funcion)
    {
     ...
     * @return integer
     */
    public function get_cant_condiciones()
    {
     ...
     * @return boolean
     */
    public function hay_condicion_fija()
    {
        $hay_fija = false;
     ...
     */
    public function set_condicion_fija($nombre, $estado = true)
    {
     ...
     * @param string $nombre
     */
    public function set_condicion_default($nombre)
    {
        if (!isset($this->_condiciones[$nombre])) {
            toba_logger::instancia()->error("No existe la condición '$nombre' para la columna '". $this->get_nombre()."'");
            throw new toba_error_def('No existe la condición señalada para la columna indicada, revise el log');
     ...
     */
    public function eliminar_condicion_default()
    {
     ...
     * @return boolean
     */
    public function hay_condicion_default()
    {
     ...
     */
    public function condicion($nombre = null)
    {
        if (! isset($nombre)) {
     ...
     * @throws toba_error_def
     */
    public function set_condicion(toba_filtro_condicion $condicion, $nombre = null)
    {
        if (! isset($nombre)) {
            if (isset($this->_estado)) {
     ...
     * @return string
     */
    public function get_html_condicion()
    {
     ...
     */
    public function get_html_valor()
    {
     ...
     * @return string
     */
    public function get_html_etiqueta()
    {
        $html = '';
        $marca = '';
    ...
    public function get_pdf_valor()
    {
        $valor = $this->_ef->get_descripcion_estado('pdf');
        return $valor;
    }

    public function get_excel_valor()
    {
