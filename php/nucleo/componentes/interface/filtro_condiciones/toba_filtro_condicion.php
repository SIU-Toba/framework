...
class toba_filtro_condicion
{
    ...
    public function __construct($etiqueta = '', $operador_sql = '', $pre = '', $post = '', $casting_izq = '', $casting_der = '')
    {
    ...
    public function set_operador_sql($operador)
    {
        $this->operador_sql = $operador;
    }

    public function set_post_valor($cadena)
    {
        $this->post = $cadena;
    }

    public function set_pre_valor($cadena)
    {
        $this->pre = $cadena;
    }

    public function set_casting_izq($casting)
    {
        $this->casting_izq = $casting;
    }

    public function set_casting_der($casting)
    {
        $this->casting_der = $casting;
    }

    public function set_pre_evaluacion($cadena)
    {
        $this->pre_evaluacion = $cadena;
    }

    public function set_post_evaluacion($cadena)
    {
     ...
     */
    public function get_sql($expresion, $valor)
    {
    ...
    public function set_condicion_fija($es_fija = true)
    {
        $this->_es_condicion_fija = $es_fija;
    }

    public function es_condicion_fija()
    {
