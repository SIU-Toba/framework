		...
		for($a = 0; $a<count($this->info_ci_me_pantalla);$a++)
		{
			...
			if ($this->info_ci_me_pantalla[$a]["imagen_recurso_origen"]) {
				if ($this->info_ci_me_pantalla[$a]["imagen_recurso_origen"] == 'apex') {
					$this->lista_tabs[$id]['imagen'] = recurso::imagen_apl($this->info_ci_me_pantalla[$a]["imagen"], false);
				} else {
					$this->lista_tabs[$id]['imagen'] = recurso::imagen_pro($this->info_ci_me_pantalla[$a]["imagen"], false);
				}
			}
		}
	}	
