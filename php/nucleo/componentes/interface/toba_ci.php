...
class toba_ci extends toba_ei
{
    ...
    public static $_navegacion_ajax = false;
    ...
    public static function set_navegacion_ajax($set = true)
    {
     ...
     * @ignore
     */
    public function inicializar($parametro = array())
    {
     ...
     */
    public function limpiar_memoria($no_borrar = null)
    {
     ...
     * @see toba_cn
     */
    public function asignar_controlador_negocio($controlador)
    {
     ...
     * @ignore
     */
    public function registrar_evento_interno($id, $evento)
    {
        $parametros	= func_get_args();
        array_splice($parametros, 0, 2);
        $metodo = apex_ei_evento . apex_ei_separador . $id . apex_ei_separador . $evento;
     ...
     */
    public function evt__falla_punto_control($punto_control, &$control)
    {
    ...
    {
        if (in_array($dep, $this->_dependencias_inicializadas)) {
            return;
        }
     ...
     * @return boolean
     */
    public function es_botonera_en_barra_item()
    {
    ...
    */
     ...
     */
    public function set_pantalla($id)
    {
        $no_visibles = toba::perfil_funcional()->get_rf_pantallas_no_visibles($this->_id[1]);
        $ok = false;
        foreach ($this->_info_ci_me_pantalla as $info_pantalla) {
     ...
     * @return unknow_type
     */
    public function servicio__ajax()
    {
     ...
     */
    public function xml_get_tag_inicio()
    {
     ...
     */
    public function xml_get_tag_fin()
    {
