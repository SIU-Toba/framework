...
class toba_ei_arbol extends toba_ei
{
    ...
    final public function __construct($datos)
    {
     ...
     */
    public function desactivar_chequeo_nodos()
    {
     ...
     */
    public function set_apertura_nodos($datos_apertura)
    {
     ...
     */
    public function set_apertura_nodo($nodo)
    {
     ...
     */
    public function set_ancho_nombres($caracteres)
    {
     ...
     * @param integer $nivel
     */
    public function set_nivel_apertura($nivel)
    {
     ...
     */
    public function set_todos_abiertos()
    {
     ...
     */
    public function set_mostrar_utilerias($mostrar)
    {
     ...
     * @param boolean $mostrar
     */
    public function set_mostrar_propiedades_nodos($mostrar)
    {
     ...
     * @param boolean $mostrar
     */
    public function set_mostrar_ayuda($mostrar)
    {
     ...
     * @param boolean $mostrar
     */
    public function set_mostrar_filtro_rapido($mostrar)
    {
     ...
     * @param string $frame
     */
    public function set_frame_destino($frame)
    {
     ...
     */
    public function set_datos($nodos, $mantener_en_sesion = false)
    {
     ...
     */
    public function get_ids_nodos_enviados()
    {
        $resultado = array();
     ...
     * @ignore
     */
    public function generar_html_filtro_rapido()
    {
     ...
     */
    public function generar_html_barra_especifica()
    {
    }
    ...
    protected function mostrar_utilerias($nodo)
    {
        ...
        if ($this->_mostrar_utilerias && is_array($utilerias) && (count($utilerias) > 0)) {
            $plegados = '';
            $despl = '';
