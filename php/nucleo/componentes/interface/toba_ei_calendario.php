...
class toba_ei_calendario extends toba_ei
{
     ...
     */
    public function set_datos($datos = null)
    {
        if (isset($datos)) {
     ...
     * @param boolean $ver
     */
    public function set_ver_contenidos($ver)
    {
     ...
     * @param integer $anio
     */
    public function set_dia_seleccionado($dia, $mes, $anio)
    {
     ...
     * @param integer $fin
     */
    public function set_rango_anios($inicio, $fin)
    {
     ...
     * @param boolean $valor
     */
    public function set_iniciar_en_domingo($valor)
    {
     ...
     * @param boolean $valor
     */
    public function set_sab_seleccionable($valor)
    {
     ...
     * @param boolean $valor
     */
    public function set_dom_seleccionable($valor)
    {
     ...
     * @param boolean $valor
     */
    public function set_seleccionar_solo_dias_pasados($valor)
    {
     ...
     * @param boolean $valor
     */
    public function set_mostrar_semanas($valor)
    {
     ...
     * @param boolean $valor
     */
    public function set_resaltar_siempre_dia_actual($valor)
    {
     ...
     * @return array
     */
    public function get_contenido($dia)
    {
...
class calendario //extends activecalendar
{
    ...
    ********************************************************************************
    */
    public function semana($semana, $anio)
    {
    ...
    public function __construct($week = false, $year = false, $month = false, $day = false, $GMTDiff = 'none')
    {
        $this->timetoday = time();
        $this->selectedday = -2;
     ...
     */
    public function set_mostrar_semanas($mostrar)
    {
     ...
     * @param boolean $mostrar
     */
    public function set_mostrar_mes_actual($mostrar)
    {
     ...
     */
    public function set_seleccionar_solo_dias_pasados($seleccionar)
    {
     ...
     */
    public function set_resaltar_siempre_dia_actual($resaltar)
    {
     ...
     * @return boolean
     */
    public function get_enableSatSelection()
    {
     ...
     * @param boolean $valor
     */
    public function set_enableSatSelection($valor)
    {
     ...
     * @return boolean
     */
    public function get_enableSunSelection()
    {
     ...
     * @param boolean $valor
     */
    public function set_enableSunSelection($valor)
    {
    ...
    ********************************************************************************
    */
    public function enableWeekLinks($link = false, $javaScript = false)
    {
        if ($link) {
            $this->url = $link;
        } else {
    ...
    ********************************************************************************
    */
    public function viewEventContents()
    {
    ...
    ********************************************************************************
    */
    public function setSelectedWeek($week)
    {
        $this->selectedweek = $week;
    }
    /*
    ...
    ********************************************************************************
    */
    public function setActMonth($month)
    {
        $this->actmonth = $month;
    }
    /*
    ...
    ********************************************************************************
    */
    public function setActYear($year)
    {
        $this->actyear = $year;
    }
     ...
     * @ignore
     */
    public function updateCalendar($mes, $anio)
    {
     ...
     * @ignore
     */
    public function setEventContent($day, $content)
    {
     ...
     * @ignore
     */
    public function getEventContent($day)
    {
     ...
     * @ignore
     */
    public function showMonth($objeto_js = null, $eventos = array(), $editor = null)
    {
     ...
     * @ignore
     */
    public function barra_editor($html)
    {
        $pickerSpan = 8;
        $out = '';
        if ($html) {
    ...
    */
     ...
     * @ignore
     */
    public function mkDatePicker($objeto_js, $eventos = array())
    {
        $pickerSpan = 8;
        $datos = array();
        if ($this->datePicker) {
     ...
     * @ignore
     */
    public function mkMonthBody($objeto_js = null, $eventos = array())
    {
        $out = '';
        $monthday = 0;
     ...
     * @ignore
     */
    public function viernes($semana, $anio)
    {
     ...
     * @ignore
     */
    public function compare_week($week, $year)
    {
     ...
     * @ignore
     */
    public function mkWeek($date, $objeto_js = null, $eventos = array())
    {
     ...
     * @ignore
     */
    public function compare_date($day)
    {
     ...
     * @ignore
     */
    public function mkDay($var, $objeto_js = null, $eventos = array())
    {
        if ($var <= 9) {
            $day = "0$var";
        } else {
    ...
    ********************************************************************************
    */
    public function mkWeekUrl($week, $year)
    {
        if (strpos($this->url, '?')) {
            $glue = "&amp;";
        } else {
    ...
    */
     ...
     * @ignore
     */
    public function get_startOnSun()
    {
     ...
     * @ignore
     */
    public function set_startOnSun($valor)
    {
