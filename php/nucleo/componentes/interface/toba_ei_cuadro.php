...
class toba_ei_cuadro extends toba_ei
{
    ...
    * @ignore
    */
    public function inicializar($parametros = array())
    {
     ...
     * @ignore
     */
    public function analizar_cortes_excel()
    {
     ...
     * @ignore
     */
    public function post_configurar()
    {
     ...
     * @ignore
     */
    public function aplicar_restricciones_funcionales()
    {
        ...
        if (! empty($no_visibles)) {
            ...
            for ($a = 0; $a < $limite; $a++) {
                if (in_array($this->_info_cuadro_columna[$a]['objeto_cuadro_col'], $no_visibles)) {
                    ...
                    $a--;
                    $limite--;									//por eso vuelvo puntero atras y descuento 1 del maximo
     ...
     * @return array
     */
    public function get_nombres_parametros()
    {
    ...
    */
    public function eliminar_columnas($columnas)
    {
    ...
    */
    public function existe_columna($columna)
    {
     ...
     */
    public function existen_columnas($columnas)
    {
        $existen = true;
     ...
     */
    public function limpiar_columnas()
    {
     ...
     */
    public function agregar_columnas($columnas)
    {
     ...
     */
    public function set_grupo_columnas($nombre_grupo, $columnas)
    {
     ...
     * @ignore
     */
    public function get_columnas_agrupadas()
    {
     ...
     * @ignore
     */
    public function es_cuadro_colapsado()
    {
     ...
     * @ignore
     */
    public function get_informacion_basica_cuadro()
    {
     ...
     * @return array
     */
    public function get_informacion_basica_componente()
    {
        return $this->_info;
    }
     ...
     */
    public function set_formateo_columna($id_columna, $funcion, $clase = null)
    {
     ...
     */
    public function set_manejador_salida($tipo_salida, $clase)
    {
    ...
    public function desactivar_modo_clave_segura()
    {
        $this->_modo_clave_segura = false;
    }

    public function usa_modo_seguro()
    {
     ...
     * @return mixed
     */
    public static function recuperar_clave_fila($cuadro, $clave)
    {
     ...
     * @return boolean
     */
    public function datos_cargados()
    {
     ...
     */
    public function set_eof_mensaje($mensaje)
    {
     ...
     */
    public function set_eof_mostrar($mostrar = true)
    {
        $valor = ($mostrar) ? 0 : 1;
     ...
     * @param boolean $unico
     */
    public function set_mostrar_titulo_antes_cc($unico = true)
    {
     ...
     */
    public function set_excel_usar_formulas($usar_formulas)
    {
    ...
    public function get_descripcion_resp_popup($fila)
    {
        $resultado = '';
     ...
     */
    public function set_layout_cant_filas($cant_filas)
    {
     ...
     * @ignore
     */
    public function get_layout_cant_columnas()
    {
    ...
    public function debe_mostrar_total_registros()
    {
    ...
    */
    public function seleccionar($clave)
    {
    ...
    */
    public function get_clave_fila($fila, $forzar_claves_reales = false)
    {
        $id_fila = "";
     ...
     */
    public function get_clave_fila_array($fila)
    {
        if (isset($this->_columnas_clave)) {
            foreach ($this->_columnas_clave as $clave) {
    ...
    */
    public function get_clave_seleccionada()
    {
     ...
     * @return boolean
     */
    public function es_clave_fila_seleccionada($clave_fila)
    {
        $resultado = false;
        if (! empty($this->_clave_seleccionada)) {
            if ($this->usa_modo_seguro()) {
     ...
     * @ignore
     */
    public function resetear_claves_enviadas()
    {
     ...
     * @ignore
     */
    public function agregar_clave_enviada($clave)
    {
     ...
     * @ignore
     */
    public function get_clave_enviada($clave)
    {
    ...
    * @return boolean
    */
    public function existen_cortes_control()
    {
        $cortes_activos = 0;
     ...
     */
    public function set_cortes_colapsados($colapsado = true)
    {
        $this->_cortes_anidado_colap = $colapsado;
    }

    public function agregar_corte_control($corte)
    {
    ...
    public function eliminar_corte_control($corte)
    {
    ...
    public function deshabilitar_corte_control($corte)
    {
        if (! isset($this->_cortes_indice[$corte])) {
    ...
    public function habilitar_corte_control($corte)
    {
        if (! isset($this->_cortes_indice[$corte])) {
    ...
    */
    ...
    {
        if (empty($this->_info_cuadro_cortes)) {
            return;
        }		// no hay nada que aplanar
     ...
     * @ignore
     */
    public function planificar_cortes_control()
    /*
    ...
    */
     ...
     * @ignore
     */
    public function get_acumulador_general()
    {
        if (isset($this->_acumulador)) {
    ...
    public function get_acumulador_usuario()
    {
     ...
     * @ignore
     */
    public function calcular_totales_sumarizacion_usuario()
    {
        $sumarizacion = array();
     ...
     * @ignore
     */
    public function debe_mostrar_titulos_columnas_cc()
    {
        return $this->_mostrar_titulo_antes_cc;
    }

    public function get_cortes_modo()
    {
        return $this->_cortes_modo;
    }

    public function get_indice_cortes()
    {
        return $this->_cortes_indice;
    }

    public function get_cortes_control()
    {
    ...
    * @return boolean
    */
    public function existe_paginado()
    {
    ...
    * @param integer $tam
    */
    public function set_tamanio_pagina($tamanio = null)
    {
        if (isset($tamanio)) {
     ...
     * @param integer $cant
     */
    public function set_total_registros($cant)
    {
     ...
     * @param integer $pag
     */
    public function set_pagina_actual($pag)
    {
     ...
     * @return integer
     */
    public function get_tamanio_pagina()
    {
     ...
     */
    public function get_tipo_paginado()
    {
     ...
     * @return integer
     */
    public function get_cantidad_paginas()
    {
     ...
     * @param boolean $usar
     */
    public function set_usar_ordenamiento_con_cortes($usar = true)
    {
     ...
     * @return boolean
     */
    public function hay_ordenamiento()
    {
        return (isset($this->_orden_sentido) && isset($this->_orden_columna));
    }

    public function hay_ordenamiento_multiple()
    {
    ...
    public function quita_acentos($cadena)
    {
     ...
     * @return boolean
     */
    public function es_sentido_ordenamiento_seleccionado($columna, $sentido)
    {
     ...
     */
    public function get_eventos_sobre_fila()
    {
    ...
    public function es_asociacion_de_vinculo($id_evento)
    {
        $es_asociacion = false;
    ...
    */
    public function get_ids_evento_aplicacion_multiple()
    {
        $ids = array();
    ...
    public function disparar_eventos_multiples()
    {
    ...
    public function disparar_eventos_simples($evento)
    {
        $parametros = null;
        if (! empty($this->_clave_seleccionada)) {
    ...
    public function get_nombres_eventos_multiples()
    {
        $evt_multiples = array();
        foreach ($this->_eventos_multiples as $nombre_evt) {
    ...
    public function hay_eventos_multiples()
    {
        return (! empty($this->_eventos_multiples));
    }

    public function get_eventos_multiples()
    {
     ...
     * @ignore
     */
    public function vista_impresion_html(toba_impresion $salida)
    {
     ...
     */
    public function vista_xml($inicial = false, $xmlns = null)
    {
        if ($xmlns) {
    ...
    */
    ...
    public function instanciar_manejador_tipo_salida($tipo)
    {
    ...
    */
    ...
    public function get_cantidad_columnas_total()
    {
        return $this->_cantidad_columnas_total;
    }

    public function get_cantidad_columnas()
    {
    ...
    */
    ...
    public function debe_colapsar_cortes()
    {
    ...
    */
     ...
     * @param boolean $valor
     */
    public static function set_vista_excel_sin_cortes($valor)
    {
        self::$_mostrar_excel_sin_cortes = $valor;
    }

    public static function permite_exportacion_excel_plano()
    {
     ...
     */
    public function get_filas_disponibles_selector()
    {
     ...
     *@ignore
     */
    public function tabla_datos_es_general()
    {
        if (! $this->existen_cortes_control()) {
            return true;
        } else {
     ...
     * @ignore
     */
    public function get_instancia_clase_formateo($tipo)
    {
        return  new $this->_clase_formateo($tipo);
    }

    public function set_etiqueta_cantidad_filas($etiqueta)
    {
        $this->_etiqueta_cantidad_filas = $etiqueta;
    }

    public function get_etiqueta_cantidad_filas()
    {
