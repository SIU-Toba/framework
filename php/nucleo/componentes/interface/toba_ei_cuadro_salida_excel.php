...
class toba_ei_cuadro_salida_excel extends toba_ei_cuadro_salida
{
     ...
     */
    public function excel_cuadro(&$filas, &$totales, &$nodo)
    {
    ...
    public function generar_layout_fila($columnas, $datos_cuadro, $id_fila, $formateo, &$estilos)
    {
        $fila = array();
     ...
     * @ignore
     */
    public function excel_mensaje_cuadro_vacio($texto)
    {
     ...
     * @ignore
     */
    public function excel_cabecera_corte_control(&$nodo)
    {
     ...
     */
    public function excel_pie_corte_control(&$nodo, $es_ultimo)
    {
        ...
        if (isset($nodo['acumulador'])) {
            ...
            $this->excel_cuadro_totales_columnas(
                $nodo,
                $nodo['profundidad'],
                $titulos,
                false
    ...
    public function excel_cabecera_pie($indice_cortes, $nodo, $span)
    {
    ...
    public function excel_pie_pie($nodo, $es_ultimo)
    {
     ...
     * @ignore
     */
    public function excel_cc_inicio_nivel()
    {
    }
     ...
     * @ignore
     */
    public function excel_cc_fin_nivel()
    {
    }

    public function excel_inicio_zona_colapsable()
    {
    }

    public function excel_fin_zona_colapsable()
    {
    }
