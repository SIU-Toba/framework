...
class toba_ei_cuadro_salida_impresion_html extends toba_ei_cuadro_salida_html
{
    ...
    * @ignore
    */
    public function impresion_html_inicio()
    {
     ...
     * @ignore
     */
    public function impresion_html_fin()
    {
     ...
     * @ignore
     */
    public function impresion_html_cuadro(&$filas, &$totales)
    {
     ...
     * @ignore
     */
    public function impresion_html_mensaje_cuadro_vacio($texto)
    {
    ...
    * @ignore
    */
    public function impresion_html_cabecera_corte_control(&$nodo)
    {
     ...
     * @ignore
     */
    public function impresion_html_pie_corte_control(&$nodo, $es_ultimo)
    {
        $this->html_pie_corte_control($nodo, $es_ultimo);
    }

    public function impresion_html_cc_inicio_nivel()
    {
    }

    public function impresion_html_cc_fin_nivel()
    {
    }

    public function impresion_html_inicio_zona_colapsable($id_unico, $estilo)
    {
        echo "<table class='tabla-0' id='$id_unico' width='100%' border='1' ><tr><td>\n";
    }

    public function impresion_html_fin_zona_colapsable()
    {
        echo "</td></tr></table>\n";
    }
