...
class toba_ei_cuadro_salida_pdf extends toba_ei_cuadro_salida
{
     ...
     */
    public function pdf_cuadro(&$filas, &$totales, &$nodo)
    {
     ...
     * @ignore
     */
    public function get_opciones_columnas()
    {
     ...
     * @ignore
     */
    public function pdf_mensaje_cuadro_vacio($texto)
    {
     ...
     * @ignore
     */
    public function pdf_cabecera_corte_control(&$nodo)
    {
     ...
     * @return string
     */
    public function pdf_cabecera_pie_cc_contenido(&$nodo)
    {
        //Obtengo los cortes desde el cuadro
        $indice_cortes = $this->_cuadro->get_indice_cortes();
    ...
    */
    ...
    public function pdf_pie_corte_control(&$nodo, $es_ultimo)
    {
        //-----  Cabecera del PIE --------
        $indice_cortes = $this->_cuadro->get_indice_cortes();
        ...
        if (isset($nodo['acumulador']) && ! isset($nodo['pdf_acumulador_generado'])) {
            $this->pdf_cuadro_totales_columnas(
                $nodo['acumulador'],
                $nodo['profundidad'],
                true,
                null
    ...
    public function pdf_cabecera_pie($indice_cortes, $nodo)
    {
    ...
    public function pdf_pie_pie($nodo, $es_ultimo)
    {
     ...
     * @ignore
     */
    public function pdf_acumulador_usuario()
    {
    ...
    public function pdf_cc_inicio_nivel()
    {
    }

    public function pdf_cc_fin_nivel()
    {
    }

    public function pdf_inicio_zona_colapsable()
    {
    }

    public function pdf_fin_zona_colapsable()
    {
    }
