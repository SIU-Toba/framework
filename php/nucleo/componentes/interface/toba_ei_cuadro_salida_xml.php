...
class toba_ei_cuadro_salida_xml extends toba_ei_cuadro_salida
{
    ...
    public function __construct(toba_ei_cuadro $cuadro)
    {
    ...
    public function get_resultado_generacion()
    {
    ...
    */
    public function xml_cuadro(&$filas, &$totales, &$nodo)
    {
    ...
    public function generar_layout_fila($columnas, $datos_cuadro, $id_fila, $formateo)
    {
     ...
     * @ignore
     */
    public function xml_mensaje_cuadro_vacio($texto)
    {
     ...
     * @ignore
     */
    public function xml_cabecera_corte_control(&$nodo)
    {
    ...
    */
     ...
     * @ignore
     */
    public function xml_pie_corte_control(&$nodo, $es_ultimo)
    {
        //-----  Cabecera del PIE --------
        $indice_cortes = $this->_cuadro->get_indice_cortes();
        ...
        if (isset($nodo['acumulador']) && ! isset($nodo['xml_acumulador_generado'])) {
            $this->xml_cuadro_totales_columnas(
                $nodo['acumulador'],
                $nodo['profundidad'],
                true,
                null
    ...
    public function xml_cabecera_pie($indice_cortes, $nodo)
    {
    ...
    public function xml_pie_pie($nodo)
    {
     ...
     * @ignore
     */
    public function xml_cc_inicio_nivel()
    {
    }
     ...
     * @ignore
     */
    public function xml_cc_fin_nivel()
    {
    }
     ...
     * @ignore
     */
    public function xml_inicio_zona_colapsable()
    {
    }
     ...
     * @ignore
     */
    public function xml_fin_zona_colapsable()
    {
    }

    public function xml_acumulador_usuario()
    {
     ...
     */
    public function xml_set_columna_ancho($efs, $ancho = null)
    {
        if (is_array($efs)) {
