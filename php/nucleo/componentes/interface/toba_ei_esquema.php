...
class toba_ei_esquema extends toba_ei
{
     ...
     */
    public function set_incluir_mapa($incluir = null)
    {
    ...
    public function generar_html()
    {
        ...
        if (isset($this->_contenido)) {
            ...
            $this->generar_esquema(
                $this->_contenido,
                $this->_info_esquema['formato'],
                $this->_info_esquema['dirigido'],
                $this->_ancho,
                $this->_alto,
                $this->_incluir_mapa,
                $this->objeto_js
     ...
     * @param string $alto
     */
    public static function generar_sentencia_incrustacion($url, $formato, $ancho = null, $alto = null, $incluir_mapa = null, $objeto_js = null)
    {
     ...
     */
    public static function generar_archivo($contenido, $formato, $es_dirigido = true)
    {
     ...
     */
    public function servicio__mostrar_esquema($parametros = null)
    {
     ...
     */
    public function xml_set_caption($caption)
    {
