...
class toba_ei_filtro extends toba_ei
{
    ...
    final public function __construct($definicion)
    {
     ...
     * @return array
     */
    public function get_ids_columnas()
    {
     ...
     */
    public function eliminar_columnas($ids_columnas = array())
    {
     ...
     */
    public function get_sql_where($separador = 'AND', $clausulas = null)
    {
        if (! isset($clausulas)) {
     ...
     * @return array
     */
    public function get_sql_clausulas()
    {
        $where = array();
        if (isset($this->_columnas_datos)) {
     ...
     */
    public function columna($nombre)
    {
    ...
    public function servicio__cascadas_columnas()
    {
