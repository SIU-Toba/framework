...
class toba_ei_firma extends toba_ei
{
    ...
    public function generar_applet()
    {
     ...
     * @return string
     */
    public function get_url_enviar_pdf($usa_url_encode)
    {
        $destino = array($this->_id);
        $url_base = $this->get_url_base_actual();
    ...
    public function get_url_base_actual()
    {
    ...
    public function set_motivo_firma($motivo)
    {
        $this->_motivo_firma;
    }
    ...
    public function set_dimension($ancho, $alto)
    {
        $this->_ancho = $ancho;
        $this->_alto = $alto;
    }

    public function set_mostrar_pdf($mostrar)
    {
        $this->_mostrar_pdf = $mostrar;
    }

    public function set_alto_pdf($alto)
    {
