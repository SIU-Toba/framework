...
class toba_ei_formulario extends toba_ei
{
     ...
     */
    public function agregar_ef($id_ef, $clase, $etiqueta, $columnas_clave, $parametros_extra)
    {
    ...
    */
    public function set_ancho_etiqueta($ancho)
    {
     ...
     * @return boolean
     */
    public function ef_tiene_maestros_seteados($id_ef)
    {
     ...
     */
    public function set_expandir_descripcion($mostrar)
    {
     ...
     */
    public function set_detectar_cambios($detectar = true)
    {
     ...
     * @return array
     */
    public function get_nombres_ef()
    {
     ...
     * @return integer
     */
    public function get_cantidad_efs()
    {
     ...
     */
    public function set_solo_lectura($efs = null, $readonly = true)
    {
        if (!isset($efs)) {
     ...
     */
    public function set_efs_obligatorios($efs = null, $obligatorios = true)
    {
        if (!isset($efs)) {
            $efs = $this->_lista_ef_post;
        }
     ...
     */
    public function desactivar_validacion_ef($ef)
    {
        if (isset($this->_elemento_formulario[$ef])) {
     ...
     * @param array $efs Uno o mas efs, si es nulo se asume todos
     */
    public function desactivar_efs($efs = null)
    {
        if (!isset($efs)) {
            $efs = $this->_lista_ef_post;
        }
     ...
     */
    public function set_datos_defecto($datos)
    {
     ...
     */
    public function servicio__mostrar_captchas_efs()
    {
     ...
     */
    public function servicio__cascadas_efs()
    {
     ...
     */
    public function servicio__filtrado_ef_ce()
    {
     ...
     */
    public function servicio__filtrado_ef_ce_validar()
    {
        if (! isset($_GET['filtrado-ce-ef']) || ! isset($_GET['filtrado-ce-valor'])) {
     ...
     */
    public function set_pdf_tabla_ancho($ancho)
    {
     ...
     */
    public function set_pdf_letra_tabla($tamanio)
    {
     ...
     */
    public function set_pdf_tabla_opciones($opciones)
    {
     ...
     * @return array
     */
    public function get_valores_pdf($id_ef)
    {
        $formateo = new $this->_clase_formateo('pdf');
     ...
     */
    public function set_formateo_ef($id_ef, $funcion, $clase = null)
    {
     ...
     */
    public function xml_set_ef_no_procesar($ef)
    {
        if (is_array($ef)) {
