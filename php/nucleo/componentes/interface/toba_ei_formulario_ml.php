...
class toba_ei_formulario_ml extends toba_ei_formulario
{
     ...
     */
    public function set_metodo_analisis($metodo)
    {
        switch ($metodo) {
            case 'LINEA':
     ...
     */
    public function set_exportar_excel($exportar = true)
    {
     ...
     * @todo Cambiar cuando esta informacion pase a formar parte de los metadatos
     */
    public function set_exportar_pdf($exportar = true)
    {
     ...
     */
    public function set_ordenar_en_linea($en_linea)
    {
     ...
     * @param boolean $en_linea
     */
    public function set_borrar_en_linea($en_linea)
    {
     ...
     */
    public function set_modo_agregar($es_inferior, $texto_a_mostrar = null)
    {
     ...
     */
    public function set_ocultar_agregar()
    {
     ...
     */
    public function set_mostrar_agregar()
    {
     ...
     */
    public function set_mostrar_utilerias_orden($mostrar = true)
    {
     ...
     */
    public function set_mostrar_cabecera_sin_datos($mostrar)
    {
    ...
    */
     ...
     */
    public function desactivar_agregado_filas()
    {
     ...
     */
    public function limpiar_interface()
    {
        foreach ($this->_lista_ef as $ef) {
            $this->_elemento_formulario[$ef]->resetear_estado();
        }
     ...
     * @return integer
     */
    public function get_cantidad_lineas()
    {
     ...
     */
    public function get_datos($analizar_diferencias = false)
    {
    ...
    public function analizar_diferencias($datos)
    {
    ...
    public static function set_callback_validacion(toba_valida_datos $validador)
    {
    ...
    */
     ...
     */
    public function set_datos($datos, $set_cargado = true)
    {
        if (!is_array($datos)) {
    ...
    */
    public function agregar_registro($valores = array())
    {
     ...
     */
    public function set_registro_nuevo($template = array())
    {
     ...
     * @param integer $id
     */
    public function set_proximo_id($id)
    {
    ...
    protected function generar_botonera_manejo_filas()
    {
        ...
        if ($agregar || ($ordenar && !$this->_ordenar_en_linea)) {
            ...
            echo toba::output()->get('FormularioMl')->getBotoneraManejoFila(
                $this->objeto_js,
                $this->_rango_tabs[0]++,
                $agregar,
                $this->_mostrar_agregar,
                $this->_modo_agregar,
                "{$this->objeto_js}.crear_fila();",
                $this->_borrar_en_linea,
                "{$this->objeto_js}.eliminar_seleccionada();",
                $this->_info_formulario['filas_agregar'],
                "{$this->objeto_js}.deshacer();",
                $ordenar,
                $this->_ordenar_en_linea,
                "{$this->objeto_js}.subir_seleccionada();",
                "{$this->objeto_js}.bajar_seleccionada();"
            );
        }
    }
    ...
    protected function generar_formulario_cuerpo()
    {
        ...
        foreach ($this->_ordenes as $fila) {
            ...
            if ($this->_info_formulario['filas_agregar'] && $this->_borrar_en_linea) {
                $content =  toba_form::button_html(
                    "{$this->objeto_js}_eliminar$fila",
                    toba_recurso::imagen_toba('borrar.gif', true),
     ...
     * @return string
     */
    public function get_objeto_js_ef($id)
    {
    ...
    public function vista_pdf($salida)
    {
        $this->totalizar_columnas_impresion();
    ...
    public function totalizar_columnas_impresion()
    {
