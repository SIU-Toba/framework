...
class toba_ei_mapa extends toba_ei
{
     ...
     * @return string
     */
    public function get_evento_interaccion()
    {
        $evento = null;
     ...
     * @return boolean
     */
    public function hay_evento_interaccion()
    {
     ...
     * @param integer $alto
     */
    public function set_viewport($ancho, $alto)
    {
     ...
     */
    public function set_layers_activos($layers = array())
    {
     ...
     * @param float $ymax
     */
    public function set_extent_activo($xmin, $ymin, $xmax, $ymax)
    {
     ...
     * @return array
     */
    public function get_layers_activos()
    {
     ...
     * @return array
     */
    public function get_nombre_layers()
    {
     ...
     * @ignore
     */
    public function servicio__ejecutar($parametros = null)
    {
     ...
     * @ignore
     */
    public function mapa_setear_estado_layers()
    {
     ...
     * @ignore
     */
    public function mapa_setear_extent_activo()
    {
     ...
     */
    public function generar_salida($salida)
    {
        $img = $this->_mapa->draw();
        if (is_null($img)) {
