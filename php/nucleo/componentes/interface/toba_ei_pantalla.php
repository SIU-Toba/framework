...
{
    public const NAVEGACION_TAB_HORIZONTAL		= 'tab_h';
    public const NAVEGACION_TAB_VERTICAL		= 'tab_v';
    public const NAVEGACION_WIZARD				= 'wizard';
    public const NAVEGACION_BASICA				= 'basica';
    ...
    final public function __construct($info_pantalla, $submit, $objeto_js)
    {
     ...
     * @param string $nueva
     */
    public function set_etiqueta($nueva)
    {
     ...
     */
    public function set_descripcion($descr, $tipo = 'info')
    {
     ...
     */
    public function set_tipo_navegacion($tipo)
    {
        $this->_info_ci['tipo_navegacion'] = $tipo;
    }

    public function set_navegacion_ajax($set = true)
    {
     ...
     */
    public function agregar_dep($id_obj)
    {
     ...
     */
    public function eliminar_dep($id)
    {
     ...
     * @return array
     */
    public function get_lista_dependencias()
    {
     ...
     * @return boolean
     */
    public function existe_dependencia($nombre_dep)
    {
     ...
     */
    public function eliminar_tab($id)
    {
     ...
     */
    public function get_lista_tabs()
    {
        //-- Restricción funcional pantalla no-visible ------
    ...
    protected function cargar_lista_eventos()
    {
        ...
        switch ($this->_info_ci['tipo_navegacion']) {
            ...
            case self::NAVEGACION_WIZARD:
                list($anterior, $siguiente) = array_elem_limitrofes(
                    array_keys($this->get_lista_tabs()),
     ...
     */
    public function registrar_evento_cambio_tab($id)
    {
     ...
     * @return array
     */
    public function posicionar_botonera_abajo()
    {
     ...
     * @return array
     */
    public function posicionar_botonera_arriba()
    {
     ...
     * @return array
     */
    public function posicionar_botonera_ambos()
    {
    ...
    public function generar_layout_template_impresion(toba_impresion $obj_salida)
    {
        $restantes = array_keys($this->_dependencias);
        //Parseo del template
        $pattern = '/\[dep([\s\w+=\w+]+)\]/i';
