...
class toba_cn extends toba_componente
{
     ...
     */
    public function evt__limpieza_memoria($no_borrar = null)
    {
     ...
     */
    public function procesar($parametros = null, $transaccionar = true, $limpiar_memoria = true)
    {
        $resultado = null;
     ...
     * @ventana
     */
    public function evt__validar_datos()
    {
    }
     ...
     * @todo Ver la posibilidad de usar ignore_user_abort() para evitar problemas con medios no transaccionales
     */
    public function procesar_anidado($parametros = null, $no_borrar = null)
    {
        $resultado = null;
     ...
     */
    public function ejecutar_sql($sentencias_sql)
    {
