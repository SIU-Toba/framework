 ...
 * 
 * Separar la carga y utilizaci�n de los datos (inicio y fin de una transaccion de negocios)
 * permite:
...
class toba_cn extends toba_componente
{
	 ...
	 *  Una vez terminada la transacci�n se invoca a la limpieza de memoria
	 * 
