...
abstract class toba_servicio_web extends toba_componente
{
    ...
    public function validar_certificado_cliente()
    {
     ...
     */
    public function get_certificado_cliente()
    {
    ...
    public function get_id_cliente($parametro = null)
    {
    ...
    public static function agregar_mapeo_firmas($archivo, $id, $fingerprint = null)
    {
    ...
    public static function decodificar_certificado($archivo)
    {
     ...
     */
    public function op__eco(toba_servicio_web_mensaje $mensaje)
    {
