...
{
    public const tipo_tabla_unica = 'st';
    public const tipo_multitabla  = 'mt';
     ...
     */
    public function __construct($datos_tabla)
    {
     ...
     */
    public function activar_perfil_de_datos()
    {
     ...
     */
    public function activar_proceso_carga_externa_sql($sql, $col_parametros, $col_resultado, $sincro_continua = true, $estricto = true)
    {
     ...
     * permite que no posea valor.
     */
    public function activar_proceso_carga_externa_dao($metodo, $clase = null, $include = null, $col_parametros = [], $col_resultado = [], $sincro_continua = true, $estricto = true, $carga_masiva = 0, $metodo_masivo = '')
    {
        $proximo = count($this->_proceso_carga_externa);
     ...
     * permite que no posea valor.
     */
    public function activar_proceso_carga_externa_datos_tabla($tabla, $metodo, $col_parametros, $col_resultado, $sincro_continua = true, $estricto = true, $carga_masiva = 0, $metodo_masivo = '')
    {
        $proximo = count($this->_proceso_carga_externa);
    ...
    public function activar_proceso_carga_externa_consulta_php($metodo, $id_consulta_php, $col_parametros, $col_resultado, $sincro_continua = true, $estricto = true, $carga_masiva = 0, $metodo_masivo = '')
    {
        $proximo = count($this->_proceso_carga_externa);
     ...
     * @param boolean $usar
     */
    public function set_usar_trim($usar)
    {
        $this->_hacer_trim_datos = $usar;
    }

    public function get_usar_trim()
    {
     ...
     */
    public function set_lock_optimista($usar = true)
    {
        $this->_lock_optimista = $usar;
    }

    public function get_lock_optimista()
    {
     ...
     */
    public function pertenece_a_tabla(&$col, $tabla)
    {
     ...
     */
    public function cargar_por_clave($clave, $anexar_datos = false, $usar_cursores = false)
    {
     ...
     * @return boolean Falso si no se encontro ningun registro
     */
    public function cargar_con_where($clausula, $anexar_datos = false, $usar_cursores = false)
    {
     ...
     */
    public function cargar_con_where_from_especifico($where = null, $from = null, $anexar_datos = false, $usar_cursores = false)
    {
     ...
     * @return boolean Falso si no se encontro ningún registro
     */
    public function cargar_con_sql($sql, $anexar_datos = false, $usar_cursores = false)
    {
     ...
     * @return boolean Falso si no se encontro ningún registro
     */
    public function cargar_con_datos($datos, $anexar_datos = false, $usar_cursores = false)
    {
        if (count($datos) > 0) {
     ...
     */
    public function sincronizar($filas = array())
    {
     ...
     */
    public function sincronizar_eliminados($filas = array())
    {
     ...
     * @return integer Cantidad de modificaciones a la base
     */
    public function sincronizar_insertados($filas = array())
    {
        $this->get_estado_datos_tabla();
        $modificaciones = 0;
        if ($filas) {
     ...
     * @return integer Cantidad de modificaciones a la base
     */
    public function sincronizar_actualizados($filas = array())
    {
        $this->get_estado_datos_tabla();
        $modificaciones = 0;
        if ($filas) {
     ...
     * @ventana
     */
    public function evt__pre_sincronizacion()
    {
    }
     ...
     * @ventana
     */
    public function evt__post_sincronizacion()
    {
    }
     ...
     * @ventana
     */
    public function evt__perdida_sincronizacion($id_fila, $sql_origen)
    {
     ...
     * @ignore
     */
    public function get_sql_de_carga($campos)
    {
     ...
     * @ignore
     */
    public function generar_sql_where_registro($id_registro)
    {
        $id = array();
        if (! $this->_lock_optimista) {
            ...
            foreach ($this->_columnas as $col) {
                if (!$this->pertenece_a_tabla($col, $this->_tabla)) {
                    continue;
                }
                if (!$col['externa'] && $col['tipo'] != 'B') {
     ...
     * @ignore
     */
    public function consultar_columna_blob($id_registro, $columna)
    {
        $this->get_estado_datos_tabla();
    ...
    public function completar_campos_externos_fila($fila, $evento = null)
    {
        ...
        if (is_array($this->_proceso_carga_externa) && ! empty($this->_proceso_carga_externa)) {
            foreach (array_keys($this->_proceso_carga_externa) as $carga) {
                ...
                if (isset($evento) && !($parametros["sincro_continua"])) {
                    continue;
                }
    ...
    public function carga_inicial_campos_externos($datos)
    {
