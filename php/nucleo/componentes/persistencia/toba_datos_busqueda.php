...
class toba_datos_busqueda
{
     ...
     * @param type $tabla
     */
    public function __construct($relacion, $tabla)
    {
     ...
     */
    public function set_padre($tabla_padre, $id_padre)
    {
     ...
     */
    public function set_condicion($campo, $operador, $valor)
    {
     ...
     */
    public function limpiar_condiciones()
    {
     ...
     * @return array
     */
    public function get_columnas_orden()
    {
     ...
     */
    public function set_columnas_orden($cols = array())
    {
        ...
        foreach ($cols as $columna => $sentido) {
            if (! in_array($columna, $cols_existentes)) {
                ...
                throw new toba_error_def('Parámetro de ordenamiento incorrecto, revise el log');
            }
        }
     ...
     * @ignore
     */
    public function ordenar_datos_x_columnas($datos_orig)
    {
