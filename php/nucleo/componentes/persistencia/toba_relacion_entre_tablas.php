...
class toba_relacion_entre_tablas
{
    ...
    public function set_mapeo_filas($mapeo)
    {
        $this->mapeo_filas = $mapeo;
    }

    public function set_mapeo_filas_eliminadas($mapeo)
    {
        $this->mapeo_filas_eliminadas = $mapeo;
    }

    public function set_relacion_inclusion($inclusion)
    {
        $this->es_relacion_de_inclusion = $inclusion;
    }

    public function get_mapeo_filas()
    {
        return $this->mapeo_filas;
    }

    public function get_mapeo_filas_eliminadas()
    {
        return $this->mapeo_filas_eliminadas;
    }

    public function get_mapeo_campos()
    {
    ...
    public function tabla_padre()
    {
        return $this->tabla_padre;
    }

    public function tabla_hijo()
    {
     ...
     * @ignore
     */
    public function generar_clausula_subselect($alias_hija)
    {
     ...
     */
    public function evt__carga_hijo($reg_hijos = null)
    {
     ...
     */
    public function evt__sincronizacion_padre($filas = array())
    {
            ...
            if (isset($this->mapeo_filas[$id_fila_padre])) {
                foreach ($this->mapeo_filas[$id_fila_padre] as $id_fila_hijo) {
                    ...
                    foreach ($this->mapeo_campos as $columna_padre => $columna_hijo) {
                        $this->tabla_hijo->set_fila_columna_valor(
                            $id_fila_hijo,
                            $columna_hijo,
     ...
     */
    public function evt__eliminacion_fila_padre($id)
    {
        //¿Hay filas hijos?
     ...
     */
    public function evt__eliminacion_fila_hijo($id)
    {
     ...
     */
    public function get_id_filas_hijas_de($id_padre, $incluir_hijos_eliminados = false)
    {
     ...
     */
    public function filtrar_filas_hijas($filas, $incluir_hijos_eliminados = false)
    {
     ...
     */
    public function hay_cursor_en_padre()
    {
     ...
     */
    public function get_id_filas_hijas($incluir_hijos_eliminados = false)
    {
        if ($this->hay_cursor_en_padre()) {
     ...
     */
    public function get_id_padre($id_fila_hijo)
    {
     ...
     */
    public function buscar_padre_de($id_fila_hijo)
    {
        foreach (array_keys($this->mapeo_filas) as $padre) {
            $pos = array_search($id_fila_hijo, $this->mapeo_filas[$padre]);
            if ($pos !== false) {
     ...
     */
    public function set_padre($id_fila, $id_padre)
    {
     ...
     */
    public function asociar_fila_con_padre($id_hijo, $id_padre = null)
    {
