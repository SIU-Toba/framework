...
{
    protected static $_modo_memoria_compatible = false;		//Dos componentes con el mismo id creados en un request reusan la misma celda de memoria?
     ...
     */
    public static function set_modo_compatible_manejo_sesion($compatible)
    {
     ...
     * @ignore
     */
    public function get_clave_memoria_global()
    {
     ...
     * @see toba_mensajes
     */
    public function get_mensaje($indice, $parametros = null)
    {
     ...
     */
    public function informar_msg($mensaje, $nivel = null)
    {
     ...
     * @see toba_notificacion
     */
    public function informar($indice, $parametros = null, $nivel = null)
    {
     ...
     * @ignore
     */
    public function cargar_memoria()
    {
     ...
     * @ignore
     */
    public function controlar_memoria()
    {
     ...
     */
    public function borrar_memoria()
    {
        unset($this->_memoria);
     ...
     */
    public function mantener_estado_sesion()
    {
        return array();
    }
     ...
     * @ignore
     */
    public function guardar_estado_sesion()
    {
     ...
     */
    public function eliminar_estado_sesion($no_eliminar = null)
    {
        if (!isset($no_eliminar)) {
            $no_eliminar = array();
        }
        for ($a = 0;$a < count($this->_propiedades_sesion);$a++) {
     ...
     */
    public function get_estado_sesion()
    {
        if (count($this->_propiedades_sesion) > 0) {
     ...
     */
    public function set_controlador($controlador, $id_en_padre = null)
    {
     ...
     */
    public function dependencia($id, $carga_en_demanda = true)
    {
     ...
     * @return toba_componente
     */
    public function dep($id, $carga_en_demanda = true)
    {
     ...
     */
    public function agregar_dependencia($identificador, $proyecto, $objeto)
    {
     ...
     */
    public function agregar_dependencia_por_indice($identificador_rol, $identificador_componente)
    {
     ...
     * @ignore
     */
    public function cargar_dependencia($identificador)
    {
     ...
     * @ignore
     */
    public function descargar_dependencia($identificador)
    {
        $posicion = $this->_indice_dependencias[$identificador];
     ...
     * @return boolean
     */
    public function dependencia_cargada($id)
    {
     ...
     * @return boolean
     */
    public function existe_dependencia($id)
    {
     ...
     * @return integer
     */
    public function get_cantidad_dependencias()
    {
     ...
     * @return array
     */
    public function get_dependencias_clase($ereg_busqueda)
    {
        $ok = array();
        for ($a = 0;$a < count($this->_info_dependencias);$a++) {
