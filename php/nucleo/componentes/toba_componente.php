...
abstract class toba_componente
{
	...
	/**
	 * Alternativa para que la reutilizaci�n de un mismo componente en un mismo request se siga comportando como antes de [3050], es decir el ultimo creado pisa la memoria del 1ero.
	 */
	 ...
	 * Como la ventana es previa a la atenci�n de eventos y servicios es un punto ideal para la configuraci�n global del componente
	 * @ventana
	 */
	function ini() {}
	...
	/**
	 * Shortcut de @see toba_logger::debug() que incluye informaci�n b�sica del componente actual
	 */
	...
	/**
	 * Retorna el nombre del componente seg�n se defini� en el editor
	 * @return string
	 */
	function get_nombre()
	{
	...
	/**
	 * Retorna el t�tulo del componente (nombre visible al usuario)
	 * @return string
	 */
	function get_titulo()
	{
	...
	/**
	 * Retorna un par�metro est�tico definido en las prop. b�sicas del componente
	 ...
	 * @param mixed $parametros Par�metros posicionales a ser reemplazados en el mensaje (puede ser uno solo o un array)
...
//Res: proque no se pueden cargar objetos de dos proyectos en la misma solicitud
	...
	/**
	 * Agregar din�micamente una dependencia al componente actual
	 *
	...
	/**
	 * Agregar din�micamente una dependencia al componente actual utilizando
	 *
	...
	/**
	 * Retorna verdadero si la dependencia fue construida y asociada en este pedido de p�gina
	 * @return boolean
	 */
