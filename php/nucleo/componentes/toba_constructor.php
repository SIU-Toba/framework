...
{
    public static $objetos_runtime_instanciados = array(); // Referencias a los objetos creados
    public static $cache_infos = array();
    public static $refresco_forzado = false;
     ...
     * @return objeto
     */
    public static function get_runtime($id, $tipo = null, $usar_cache = false)
    {
    ...
    public static function get_runtime_clase_y_datos($id, $tipo = null, $usar_cache = false)
    {
    ...
    public static function get_runtime_objeto($id, $tipo, $clase, $datos)
    {
     ...
     */
    public static function get_info($id, $tipo = null, $en_profundidad = true, $datos = null, $refrescar_cache = false, $resumidos = false)
    {
     ...
     * @return objeto
     */
    public static function buscar_runtime($id, $numero_instancia = 0)
    {
    ...
    */
    public static function get_metadatos_compilados($id, $item = false)
    {
     ...
     * @ignore
     */
    public static function control_clave_valida($clave_componente)
    {
     ...
     */
    public static function set_refresco_forzado($refrescar)
    {
