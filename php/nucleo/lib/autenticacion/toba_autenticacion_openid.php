...
class toba_autenticacion_openid extends toba_autenticacion implements toba_autenticable
{
    ...
    public function __construct($campos = null, $providers = null, $permite_login_toba = false)
    {
        $this->campos = $campos;
    ...
    public function set_provider($datos)
    {
    ...
    public function permite_login_toba()
    {
    ...
    public function get_valor($campo)
    {
    ...
    public function verificar_acceso($datos_iniciales = null)
    {
    ...
    public function iniciar_sesion($usuario, $clave, $datos_iniciales = null)
    {
