...
abstract class toba_ei_grafico_conf_especifico extends toba_ei_grafico_conf
{
    ...
    public function canvas__set_titulo($titulo)
    {
     ...
     */
    public function serie__set_activa($id_serie)
    {
     ...
     */
    public function serie__agregar($id, $datos)
    {
     ...
     */
    public function serie__get_activa()
    {
     ...
     * @param string $id_serie
     */
    public function serie($id_serie)
    {
        if (!isset($this->series[$id_serie])) {
