...
class toba_ei_grafico_conf_torta extends toba_ei_grafico_conf_especifico
{
     ...
     */
    public function serie__set_titulo($titulo)
    {
     ...
     * @return toba_ei_grafico_conf_torta
     */
    public function serie__set_leyendas($leyendas)
    {
     ...
     */
    public function serie__set_tema($tema)
    {
     ...
     * @return toba_ei_grafico_conf_torta
     */
    public function serie__set_centro($x, $y = 0.5)
    {
     ...
     * @return toba_ei_grafico_conf_torta
     */
    public function serie__separar_porciones($indices)
    {
