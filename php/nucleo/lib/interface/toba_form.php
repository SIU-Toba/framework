...
class toba_form
{
    public static function text($nombre, $actual, $read_only, $len, $size, $clase = "ef-input", $extra = "")
    // EditBox
    {
    ...
    public static function select($nombre, $actual, $datos, $clase = "ef-combo", $extra = "", $categorias = null)
    ...
    public static function multi_select($nombre, $actuales, $datos, $tamanio, $clase = "ef-combo", $extra = "")
    {
    ...
    public static function textarea($nombre, $valor, $filas, $columnas, $clase = "ef-textarea", $wrap = "", $extra = "")
    //TEXTAREA
    //wrap=virtual
    {
        if (trim($wrap) != "") {
    ...
    public static function checkbox($nombre, $actual, $valor, $clase = "ef-checkbox", $extra = "")
    //Checkbox STANDART. recibe el valor y el valor actual
    {
        $s = "";
        if (!is_null($valor) && !is_null($actual) && $valor == $actual) {
            $s = "CHECKED";
        }		//Castea null a cero, por ende en necesario evitarlo
        $valor = texto_plano($valor);
        return "<input name='$nombre' id='$nombre' type='checkbox' value='$valor' $s class='$clase' $extra />\n";
    }

    public static function radio($nombre, $actual, $datos, $clase = null, $extra = "", $tab_index = "")
    {
        if (!is_array($datos)) {
            $datos = array();
        }
    ...
    public static function radio_manual($id, $nombre, $clave, $sel, $html_clase, $extra, $tab_index, $valor)
    {
    ...
    public static function hidden($nombre, $valor, $extra = "")
    //Campo HIDDEN
    {
        $valor = texto_plano($valor);
    ...
    public static function submit($nombre, $valor, $clase = "ei-boton", $extra = "", $tecla = null)
    // Boton de SUBMIT
    {
        if ($tecla === null) {
    ...
    public static function image($nombre, $src, $extra = "", $tecla = null)
    // Boton de SUBMIT
    {
    ...
    public static function button($nombre, $valor, $extra = "", $clase = "ei-boton", $tecla = null)
    // Boton de SUBMIT
    {
        if ($tecla === null) {
    ...
    public static function link_html(
        $nombre,
        $html,
        $extra = "",
        $tab = null,
    ...
    public static function password($nombre, $valor = "", $maximo = '', $tamanio = '', $clase = "ef-input", $extra = '')
    {
        $valor = texto_plano($valor);
    ...
    public static function archivo($nombre, $valor = null, $clase = "ef-upload", $extra = "")
    // Boton de SUBMIT
    {
        if (isset($valor)) {
            $valor = "value='$valor'";
    ...
    public static function abrir($nombre, $action, $extra = "", $method = "post", $upload = true)
    {
