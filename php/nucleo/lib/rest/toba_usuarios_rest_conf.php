    ...
    usuarios_usuario_password //devuelve si user/pass es valido para usar en basic
{
    ...
    private static $env_config = 'API_BASIC_CLIENTES';
    private static $env_config_ak = 'API_KEYS_CLIENTES';

    private static $passwd_index = 'password';
    private static $apk_index = 'api_key';
     ...
     */
    public function es_valido($usuario, $password)
    { //se usa para basic
