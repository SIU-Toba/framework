...
class toba_vista_pdf
{
     ...
     */
    public function set_texto_pie($texto)
    {
     ...
     */
    public function set_papel_tamanio($tamanio)
    {
     ...
     */
    public function set_papel_orientacion($orientacion)
    {
     ...
     */
    public function set_pdf_fuente($fuente = 'Helvetica.afm')
    {
     ...
     */
    public function numerar_paginas($posicion = 'right', $formato = '{PAGENUM} de {TOTALPAGENUM}')
    {
        $this->pdf->ezStartPageNumbers(500, 20, 8, $posicion, $formato, 1);
    }

    public function parar_numeracion_paginas()
    {
    ...
    public function texto($texto, $tamanio = 8, $opciones = array( 'justification' => 'left'))
    {
     ...
     */
    public function insertar_imagen($archivo, $pad = 5, $width = 0, $alineacion = 'left')
    {
     ...
     */
    public function tabla($datos, $ver_titulos_col = false, $tamanio = 8, $opciones = array())
    {
