...
class toba_vista_xslfo
{
     ...
     * @ignore
     */
    public function set_callback_preproceso($object)
    {
     ...
     * @return string
     */
    public function get_nombre_archivo_destino()
    {
     ...
     * @return string
     */
    public function get_nombre_archivo_xml()
    {
     ...
     * @return string
     */
    public function get_nombre_archivo_xsl()
    {
     ...
     * @return string
     */
    public function get_path_to_fop()
    {
        return $this->fop;
    }
     ...
     */
    public function get_manejador_vista_xml()
    {
        return $this->xml;
    }
