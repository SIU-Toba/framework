...
{
    public static $marca_login_basico = 'uso_login_basico';
    public static $marca_login_central = 'uso_login_central';
    public static $metodos_centralizados = array('cas','saml', 'saml_onelogin');
    public static $session_atributos_usuario = 'auth_atributos_usuario';
    public static $session_usuarios_posibles = 'userAccounts';
    public static $modo_debug = false;

    protected static $atributos_validos_usuario = [
    ...
    public static function es_autenticacion_centralizada($id)
    {
        return in_array($id, self::$metodos_centralizados);
    }

    public static function set_modo_debug($activo)
    {
        self::$modo_debug = $activo;
    }

    public function set_parametros_url($parametros)
    {
        $this->parametros_url = $parametros;
    }

    public function usar_login_basico()
    {
        $this->setear_marca_login(self::$marca_login_basico);
    }

    public function uso_login_basico()
    {
        return $this->verificar_marca_login(self::$marca_login_basico);
    }

    public function usar_login_centralizado()
    {
        $this->setear_marca_login(self::$marca_login_central);
    }

    public function uso_login_centralizado()
    {
        return $this->verificar_marca_login(self::$marca_login_central);
    }

    public function eliminar_login_basico()
    {
    ...
    public function get_atributos_usuario()
    {
     ...
     * @return array
     */
    public function get_lista_cuentas_posibles()
    {
    ...
    public function get_id_usuario_arai()
    {
