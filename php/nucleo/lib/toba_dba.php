...
class toba_dba
{
    ...
    public static function get_path_archivo_bases()
    {
    ...
    */
    public static function cargar_bases_definidas()
    {
    ...
    */
    public static function get_parametros_base($id_base)
    {
    ...
    */
    public static function set_parametros_base($id_base, $parametros)
    {
     ...
     * @return array()
     */
    public static function get_bases_definidas()
    {
    ...
    *	@return db
    */
    public static function get_db($nombre, $reusar = true)
    {
        return self::get_instancia()->get_conexion($nombre, $reusar);
    }

    public static function get_db_de_fuente($instancia, $proyecto, $fuente, $reusar = true)
    {
    ...
    */
    public static function existe_conexion($nombre)
    {
    ...
    */
    public static function refrescar($nombre)
    {
    ...
    *	Desconecta una DB
    */
    public static function desconectar($nombre)
    {
        $dba = self::get_instancia();
        $dba->desconectar_db($nombre);
    }
