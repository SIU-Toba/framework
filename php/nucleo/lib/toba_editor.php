...
class toba_editor
{
    ...
    */
    public static function iniciar($instancia, $proyecto)
    {
    ...
    public static function referenciar_memoria()
    {
    ...
    */
    public static function activado()
    {
    ...
    */
    public static function modo_prueba()
    {
    ...
    public static function get_id_instancia_activa()
    {
        if (self::activado()) {
    ...
    public static function get_base_activa()
    {
        if (self::activado()) {
    ...
    public static function get_db_defecto()
    {
    ...
    public static function get_proyecto_cargado()
    {
        if (self::activado()) {
    ...
    public static function set_proyecto_cargado($proyecto)
    {
     ...
     */
    public static function set_item_solicitado($item)
    {
    ...
    public static function get_punto_acceso_editor()
    {
        if (self::activado()) {
    ...
    */
    public static function acceso_recursivo()
    {
        if (self::activado()) {
    ...
    public static function limpiar_memoria_proyecto_cargado()
    {
    ...
    */
    public function iniciar_contexto_proyecto_cargado()
    {
    ...
    public function incluir_path_proyecto_cargado()
    {
        if (!self::acceso_recursivo()) {
    ...
    */
    public static function get_parametros_previsualizacion_js()
    {
     ...
     */
    public static function get_grupos_acceso_previsualizacion()
    {
        return self::get_perfiles_funcionales_previsualizacion();
    }


    public static function get_perfiles_funcionales_previsualizacion()
    {
        $param_prev = self::get_parametros_previsualizacion();
    ...
    */
    public static function get_perfil_datos_previsualizacion()
    {
    ...
    public static function get_perfiles_datos_previsualizacion()
    {
        $param_prev = self::get_parametros_previsualizacion();
     ...
     * @return unknown
     */
    public static function get_url_previsualizacion()
    {
        $pa = '';
    ...
    */
    public static function get_parametros_previsualizacion($refrescar = false)
    {
    ...
    */
    public static function set_parametros_previsualizacion($datos)
    {
    ...
    public static function get_parametros_previsualizacion_db()
    {
    ...
    public static function set_parametros_previsualizacion_db($datos)
    {
        $rs = self::get_parametros_previsualizacion_db();
        $datos = quote($datos);
        $proyecto = quote(self::get_proyecto_cargado());
     ...
     */
    public static function get_modelo_proyecto()
    {
    ...
    */
    public static function generar_zona_vinculos_item($item, $accion, $enviar_div_wrapper = true)
    {
        if (! self::acceso_recursivo()) {
    ...
    protected static function mostrar_vinculo($vinculo)
    {
        if (! isset($vinculo['js'])) {
    ...
    */
    public static function generar_zona_vinculos_componente($componente, $editor, $clase, $con_subclase)
    {
    ...
    */
    public static function get_vinculo_subcomponente($item_editor, $parametros, $opciones = array(), $frame = 'frame_centro')
    {
        $imagen = 'objetos/editar.gif';
        if (!isset($opciones['celda_memoria'])) {
    ...
    public static function get_vinculos_item($item, $accion)
    {
    ...
    public static function get_vinculos_componente($componente, $editor, $clase)
    {
        $vinculos = array();
        $opciones['celda_memoria'] = 'central';
        $opciones['menu'] = true;
    ...
    public static function get_vinculo_evento($componente, $editor, $evento)
    {
        $opciones['celda_memoria'] = 'central';
        $opciones['prefijo'] = self::get_punto_acceso_editor();
        $opciones['validar'] = false;
    ...
    public static function get_vinculo_pantalla($componente, $editor, $pantalla)
    {
        $opciones['celda_memoria'] = 'central';
        $opciones['prefijo'] = self::get_punto_acceso_editor();
        $opciones['validar'] = false;
    ...
    public static function get_utileria_editor_abrir_php($id_componente, $icono = 'reflexion/abrir.gif')
    {
    ...
    public static function imagen_editor($imagen, $html = false, $ancho = null, $alto = null, $tooltip = null, $mapa = null)
    {
    ...
    public static function db_proyecto_cargado($id_fuente)
    {
