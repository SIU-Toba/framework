...
class toba_error extends Exception
{
    ...
    public function __construct($mensaje_visible, $mensaje_solo_debug = '', $titulo_ventana = null)
    {
    ...
    public function get_mensaje_log()
    {
    ...
    public function get_titulo_ventana()
    {
...
class toba_error_db extends toba_error
{
    ...
    public function __construct($info, $sql = null, $parser_errores = null, $es_comando = false)
    {
    ...
    public function set_info_error($error)
    {
        $this->info_error = $error;
    }

    public function set_mensaje_motor($mensaje)
    {
        $this->info_error[2] = $mensaje;
    }

    public function set_sql_ejecutado($sql)
    {
        $this->sql = $sql;
    }

    public function get_mensaje_motor()
    {
        return $this->info_error[2];
    }

    public function get_sql_ejecutado()
    {
        return $this->sql;
    }
    ...
    public function get_codigo_motor()
    {
...
class toba_error_validacion extends toba_error
{
    ...
    public function __construct($mensaje, $causante = null)
    {
        $this->causante = $causante;
        parent::__construct($mensaje);
    }

    public function get_causante()
    {
...
{
    public function __construct($mensaje, $opciones, $headers)
    {
        if (PHP_SAPI != 'cli') {
...
class toba_reset_nucleo extends Exception
{
    ...
    public function __construct($mensaje = null, $id_item = null)
    {
        parent::__construct($mensaje);
        if (isset($id_item)) {
...
class toba_error_servicio_web extends toba_error
{
    ...
    public function __construct($mensaje_visible, $codigo_error = null, $mensaje_solo_debug = '')
    {
