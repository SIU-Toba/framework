...
class toba_fuente_datos
{
     ...
     * @return toba_db
     */
    public function get_db($reusar = true)
    {
        if ($reusar) {
            if (!isset($this->db)) {
                $this->pre_conectar();
                $this->db = toba_dba::get_db_de_fuente(
     ...
     * @return int
     */
    public function get_id_datos_tabla($tabla)
    {
    ...
    * @ventana
    */
    public function post_conectar()
    {
    }

    public function crear_usuario_para_auditoria($db)
    {
    ...
    public function configurar_parseo_errores($db)
    {
    ...
    public function set_fuente_posee_auditoria($tiene = false)
    {
    ...
    public function set_fuente_parsea_errores($parsea = false)
    {
        $this->definicion['parsea_errores'] = ($parsea) ? '1' : '0';
    }

    public function usa_permisos_por_tabla()
    {
     ...
     * @ignore
     */
    public function resetear_mapeo_tablas()
    {
        if (isset($this->definicion['mapeo_tablas_dt'])) {
