...
abstract class toba_gadget
{
    ...
    public function get_gadget_url()
    {
    ...
    public function set_gadget_url($url)
    {
        $this->_datos['gadget_url'] = $url;
    }

    public function set_clase($subclase, $subclase_archivo)
    {
    ...
    public function set_eliminable($eliminable)
    {
