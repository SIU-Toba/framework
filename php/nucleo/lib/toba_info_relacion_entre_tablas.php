...
class toba_info_relacion_entre_tablas
{
    ...
    public static function cargar_relaciones($fuente_datos, $proyecto = null)
    {
    ...
    */
    public static function get_relacion($tabla_1, $tabla_2, $fuente_datos = null, $proyecto = null)
    {
        if (!$fuente_datos) {
        ...
        if (isset(self::$relaciones[$fuente_datos][$tabla_1][$tabla_2])) {
            ...
            if (isset(self::$relaciones[$fuente_datos][$tabla_2][$tabla_1])) {
                ...
                toba_logger::instancia()->error('Información del modelo de datos de la fuente: '. $fuente_datos . ". No existe la relación: $tabla_1 - $tabla_2");
                throw new toba_error('Información del modelo de datos de la fuente: No existe relación entre las tablas planteadas, revise el log');
            }
        }
        return $respuesta;
    }
     ...
     * @param Array de tablas ordenadas segun su relación
     * @todo IMPLEMENTAR!
     */
    public static function validar_camino($camino)
    {
