...
class toba_instalacion
{
    ...
    private function __construct($recargar)
    {
        ...
        if (!$this->memoria || $recargar) {
            ...
            if (! file_exists($archivo)) {
                toba_logger::instancia()->error("No se encontro la instalación. El archivo instalacion.ini no se encuentra en la ruta : $archivo");
                throw new toba_error('No fue posible encontrar la instalación', 'El archivo instalacion.ini no se encuentra en la ruta');
            }
    ...
    */
     ...
     */
    public function get_editor_php()
    {
     ...
     */
    public function es_js_comprimido()
    {
    ...
    */
    ...
    public function arreglo_png_ie()
    {
     ...
     */
    public function get_numero_version()
    {
    ...
    public function get_datos_smtp($nombre_config = null)
    {
     ...
     */
    public static function get_path_temp()
    {
     ...
     * @return array
     */
    public function get_configuracion_certificados_ssl()
    {
        $conf = array();
