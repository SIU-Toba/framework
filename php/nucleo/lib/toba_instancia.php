...
class toba_instancia
{
     ...
     */
    public static function get_datos_instancia($id_instancia)
    {
    ...
    public function get_schema_logs_toba()
    {
    ...
    public static function get_path_instalacion_proyecto($proyecto)
    {
        $id_instancia = toba::instancia()->get_id();
    ...
    public function get_directiva_compilacion($proyecto)
    {
    ...
    public function get_directiva_compilacion_perfiles($proyecto)
    {
    ...
    public function get_largo_minimo_password()
    {
    ...
    public function registrar_solicitud($id, $proyecto, $item, $tipo_solicitud)
    {
    ...
    public function actualizar_solicitud_cronometro($id, $proyecto)
    {
    ...
    public function registrar_solicitud_observaciones($proyecto, $id, $tipo, $observacion)
    {
    ...
    public function registrar_solicitud_browser($proyecto, $id, $sesion_proyecto, $sesion, $ip)
    {
    ...
    public function registrar_solicitud_consola($proyecto, $id, $usuario, $llamada)
    {
    ...
    public function registrar_marca_cronometro($proyecto, $solicitud, $marca, $nivel, $texto, $tiempo)
    {
    ...
    public function registrar_solicitud_web_service($proyecto, $solicitud, $metodo, $ip)
    {
     ...
     */
    public function get_url_proyectos($proys)
    {
        $salida = array();
     ...
     */
    public function get_url_proyecto($proy)
    {
    ...
    public function get_url_proyecto_pers($proy)
    {
     ...
     */
    public function get_proyectos_accesibles($refrescar = false)
    {
     ...
     * @see toba_usuario
     */
    public function get_info_usuario($usuario)
    {
        $rs = array();
        if (trim($usuario) != '') {
            $rs = $this->get_info_usuarios(array($usuario));
        }
        if (empty($rs)) {
     ...
     * @see toba_usuario
     */
    public function get_info_usuarios($usuarios)
    {
        $rs = array();
        if (! empty($usuarios)) {
    ...
    public function get_info_autenticacion($usuario)
    {
        try {
            $sql = 'SELECT clave,
						  autentificacion,
    ...
    public function get_pregunta_secreta($usuario)
    {
        try {
    ...
    public function get_lista_claves_usadas($usuario, $periodo_tiempo = null, $no_repetidas = null)
    {
     ...
     * @return array
     */
    public function get_datos_perfiles_funcionales_usuario_proyecto($usuario, $proyecto)
    {
        $db = $this->get_db();
    ...
    */
    public function get_perfiles_funcionales($usuario, $proyecto)
    {
    ...
    */
    public function get_grupos_acceso($usuario, $proyecto)
    {
    ...
    */
    ...
    public function es_ip_rechazada($ip)
    {
    ...
    public function registrar_error_login($usuario, $ip, $texto)
    {
    ...
    public function bloquear_ip($ip)
    {
        try {
    ...
    public function get_cantidad_intentos_en_ventana_temporal($ip, $ventana_temporal = null)
    {
    ...
    public function get_cantidad_intentos_usuario_en_ventana_temporal($usuario, $ventana_temporal = null)
    {
    ...
    public function es_usuario_bloqueado($usuario)
    {
    ...
    public function abrir_sesion($sesion, $usuario, $proyecto)
    {
    ...
    public function cerrar_sesion($sesion, $observaciones = null)
    {
        $db = $this->get_db();
     ...
     */
    public function agregar_usuario($usuario, $nombre, $clave, $atributos = array())
    {
        $this->get_modelo_instancia()->agregar_usuario($usuario, $nombre, $clave, null, $atributos);
    }

    public function vincular_usuario($proyecto, $usuario, $perfil_acceso, $perfil_datos = array(), $set_previsualizacion = true)
    {
        $this->get_modelo_instancia()->get_proyecto($proyecto)->vincular_usuario($usuario, $perfil_acceso, $perfil_datos, $set_previsualizacion);
    }

    public function desbloquear_usuario($usuario)
    {
