...
class toba_js
{
    ...
    */
     ...
     */
    public static function incluir($archivo)
    {
     ...
     */
    public static function ejecutar($codigo)
    {
     ...
     */
    public function agregar_consumos_basicos($consumos = array())
    {
     ...
     */
    public static function cargar_consumos_basicos()
    {
        if (! self::$basicos_cargados) {
            ...
            //Cargo las libs no relacionadas al ppio
            self::$consumos_basicos = array_merge($consumos_lib, self::$consumos_basicos);
    ...
    public static function cargar_definiciones_runtime()
    {
     ...
     */
    public static function cargar_consumos_globales($consumos)
    {
     ...
     */
    public static function arreglo($arreglo, $es_assoc = false, $seg_nivel_assoc = true)
    {
        $js = "";
        $escapador = toba::escaper();
        if ($es_assoc) {
     ...
     */
    public static function string($cadena)
    {
        return pasar_a_unica_linea($cadena);
    }

    public static function sanear_string($cadena)
    {
     ...
     */
    public static function evento($id, $evento, $parametros = null, $es_implicito = false)
    {
        $escapador = toba::escaper();
