...
class toba_logger
{
    ...
    protected static $errores_manejables = array(E_WARNING, E_NOTICE, E_DEPRECATED);
     ...
     * @return logger
     */
    public static function instancia($proyecto = null)
    {
    ...
    public static function manejador_errores_recuperables($error_nro, $error_string, $error_archivo = '', $error_linea = 0)
    {
     ...
     */
    public function emergencia($mensaje, $proyecto = null)
    {
     ...
     */
    public function alerta($mensaje, $proyecto = null)
    {
     ...
     */
    public function crit($mensaje, $proyecto = null)
    {
     ...
     */
    public function error($mensaje, $proyecto = null)
    {
     ...
     */
    public function warning($mensaje, $proyecto = null)
    {
     ...
     */
    public function notice($mensaje, $proyecto = null)
    {
     ...
     */
    public function info($mensaje, $proyecto = null)
    {
     ...
     */
    public function debug($mensaje, $proyecto = null)
    {
    ...
    */
    public function obsoleto($clase, $metodo, $version, $extra = null, $proyecto = null)
    {
     ...
     */
    public function trace($con_parametros = false, $proyecto = null)
    {
     ...
     */
    public function var_dump($variable, $proyecto = null)
    {
     ...
     */
    public function seccion($mensaje, $proyecto = null)
    {
