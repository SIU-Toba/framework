...
class toba_mail implements toba_tarea
{
     ...
     */
    public function set_configuracion_smtp($nombre_conf = null)
    {
     ...
     */
    public function get_datos_configuracion_smtp()
    {
     ...
     */
    public function set_cc($direcciones = array())
    {
        $this->cc = $direcciones;
    }
     ...
     * @param array $direcciones Arreglo de direcciones de email
     */
    public function set_bcc($direcciones = array())
    {
     ...
     * @param boolean $html
     */
    public function set_html($html = true)
    {
        $this->html = true;
    }
     ...
     */
    public function set_remitente($from_name)
    {
     ...
     */
    public function set_confirmacion($confirm)
    {
     ...
     */
    public function agregar_adjunto($nombre, $path_archivo, $encoding = 'base64', $tipo = '')
    {
        $contenido = '';
