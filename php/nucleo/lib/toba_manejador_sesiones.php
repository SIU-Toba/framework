...
class toba_manejador_sesiones
{
    ...
    public static function verificar_directorio_toba()
    {
        if (!defined('TOBA_DIR')) {
    ...
    public static function enviar_csrf_hidden()
    {
        $tm = toba::memoria();
     ...
     */
    public function login($id_usuario, $clave = null, $datos_iniciales = null)
    {
     ...
     */
    public function login_anonimo($datos_iniciales = null)
    {
        if ($this->existe_sesion_activa()) {
     ...
     */
    public function logout($observaciones = null)
    {
     ...
     */
    public function cambio_usuario($actual, $nuevo, $datos_iniciales = null)
    {
    ...
    */
    public function iniciar_sesion_proyecto($datos_iniciales)
    {
     ...
     */
    public function set_autenticacion(toba_autenticable $autenticacion)
    {
        $this->autenticacion = $autenticacion;
    }

    public function get_autenticacion()
    {
    ...
    */
    public function existe_usuario_activo($instancia = null)
    {
    ...
    */
    public function existe_sesion_activa($proyecto = null)
    {
    ...
    */
    public function get_id_sesion($proyecto = null)
    {
        $proyecto = isset($proyecto) ? $proyecto : $this->proyecto;
    ...
    */
    public function get_id_usuario_instancia()
    {
        if ($this->existe_usuario_activo()) {
    ...
    */
    public function get_cantidad_instancias_cargadas()
    {
    ...
    */
    public function get_cantidad_instancias_activas()
    {
        $x = 0;
        if (isset($_SESSION[TOBA_DIR]['instancias']) && is_array($_SESSION[TOBA_DIR]['instancias'])) {
            foreach (array_keys($_SESSION[TOBA_DIR]['instancias']) as $instancia) {
                if ($this->existe_usuario_activo($instancia)) {
                    $x++;
                }
            }
        }
    ...
    */
    public function get_cantidad_proyectos_cargados()
    {
    ...
    */
    public function get_cantidad_proyectos_activos()
    {
        $x = 0;
    ...
    */
    public function existe_proyecto_cargado($proyecto)
    {
    ...
    */
    public function get_restricciones_funcionales()
    {
     ...
     * @return array
     */
    public function get_perfiles_funcionales_activos()
    {
     ...
     * @param array $activos
     */
    public function set_perfiles_funcionales_activos($activos)
    {
        $finales = array();
    ...
    */
    ...
    public function verificar_cambio_perfil_activo()
    {
    ...
    * @see toba_manejador_sesiones::get_perfiles_datos
    ...
    public function get_perfil_datos_activo()
    {
    ...
    */
    public function set_perfil_datos_activo($id_perfil)
    {
     ...
     * @throws toba_error_seguridad
     */
    public function set_perfiles_datos_activos($perfiles)
    {
    ...
    */
    public function abortar_sesion_proyecto($proyecto, $obs = null)
    {
    ...
    public function recargar_info_proyecto($proyecto)
    {
    ...
    public static function recargar_info_instalacion()
    {
        toba_instalacion::instancia(true);
    }

    public static function recargar_info_instancia()
    {
    ...
    */
    ...
    public static function & segmento_info_instalacion()
    {
    ...
    public function & segmento_info_instancia()
    {
        self::verificar_directorio_toba();
    ...
    public function & segmento_datos_instancia()
    {
        self::verificar_directorio_toba();
    ...
    public function & segmento_editor()
    {
        self::verificar_directorio_toba();
    ...
    public function & segmento_info_proyecto($proyecto = null)
    {
        self::verificar_directorio_toba();
        if (! isset($proyecto)) {
    ...
    public function & segmento_memoria_proyecto()
    {
        self::verificar_directorio_toba();
    ...
    public function & segmento_memoria_puntos_control()
    {
        self::verificar_directorio_toba();
    ...
    public function borrar_segmento_instalacion()
    {
        self::verificar_directorio_toba();
    ...
    public function borrar_segmento_instancia()
    {
        self::verificar_directorio_toba();
    ...
    public function borrar_segmento_editor()
    {
        self::verificar_directorio_toba();
    ...
    public function borrar_segmento_proyecto($proyecto = null)
    {
        self::verificar_directorio_toba();
        if (!isset($proyecto)) {
            $proyecto = $this->proyecto;
