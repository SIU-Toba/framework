...
class toba_memoria
{
    ...
    public function get_celda_memoria_actual_id()
    {
        return $this->celda_memoria_actual_id;
    }

    public function set_item_solicitado($item, $genera_csrf_token = true)
    {
     ...
     */
    public function prefijo_vinculo()
    {
     ...
     */
    public function get_servicio_solicitado()
    {
        return $this->servicio;
    }

    public function set_servicio_solicitado($servicio)
    {
     ...
     */
    public function get_id_objetos_destino()
    {
     ...
     */
    public function get_parametro($canal)
    {
     ...
     */
    public function get_item_solicitado()
    {
     ...
     * @return array [0]=>proyecto, [1]=>id_item
     */
    public static function get_item_solicitado_original()
    {
     ...
     * @return array
     */
    public function get_parametros_item_original()
    {
    ...
    public function usuario_solicita_cronometrar()
    {
    ...
    public function get_url_solicitud()
    {
    ...
    */
    public function inicializar_memoria()
    {
    ...
    {
        ei_arbol(
            array(	'global proyecto' => $this->memoria_global,
    ...
    */
     ...
     * @return boolean
     */
    public function verificar_acceso_popup()
    {
     ...
     */
    public function set_dato_instancia($indice, $datos)
    {
     ...
     */
    public function get_dato_instancia($indice, $eliminar_dato = false)
    {
     ...
     */
    public function eliminar_dato_instancia($indice)
    {
     ...
     */
    public function existe_dato_instancia($indice)
    {
     ...
     */
    public function limpiar_datos_instancia()
    {
     ...
     */
    public function set_dato($indice, $datos)
    {
     ...
     * @return mixed Si el dato existe en la memoria lo retorna sino retorna null
     */
    public function get_dato($indice)
    {
     ...
     */
    public function existe_dato($indice)
    {
    ...
    */
     ...
     */
    public function set_dato_operacion($indice, $datos)
    {
     ...
     * @return mixed Si el dato existe en la memoria lo retorna sino retorna null
     */
    public function get_dato_operacion($indice)
    {
     ...
     */
    public function eliminar_dato_operacion($indice)
    {
     ...
     */
    public function existe_dato_operacion($indice)
    {
     ...
     */
    public function limpiar_datos_operacion()
    {
     ...
     * Se elimina cuando se cambia de operación
     */
    public function set_array_operacion($indice, $datos)
    {
     ...
     */
    public function en_array_operacion($indice, $dato, $tira_excepcion = true)
    {
     ...
     * @return mixed Si el dato existe en la memoria lo retorna sino retorna null
     */
    public function get_array_operacion($indice)
    {
     ...
     */
    public function limpiar_array_operacion($indice)
    {
     ...
     */
    public function set_dato_sincronizado($indice, $datos, $celda = null)
    {
        if (!isset($celda)) {
     ...
     */
    public function get_dato_sincronizado($indice, $celda = null)
    {
        if (isset($celda)) {
     ...
     * @ignore
     */
    public function eliminar_evento_sincronizado_solicitud_previa($componente, $evento)
    {
    ...
    */
    public function registrar_archivo_temporal($archivo)
    {
    ...
    public function eliminar_archivos_temporales()
    {
     ...
     * @return mixed
     */
    public static function get_valor_verificado($param, $valor_defecto)
    {
    ...
    //						METODOS ANTI-CSRF
    //-------------------------------------------------------------------------------------------------------------------------------------//
    public function fijar_csrf_token($forzar = false)
    {
    ...
    public function validar_pedido_pagina($valor_form)
    {
    ...
    protected static function validar_id_item_enviado($item)
    {
