...
class toba_mensajes
{
     ...
     */
    public function set_fuente_ini($path)
    {
        if (! file_exists($path)) {
     ...
     */
    public function get($indice, $parametros = null)
    {
     ...
     * @param mixed $parametros Parámetros posicionales a ser reemplazados en el mensaje (puede ser uno solo o un array)
     */
    public function get_toba($indice, $parametros = null)
    {
     ...
     * @param mixed $parametros Parámetros posicionales a ser reemplazados en el mensaje (puede ser uno solo o un array)
     */
    public function get_proyecto($indice, $parametros = null)
    {
     ...
     * @param mixed $parametros Parámetros posicionales a ser reemplazados en el mensaje (puede ser uno solo o un array)
     */
    public function get_componente($objeto, $indice, $parametros = null)
    {
     ...
     */
    public function get_operacion_actual()
    {
     ...
     */
    public function parsear_parametros($mensaje, $parametros)
    {
