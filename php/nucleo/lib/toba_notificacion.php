...
class toba_notificacion
{
     ...
     */
    public function agregar($mensaje, $nivel = 'error', $extras = null)
    {
     ...
     * @param string $mensaje Mensaje completo a mostrar
     */
    public function error($mensaje, $extras = null)
    {
     ...
     * @param string $mensaje Mensaje completo a mostrar
     */
    public function warning($mensaje, $extras = null)
    {
     ...
     * @param string $mensaje Mensaje completo a mostrar
     */
    public function info($mensaje, $extras = null)
    {
     ...
     */
    public function mostrar($incluir_comsumos = true)
    {
        if ($incluir_comsumos) {
