...
class toba_parser_ayuda
{
     ...
     */
    public static function es_texto_plano($texto)
    {
     ...
     */
    public static function parsear(string $texto, $resumido = false)
    {
        $parseado = "";
        $resultado = array();
    ...
    public static function parsear_wiki_toba($id, $nombre, $proyecto = null, $resumido = false)
    {
        return self::parsear_wiki($id, $nombre, 'toba_editor', $resumido);
    }

    public static function parsear_wiki($id, $nombre, $proyecto = null, $resumido = false)
    {
    ...
    public static function parsear_api($id, $nombre, $proyecto = null, $resumido = false)
    {
        $anchor = '';
        if (strpos($id, '#') !== false) {
            $anchor = substr($id, strpos($id, '#') + 1);
    ...
    public static function parsear_api_js($id, $nombre, $proyecto = null, $resumido = false)
    {
        $anchor = '';
        if (strpos($id, '#') !== false) {
            $anchor = substr($id, strpos($id, '#') + 1);
