...
{
    public const separador_multicol_db = '|%-,-%|';
    ...
    */
    public function set_perfil($proyecto, $ids)
    {
        $this->ids = (! is_array($ids)) ? array($ids) : $ids;
        $this->inicializar($proyecto);
    }

    public function cargar_info_restricciones()
    {
    ...
    public function cargar_info_dimensiones($fuente)
    {
    ...
    public function indexar_gatillos($fuente)
    {
        $gatillos = array();
    ...
    *	@return string|null Si el usuario no posee un perfil devuelve NULL
    */
    ...
    *	@return array Si el usuario no posee un perfil devuelve NULL
    */
    ...
    *	@return boolean
    */
    public function posee_restricciones($fuente)
    {
        $resultado = false;
    ...
    *	@return array	Retorna un array de dimensiones con un subarray de restricciones
    */
    public function get_restricciones($fuente)
    {
        if (isset($this->restricciones[$fuente])) {
     ...
     * @return boolean
     */
    public function posee_dimension($dimension, $fuente_datos = null)
    {
    ...
    */
    public function get_restricciones_dimension($fuente, $nombre)
    {
    ...
    * @return array Arreglo de restricciones si aplica, sino null
     */
    public function get_restricciones_dimension_agrupado_perfil($fuente, $nombre)
    {
    ...
    *	@return array	Retorna un array de dimensiones
    */
    public function get_lista_dimensiones_restringidas($fuente)
    {
        if (isset($this->restricciones[$fuente])) {
    ...
    */
    public function get_gatillos_activos($fuente)
    {
    ...
    public static function get_restricciones_usuario($usuario, $proyecto)
    {
    ...
    */
    public function filtrar($sql, $fuente_datos = null, $dimensiones_desactivar = null, $gatillos_exclusivos = array())
    {
    ...
    public function filtrar_sql($sql, $fuente_datos = null, $dimensiones_desactivar = null, $gatillos_exclusivos = array())
    {
        ...
        foreach ($dimensiones_implicadas as $dimension => $tabla) {
            if (isset($dimensiones_desactivar) && in_array($dimension, $dimensiones_desactivar)) {
                continue;
            }
    ...
    */
    public function reconocer_dimensiones_implicadas($tablas_encontradas, $fuente_datos)
    {
        $dimensiones = array();
    ...
    */
    public function get_where_dimension_gatillo($fuente_datos, $dimension, $tabla_gatillo, $alias_tabla)
    {
    ...
    public function get_where_aplicacion_restriccion($fuente_datos, $dimension, $columnas_aplicacion_restriccion, $alias_tabla)
    {
        $where = array();
    ...
    */
    public function get_alias_unico()
    {
        $this->id_alias_unico++;
        return 'toba_pdtasoc_' . $this->id_alias_unico;
    }

    public function get_lista_columnas_sql($columnas, $alias)
    {
        $sql = '';
        $c = count($columnas);
        for ($a = 0;$a < $c;$a++) {
    ...
    */
    public function buscar_tablas_gatillo_en_sql($sql, $fuente_datos)
    {
    ...
    */
    public function get_clausula_from($sql)
    {
        //-- 1: Preparo el SQL
        // Le saco el ';' de atras
        $sql = trim($sql);
        ...
        foreach ($tokens as $token) {
            ...
            //Sali del FROM?
            if ($en_from && (
                ($balance == 0 && (stripos($token, 'where') !== false))
    ...
    */
    public function buscar_gatillos_from($sql_from, $fuente_datos)
    {
        $i = 0;
        $tablas = array();
    ...
    public function hay_combinaciones_de_querys($sql)
    {
    ...
    */
    public function get_info($fuente_datos)
    {
    ...
    */
    public function probar_sqls($fuente_datos, $sqls, $contar_filas = false, $mostrar_filas = false)
    {
        $test = array();
        if (! $this->posee_restricciones($fuente_datos)) {
            return $test;
