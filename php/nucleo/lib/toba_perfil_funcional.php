...
class toba_perfil_funcional
{
     ...
     * @return array
     */
    public function get_rf_pantallas_no_visibles($ci)
    {
        $pantallas = array();
     ...
     * @return array
     */
    public function get_rf_eis_no_visibles()
    {
        $eis = array();
    ...
    public function get_rf_eventos_no_visibles()
    {
        $eventos = array();
    ...
    public function get_rf_cuadro_cols_no_visibles($id_cuadro)
    {
        $columnas = array();
    ...
    public function get_rf_form_efs_no_visibles($id_form)
    {
        $efs = array();
    ...
    public function get_rf_form_efs_no_editables($id_form)
    {
        $efs = array();
        foreach ($this->rf_form_efs as $rf) {
    ...
    public function get_rf_filtro_cols_no_visibles($id_filtro)
    {
        $columnas = array();
