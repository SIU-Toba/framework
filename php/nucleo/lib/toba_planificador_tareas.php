...
class toba_planificador_tareas
{
     ...
     */
    public function programar_tarea(toba_tarea $tarea, $timestamp, $intervalo = null, $nombre = null)
    {
     ...
     */
    public function desprogramar($id_tarea, $manejador_interface = null)
    {
        $db = toba::instancia()->get_db();
     ...
     * @param toba_manejodr_interface $manejador_interface Clase para la salida grafica, por defecto nulo
     */
    public function ejecutar_pendientes($manejador_interface = null)
    {
     ...
     * @param toba_manejodr_interface $manejador_interface Clase para la salida grafica, por defecto nulo
     */
    public function ejecutar_tarea($id, $manejador_interface = null)
    {
