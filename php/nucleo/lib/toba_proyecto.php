...
class toba_proyecto
{
    ...
    public const prefijo_punto_acceso = 'apex_pa_';
    ...
    public static function hay_instancia()
    {
     ...
     */
    public function set_parametro($id, $valor)
    {
     ...
     * @return toba_db
     */
    public function cargar_info_basica($proyecto = null)
    {
    ...
    public function es_multiproyecto()
    {
        return $this->get_parametro('listar_multiproyecto');
    }

    public function permite_cambio_perfiles()
    {
    ...
    public function personalizacion_activa()
    {
    ...
    public function get_clases_extendidas()
    {
        return array(
    ...
    public static function get_path_pers()
    {
     ...
     */
    public static function get_directiva_compilacion()
    {
     ...
     */
    public static function get_path_php()
    {
     ...
     */
    public static function get_path_pers_php()
    {
     ...
     */
    public function get_www($archivo = "")
    {
    ...
    public function get_www_pers($archivo = "")
    {
     ...
     * @return array con claves 'path' (en el sist.arch.) y 'url' (URL navegable)
     */
    public function get_www_temp($archivo = '')
    {
    ...
    public function get_definicion_dependencia($id_componente, $proyecto = null)
    {
        $proyecto = isset($proyecto) ? $proyecto : $this->id ;
    ...
    public function get_id_componente_por_indice($identificador, $proyecto = null)
    {
    ...
    public function get_info_dimension($dimension, $proyecto = null)
    {
        if (! isset($proyecto)) {
            $proyecto = $this->id;
        }
    ...
    public static function get_info_relacion_entre_tablas($fuente_datos, $proyecto)
    {
        if (toba::nucleo()->utilizar_metadatos_compilados($proyecto)) {
    ...
    public function get_info_punto_control($punto_control, $proyecto = null)
    {
        if (! isset($proyecto)) {
            $proyecto = $this->id;
        }
    ...
    public function get_info_fuente_datos($id_fuente, $proyecto = null)
    {
        if (! isset($proyecto)) {
            $proyecto = $this->id;
        }
     ...
     */
    public function get_items_menu($proyecto = null, $grupos_acceso = null)
    {
        if (!isset($proyecto)) {
            $proyecto = $this->id;
        }
        if (!isset($grupos_acceso)) {
        ...
        if (toba::nucleo()->utilizar_metadatos_compilados($proyecto) && toba::nucleo()->usar_perfiles_compilados($proyecto)) {
            $rs = $this->recuperar_datos_compilados_grupo(
                'toba_mc_gene__grupo_',
                $grupos_acceso,
                'get_items_menu',
                true,
                array('padre','orden')
    ...
    public function quitar_item_menu($item)
    {
     ...
     */
    public function puede_grupo_acceder_item($item)
    {
        $grupos_acceso = toba::manejador_sesiones()->get_perfiles_funcionales_activos();
        ...
        if (!isset($this->indice_items_accesibles)) {
            ...
            if (toba::nucleo()->utilizar_metadatos_compilados($this->id, 'compilados') && toba::nucleo()->usar_perfiles_compilados($this->id)) {
                ...
                if (! empty($grupos_acceso)) {
                    ...
                    $this->indice_items_accesibles = $this->recuperar_datos_compilados_grupo(
                        'toba_mc_gene__grupo_',
                        $grupos_acceso,
    ...
    */
    public function get_items_zona($zona, $grupos_acceso = null)
    {
        if (!isset($grupos_acceso)) {
            $grupos_acceso = toba::manejador_sesiones()->get_perfiles_funcionales_activos();
        }
    ...
    public function get_perfiles_funcionales_usuario_anonimo()
    {
     ...
     */
    public function get_grupos_acceso_usuario_anonimo()
    {
        return $this->get_perfiles_funcionales_usuario_anonimo();
    }


    public function get_perfiles_funcionales_asociados($perfil)
    {
        if (toba::nucleo()->utilizar_metadatos_compilados($this->id) && toba::nucleo()->usar_perfiles_compilados($this->id)) {
     ...
     */
    public function get_lista_permisos($grupos_acceso = null)
    {
     ...
     */
    public function get_descripcion_permiso($permiso)
    {
        if (toba::nucleo()->utilizar_metadatos_compilados($this->id)) {
    ...
    public function get_mensaje_toba($indice)
    {
        if (toba::nucleo()->utilizar_metadatos_compilados($this->id)) {
    ...
    public function get_mensaje_proyecto($indice)
    {
        if (toba::nucleo()->utilizar_metadatos_compilados($this->id)) {
    ...
    public function get_mensaje_objeto($objeto, $indice)
    {
        if (toba::nucleo()->utilizar_metadatos_compilados($this->id)) {
    ...
    public function get_info_consulta_php($clase, $proyecto = null)
    {
        if (! isset($proyecto)) {
            $proyecto = $this->id;
        }
    ...
    public function get_info_servicios_web_acc($id, $proyecto = null)
    {
        if (! isset($proyecto)) {
            $proyecto = $this->id;
        }
    ...
    public function get_info_pms($proyecto = null)
    {
        if (is_null($proyecto)) {
            $proyecto = $this->id;
        }
     ...
     */
    public function get_gadgets_proyecto($usuario, $proyecto = null)
    {
        if (is_null($proyecto)) {
            $proyecto = $this->id;
    ...
    public static function existe_dato_compilado($clase, $metodo)
    {
        return in_array($metodo, get_class_methods($clase));
    }

    public static function recuperar_datos_compilados($clase, $metodo)
    {
        return call_user_func(array($clase, $metodo));
    }

    public function recuperar_datos_compilados_grupo($prefijo_clase, $grupos, $metodo, $reindexar = true, $orden = null)
    {
        $temp = array();
    ...
    public function configurar_logger()
    {
    ...
    public function configurar_logger_ws()
    {
        if (defined('apex_pa_log_archivo_nivel')) {
