...
class toba_proyecto_implementacion
{
    ...
    */
    public static function get_perfiles_datos($proyecto)
    {
    ...
    */
    public static function get_info_perfiles_datos($proyecto, $perfil)
    {
        $db = toba::instancia()->get_db();
        $proyecto = $db->quote($proyecto);
    ...
    */
    public static function get_perfil_datos($usuario, $proyecto)
    {
     ...
     * @return array
     */
    public static function get_perfiles_datos_usuario($usuario, $proyecto)
    {
        $db = toba::instancia()->get_db();
        $proyecto = $db->quote($proyecto);
    ...
    * @return array
    */
    public static function get_perfil_datos_restricciones($proyecto, $perfil)
    {
        $db = toba::instancia()->get_db();
        $proyecto = $db->quote($proyecto);
        $perfil = $db->quote($perfil);
     ...
     */
    public static function get_restricciones_funcionales($grupos, $proyecto)
    {
        if (empty($grupos)) {
            return array();
        }
    ...
    public static function get_rf_pantallas($proyecto, $item, $rf)
    {
        $db = toba::instancia()->get_db();
        $proyecto = $db->quote($proyecto);
        $item = $db->quote($item);
    ...
    public static function get_rf_eis($proyecto, $item, $rf)
    {
        $db = toba::instancia()->get_db();
        $proyecto = $db->quote($proyecto);
        $item = $db->quote($item);
    ...
    public static function get_rf_eventos($proyecto, $item, $rf)
    {
        $db = toba::instancia()->get_db();
        $proyecto = $db->quote($proyecto);
        $item = $db->quote($item);
    ...
    public static function get_rf_cuadro_cols($proyecto, $item, $rf)
    {
        $db = toba::instancia()->get_db();
        $proyecto = $db->quote($proyecto);
        $item = $db->quote($item);
    ...
    public static function get_rf_form_efs($proyecto, $item, $rf)
    {
        $db = toba::instancia()->get_db();
        $proyecto = $db->quote($proyecto);
        $item = $db->quote($item);
    ...
    public static function get_rf_filtro_cols($proyecto, $item, $rf)
    {
        $db = toba::instancia()->get_db();
        $proyecto = $db->quote($proyecto);
        $item = $db->quote($item);
