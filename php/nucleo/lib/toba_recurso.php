...
class toba_recurso
{
     ...
     * @return string
     */
    public static function url_proyecto($proyecto = null, $pers = false)
    {
        if (! isset($proyecto)) {
     ...
     */
    public static function url_toba()
    {
     ...
     * @return string
     */
    public static function url_skin($skin = null, $proyecto = null)
    {
        if (! isset($skin)) {
     ...
     */
    public static function imagen_de_origen($nombre, $origen)
    {
     ...
     */
    public static function imagen_proyecto(string $imagen, $html = false, $ancho = null, $alto = null, $tooltip = null, $mapa = null, $proyecto = null)
    {
     ...
     * @param string $mapa (no oblig.)
     */
    public static function imagen_skin($imagen, $html = false, $ancho = null, $alto = null, $tooltip = null, $mapa = null)
    {
     ...
     * @param string $mapa (no oblig.)
     */
    public static function imagen_toba($imagen, $html = false, $ancho = null, $alto = null, $alt = null, $mapa = null, $js = null)
    {
     ...
     */
    public static function imagen($src, $ancho = null, $alto = null, $alt = null, $mapa = null, $js = '', $estilo = '')
    {
        $wiki = false;
        $x = "";
        $y = "";
     ...
     */
    public static function ayuda($tecla, $ayuda = '', $clases_css = '', $delay_ayuda = 1000)
    {
        $ayuda_extra = '';
        $a = '';
        if ($tecla !== null) {
    ...
    public static function link_css($archivo = 'toba', $rol = 'screen', $buscar_en_proyecto = true)
    {
        $link = '';
        $version = toba::memoria()->get_dato_instancia('toba_revision_recursos_cliente');
    ...
    public static function link_css_proyecto($archivo, $rol = 'screen')
    {
        $link = '';
        $version = toba::memoria()->get_dato_instancia('toba_revision_recursos_cliente');
        $agregado_url = (!  is_null($version)) ? "?av=$version" : '';
