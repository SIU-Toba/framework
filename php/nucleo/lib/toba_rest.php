...
class toba_rest
{
    ...
    public static function url_rest($api = '')
    {
    ...
    public function get_instancia_rest()
    {
        return $this->app;
    }

    public function ejecutar($api = '')
    {
        if ($this->es_pedido_documentacion($api)) {
