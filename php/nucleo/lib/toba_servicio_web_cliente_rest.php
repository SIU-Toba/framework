...
{
    public const HEADER_VERSION = 'API-Version';
    public const VERIFY_PEER_VAR = 'TOBA_REST_VERIFY_PEER';
    public const ENV_PREFIX = 'CREDENCIALES_API_BASIC_';
    ...
    public static function get_version_api($response)
    {
    ...
    public static function get_datos_conexion($id_servicio)
    {
     ...
     * @return string
     */
    public static function get_url_base($opciones): string
    {
