...
{
    public const id_fila_generica = '_toba_fila_';
     ...
     */
    public function __construct($datos, $opciones = array())
    {
        $this->datos = $datos;
    ...
    public static function payload_a_array($nodo_xml)
    {
        $salida = array();
    ...
    public static function array_a_payload($array, $nivel = 0, $clave_padre = '')
    {
        $salida = '';
     ...
     */
    public function firmar_mensaje($clave_privada)
    {
    ...
    public function set_headers($asociativo)
    {
        $data = array();
