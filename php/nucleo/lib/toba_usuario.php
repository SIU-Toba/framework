...
class toba_usuario implements toba_interface_usuario
{
	...
	static function forzar_cambio_clave($usuario) 
	{
		...
		try {
			...
			toba::logger()->debug('No se pudo forzar el cambio de contrase�a en el usuario '. $usuario);
	...
	/**
	 *  Verifica la composicion y largo de una contrase�a de usuario, lanza excepcion cuando falla la validacion,
