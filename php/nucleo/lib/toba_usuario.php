...
class toba_usuario implements toba_interface_usuario
{
    ...
    public static function autenticar($id_usuario, $clave, $datos_inciales = null)
    {
        return false;
    }
    ...
    */
    ...
    public static function generar_clave_aleatoria($long)
    {
    ...
    public function set_clave($clave_plana)
    {
        $this->set_clave_usuario($clave_plana, $this->get_id());
    }

    public static function set_clave_usuario($clave_plana, $usuario)
    {
    ...
    public static function reemplazar_clave_vencida($clave_plana, $usuario, $dias_validez = null, $con_transaccion = true)
    {
    ...
    public static function forzar_cambio_clave($usuario)
    {
    ...
    public static function verificar_clave_no_utilizada($clave_plana, $usuario, $no_repetidas = null)
    {
    ...
    public static function verificar_clave_vencida($id_usuario)
    {
    ...
    public static function verificar_periodo_minimo_cambio($usuario, $periodo)
    {
     ...
     */
    public static function verificar_composicion_clave($pwd, $largo_minimo = null)
    {
     ...
     * @ignore
     */
    public static function get_exp_reg_pwd($largo_minimo)
    {
        return '/^(?!.*(.)\1{1})((?=.*[^\w\d\s])(?=.*[a-zA-Z])|(?=.*[0-9])(?=.*[a-zA-Z])).{'. $largo_minimo.',}$/';
    }

    public static function existe_usuario($id_usuario)
    {
        $datos_usuario = toba::instancia()->get_info_autenticacion($id_usuario);
