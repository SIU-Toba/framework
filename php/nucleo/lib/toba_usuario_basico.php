	...
	*/
	function get_parametro($parametro)
	{
		...
		if ( !($parametro=='a'||$parametro=='b'||$parametro=='c') ) {
			toba::logger()->error("Consulta de par�metro de usuario: El par�metro '$parametro' es invalido.");
			throw new toba_error('Consulta de par�metro de usuario: El par�metro no se encuentra o es invalido, revise el log.');
		}
