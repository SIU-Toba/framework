...
class toba_vinculador
{
     ...
     * @see get_url
     */
    public function crear_vinculo($proyecto = null, $item = null, $parametros = array(), $opciones = array())
    {
     ...
     * @see get_url
     **/
    public function crear_autovinculo($parametros = array(), $opciones = array())
    {
     ...
     */
    public function get_url($proyecto = null, $item = null, $parametros = array(), $opciones = array(), $uri_valida = false)
    {
        if (!isset($opciones['zona'])) {
            $opciones['zona'] = true;
        }
        if (!isset($opciones['cronometrar'])) {
            $opciones['cronometrar'] = false;
        }
        if (!isset($opciones['param_html'])) {
            $opciones['param_html'] = null;
        }
        if (!isset($opciones['menu'])) {
            $opciones['menu'] = null;
        }
        if (!isset($opciones['celda_memoria'])) {
            $opciones['celda_memoria'] = null;
        }
        if (!isset($opciones['texto'])) {
            $opciones['texto'] = '';
        }
        if (!isset($opciones['servicio'])) {
            $opciones['servicio'] = apex_hilo_qs_servicio_defecto;
        }
        if (!isset($opciones['objetos_destino'])) {
            $opciones['objetos_destino'] = null;
        }
        if (!isset($opciones['prefijo'])) {
            $opciones['prefijo'] = null;
        }
        if (!isset($opciones['nombre_ventana'])) {
            $opciones['nombre_ventana'] = null;
        }
        $url = $this->generar_solicitud(
            $proyecto,
            $item,
            $parametros,
            $opciones['zona'],
            $opciones['cronometrar'],
            $opciones['param_html'],
            $opciones['menu'],
            $opciones['celda_memoria'],
            $opciones['servicio'],
            $opciones['objetos_destino'],
            $opciones['prefijo'],
            $opciones['nombre_ventana']
        );
        if ($uri_valida) {
            $invalidos = "||";
    ...
    public function get_url_ws($proyecto = null, $ws = null, $parametros = array(), $opciones = array())
    {
        $separador = '&';
        if (is_null($proyecto)) {
    ...
    public function registrar_vinculo(toba_vinculo $vinculo)
    {
     ...
     */
    protected function generar_solicitud(
        $item_proyecto = null,
        $item = null,
        $parametros = null,
        $zona = false,
     ...
     */
    public static function variable_a_url($variable)
    {
     ...
     */
    public static function url_a_variable($url)
    {
    ...
    */
    public function generar_js()
    {
        ...
        foreach ($this->vinculos as $id => $vinculo) {
            ...
            $datos['url'] = $this->get_url(
                $vinculo->get_proyecto(),
                $vinculo->get_item(),
