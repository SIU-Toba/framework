 ...
 * operaci�n actual puede acceder (considerando el USUARIO que lo solicito)
 * Para navegar hacia ellas puede construir URLs e incluirlos en alg�n TAG
 *
 * @see toba_vinculo
 * @package Centrales
...
class toba_vinculador 
{
	...
	/**
	 * Genera una url que apunta a una operaci�n de un proyecto
	 *
	 ...
	 * <code> zona => Activa la propagaci�n autom�tica del editable en la zona
	 ...
	 * texto => Texto del v�nculo
	 * menu => El vinculo esta solicitado por una opci�n menu?
...
//##################################################################################
	...
	/**
	 * Retorna el querystring propagando la zona actual (si es que hay y est� cargada)
	 * @return string
	 */
	 ...
	 *
	 * @param string $item_proyecto Proyecto al que pertenece el �tem destino (por defecto el actual)
	 * @param string $item ID. del �tem destino (por defecto el actual)
	 ...
	 * @return string Comando JS que contiene el salto de p�gina
	 */
	...
	*/
	...
	/**
	 * M�todo de debug que dumpea el estado actual de los vinculos registrados
	 */
	function info()
	{
		echo "<ul>";
