...
class toba_zona
{
    ...
    public function __construct($id, $metodo_cons)
    {
        $this->id = $id;
     ...
     * @return mixed
     */
    public function get_info($clave = null)
    {
        if (! isset($clave)) {
     ...
     * @param boolean $modo
     */
    public static function set_modo_url($modo)
    {
     ...
     */
    public static function cancelar_propagacion()
    {
     ...
     */
    public function get_items_vecinos()
    {
        $items = array();
     ...
     */
    public function desactivar_items($condiciones = array())
    {
     ...
     * @param mixed $item
     */
    public function desactivar_item($item)
    {
        if (! is_null($item)) {
     ...
     */
    public function generar_html_barra_superior()
    {
     ...
     */
    public function generar_html_barra_id()
    {
        if ($this->get_modo_url()) {
     ...
     */
    public function generar_html_barra_nombre()
    {
     ...
     * @ventana
     */
    public function generar_html_barra_vinculos()
    {
     ...
     * @ventana
     */
    public function generar_html_barra_especifico()
    {
    }
     ...
     * @ventana
     */
    public function generar_html_barra_inferior()
    {
    }
