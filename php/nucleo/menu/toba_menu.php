...
abstract class toba_menu
{
    ...
    public function __construct($carga_inicial = true)
    {
        if ($carga_inicial) {
    ...
    public function set_abrir_nueva_ventana($imagen = 'nucleo/abrir_nueva_ventana.gif')
    {
    ...
    public function set_datos_opcion($id_item, $datos)
    {
        $ok = false;
        for ($i = 0; $i < count($this->items); $i++) {
    ...
    public function agregar_opcion($datos)
    {
    ...
    public function quitar_opcion($id_item)
    {
        $ok = false;
        for ($i = 0; $i < count($this->items); $i++) {
            if ($this->items[$i]['item'] == $id_item) {
     ...
     * @ignore
     */
    public function set_modo_prueba()
    {
     ...
     */
    public function set_modo_confirmacion($mensaje, $forzar = true)
    {
