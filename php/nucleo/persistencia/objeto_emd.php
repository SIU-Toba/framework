...
/*
	- Esta clase representa el ESTADO (datos + info de cambios) de una estructura tabular
	- Hace falta un buen nombre para este elemento:
		- md: Matriz de Datos
		- ut: Unidad Transaccional
		- emd: Estado de una Matriz de Datos
		- eut: Estado de una Unidad Transaccional
*/
class objeto_emd extends objeto
{
	//Metadatos
	protected $info_estructura;
	protected $info_estructura_columnas;	
