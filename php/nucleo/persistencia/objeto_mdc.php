...
/*
	- Esta clase una MATRIZ de DATOS, provee primitivas de modificacion y mantiene un log de los CAMBIOS
*/
class objeto_mdc extends objeto
{
	//Metadatos
	...
	*/
	...
	/*
		...
		Esto tiene que controlarse en la sincronizacion y no cuando se utilizan las primitivas de modificacion
		de registros
	*/
	{
