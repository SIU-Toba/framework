...
class toba_tp_basico extends toba_tipo_pagina
{
    ...
    public function barra_superior()
    {
        echo toba::output()->get('PaginaBasica')->getContenidoBarraSuperior();
    }

    public function mostrar_resize_fuente()
    {
    ...
    public function inicio_encabezado_html()
    {
        echo toba::output()->get('PaginaBasica')->getPreEncabezadoHtml();
    }

    public function fin_encabezado_html()
    {
    ...
    public function post_encabezado()
    {
