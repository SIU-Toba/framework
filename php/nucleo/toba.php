...
class toba
{
    ...
    private static $menu;
    private static $contexto_ejecucion;
    private static $perfil_de_datos;
    private static $perfil_funcional;
    private static $cn = array();
    private static $consultas_php;
    private static $rdi;
    private static $escaper;
    private static $config;
    private static $output_handler;
     ...
     */
    public static function contexto_ejecucion()
    {
     ...
     */
    public static function vinculador()
    {
    ...
    */
    public static function logger_ws()
    {
     ...
     */
    public static function derechos()
    {
     ...
     */
    public static function fuente($id_fuente = null)
    {
     ...
     */
    public static function db($id_fuente = null, $proyecto = null)
    {
     ...
     */
    public static function encriptador()
    {
     ...
     */
    public static function cronometro()
    {
     ...
     */
    public static function instalacion()
    {
    ...
    */
    public static function manejador_sesiones()
    {
     ...
     */
    public static function puntos_control()
    {
     ...
     * @return toba_pms
     */
    public static function puntos_montaje()
    {
     ...
     */
    public static function app_launcher()
    {
     ...
     */
    public static function tabla($nombre_tabla, $fuente = null, $reusar = true)
    {
        if (!isset($fuente)) {
     ...
     */
    public static function componente($indice)
    {
        $id['proyecto'] = toba_proyecto::get_id();
     ...
     * @return toba_componente
     */
    public static function componente_por_id($id)
    {
     ...
     * @return toba_cn
     */
    public static function cn($indice)
    {
     ...
     */
    public static function perfil_de_datos()
    {
     ...
     */
    public static function perfil_funcional()
    {
     ...
     */
    public static function planificador_tareas($proyecto = null)
    {
     ...
     */
    public static function consulta_php($clase)
    {
     ...
     */
    public static function acciones_js()
    {
     ...
     */
    public static function servicio_web($id, $opciones = array())
    {
     ...
     */
    public static function servicio_web_rest($id, $opciones = array())
    {
     ...
     */
    public static function contenedor_gadgets()
    {
