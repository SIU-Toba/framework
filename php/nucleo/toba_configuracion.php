...
class toba_configuracion
{
    ...
    public function add_mapeo($nombre, $objeto)
    {
        $this->mapeo[$nombre] = $objeto;
    }

    public function get_mapeo($nombre)
    {
        return $this->mapeo[$nombre];
    }

    public function existe_mapeo($nombre)
    {
     ...
     */
    public static function extender_ei_grafico_conf(toba_ei_grafico_conf_global $objeto)
    {
     ...
     */
    public static function ei_grafico_conf()
    {
