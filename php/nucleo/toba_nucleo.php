...
class toba_nucleo
{
    ...
    private static $dir_compilacion;
    private static $path;
    /**
     * @var toba_solicitud
     */
    ...
    public static function get_indice_archivos()
    {
    ...
    public static function cargar_autoload_composer()
    {
     ...
     * Punto de entrada http al nucleo
     */
    public function acceso_servicio()
    {
        try {
     ...
     */
    public function acceso_consola($instancia, $proyecto, $item)
    {
        $estado_proceso = null;
    ...
    public function iniciar_contexto_desde_consola($instancia, $proyecto)
    {
     ...
     */
    public function cargar_solicitud_web()
    {
    ...
    public function finalizar_contexto_rest()
    {
        toba::contexto_ejecucion()->conf__final();
        if (isset($this->solicitud)) {
            $this->solicitud->guardar_cronometro();
    ...
    public function controlar_requisitos_basicos()
    {
        //Removido el contenido que chequeaba magic_quotes
    }

    public function es_acceso_rest()
    {
    ...
    public static function toba_dir()
    {
        if (! isset(self::$path)) {
    ...
    public static function toba_instalacion_dir()
    {
    ...
    *	@ignore
    */
    public function utilizar_archivos_compilados()
    {
    ...
    *	@ignore
    */
    public function utilizar_metadatos_compilados($proyecto = null)
    {
    ...
    public function usar_perfiles_compilados($proyecto = null)
    {
        $proyecto = isset($proyecto) ? $proyecto : toba_proyecto::get_id();
    ...
    *	@ignore
    */
    public static function get_includes_funciones_globales()
    {
        return array(
    ...
    //-- Metodos auxiliares
    //----------------------------------------------------------------
    public function verificar_pedido_post()
    {
     ...
     * @return boolean
     */
    public function verifica_necesidad_2FA()
    {
