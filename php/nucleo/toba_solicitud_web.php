...
class toba_solicitud_web extends toba_solicitud
{
    ...
    protected function servicio__generar_html($objetos)
    {
        ...
        if ($accion == '') {
            ...
            toba_js::cargar_definiciones_runtime();
            echo toba_js::cerrar();
            toba_cargador::cargar_clase_archivo($this->info['basica']['punto_montaje'], $accion, toba::proyecto()->get_id());
        }
    ...
    public function registrar()
    {
        ...
        if ($this->registrar_db && isset($id_sesion)) {
            toba::instancia()->registrar_solicitud_browser(
     ...
     */
    public function set_autocomplete($set)
    {
     ...
     *@private
     */
    public function hacer_seguimiento()
    {
     ...
     * @private
     */
    public function generar_analizador_estadistico()
    {
        $cod_ga = toba::proyecto()->get_parametro('codigo_ga_tracker');
    ...
    public function inicializacion_pasiva()
    {
        $this->crear_zona();
        $this->cargar_objetos();
    }
