...
*/
class test_db_registros_mt_seq extends base_test_db_registros
{
	...
	function get_dbr()
	{
		require_once("mock_db_registros_mt_seq_dbr.php");
		return new mock_db_registros_mt_seq_dbr("instancia");
	}
