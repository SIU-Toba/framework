...
*/
class test_db_registros_s_alias extends base_test_db_registros
{
	...
	function get_dbr()
	{
		require_once("mock_db_registros_s_alias_dbr.php");
		return new mock_db_registros_s_alias_dbr("instancia");
	}
