...
*/
class test_db_registros_std_mt_2 extends base_test_db_registros_std_mt
{

	function get_descripcion()
	{
		return "DBR Estandard -- db_registros_mt -[ 2 ]- ( 2 tablas / INNER join / clave compuesta identica)";
	}	
	...
	function get_dbr()
	{
		require_once("mock_db_registros_std_mt_2_dbr.php");
		return new mock_db_registros_std_mt_2_dbr("instancia");
	}

	function get_where_test()
	{
		return	array("test_maestro.id1 IN (0,1,2)");
	}
