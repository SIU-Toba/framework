...
*/
class test_db_registros_std_mt_3 extends base_test_db_registros_std_mt
{
	...
	function get_dbr()
	{
		require_once("mock_db_registros_std_mt_3_dbr.php");
		return new mock_db_registros_std_mt_3_dbr("instancia");
	}
