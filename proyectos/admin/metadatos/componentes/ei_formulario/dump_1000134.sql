...
estado_:_ 1_;_', '5', 'Clonar subclases', NULL, NULL, '0', '0', NULL, '0');
INSERT INTO apex_objeto_ei_formulario_ef (objeto_ei_formulario_proyecto, objeto_ei_formulario, objeto_ei_formulario_fila, identificador, elemento_formulario, columnas, obligatorio, inicializacion, orden, etiqueta, etiqueta_estilo, descripcion, colapsado, desactivado, estilo, total) VALUES ('admin', '1000134', '1000094', 'carpeta_subclases', 'ef_editable', 'carpeta_subclases', '0', '', '6', 'Carpeta subclases', NULL, 'Path relativo donde se copiaran las subclases (si existen)', '0', '0', NULL, '0');
INSERT INTO apex_objeto_ei_formulario_ef (objeto_ei_formulario_proyecto, objeto_ei_formulario, objeto_ei_formulario_fila, identificador, elemento_formulario, columnas, obligatorio, inicializacion, orden, etiqueta, etiqueta_estilo, descripcion, colapsado, desactivado, estilo, total) VALUES ('admin', '1000134', '1000106', 'anexo', 'ef_editable', 'anexo', '0', '', '4', 'Anexo Nombre', NULL, 'Modifica el nombre del item y sus componentes agregando una cadena al inicio de cada nombre.', '0', '0', NULL, '0');
INSERT INTO apex_objeto_ei_formulario_ef (objeto_ei_formulario_proyecto, objeto_ei_formulario, objeto_ei_formulario_fila, identificador, elemento_formulario, columnas, obligatorio, inicializacion, orden, etiqueta, etiqueta_estilo, descripcion, colapsado, desactivado, estilo, total) VALUES ('admin', '1000134', '1000136', 'fuente', 'ef_combo', 'fuente', '1', 'dao_:_ get_fuentes_datos_;_
clase_:_ dao_editores_;_
include_:_ modelo/consultas/dao_editores.php_;_
clave_:_ fuente_datos_;_
valor_:_ descripcion_corta_;_
dependencias_:_ proyecto_;_', '3', 'Fuente Destino', NULL, NULL, '0', '0', NULL, '0');
