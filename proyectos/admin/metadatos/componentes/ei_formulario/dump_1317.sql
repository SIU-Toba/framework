...
INSERT INTO apex_objeto_ei_formulario_ef (objeto_ei_formulario_proyecto, objeto_ei_formulario, objeto_ei_formulario_fila, identificador, elemento_formulario, columnas, obligatorio, inicializacion, orden, etiqueta, etiqueta_estilo, descripcion, colapsado, desactivado, estilo, total) VALUES ('admin', '1317', '1165', 'categoria', 'ef_combo_dao', 'categoria', NULL, 'include: acciones/pruebas/testing_automatico/lista_casos.php;
clase: lista_casos;
dao: get_categorias;
clave: id;
