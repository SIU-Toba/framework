...
', '15', 'Mostrar en el menú', NULL, NULL, NULL, NULL, NULL, NULL);
...
', '10', 'Comportamiento', NULL, 'También llamado Patrones, estos comportamientos son los predefinidos en el sistema, tomando desiciones de qué hacer con los objetos involucrados.', NULL, NULL, NULL, '0');
...
', '8', 'Tipo Comportamiento', NULL, 'El comportamiento determina la ejecución principal de la operación. Generalmente instancia los objetos involucrados y les asigna un rol específico.', NULL, NULL, NULL, '0');
