...
INSERT INTO apex_objeto_ei_formulario_ef (objeto_ei_formulario_proyecto, objeto_ei_formulario, objeto_ei_formulario_fila, identificador, elemento_formulario, columnas, obligatorio, inicializacion, orden, etiqueta, etiqueta_estilo, descripcion, colapsado, desactivado, estilo, total) VALUES ('admin', '1815', '4572', 'usuario_grupo_acc', 'ef_combo_dao', 'usuario_grupo_acc', '1', 'dao: get_grupos_acceso;
clase: dao_permisos;
include: db/dao_permisos.php;
clave: usuario_grupo_acc;
valor: nombre;
no_seteado: --Seleccione--;', '1', 'Grupo Acceso', NULL, NULL, NULL, NULL, NULL, '0');
INSERT INTO apex_objeto_ei_formulario_ef (objeto_ei_formulario_proyecto, objeto_ei_formulario, objeto_ei_formulario_fila, identificador, elemento_formulario, columnas, obligatorio, inicializacion, orden, etiqueta, etiqueta_estilo, descripcion, colapsado, desactivado, estilo, total) VALUES ('admin', '1815', '4573', 'usuario_perfil_datos', 'ef_combo_dao', 'usuario_perfil_datos', '1', 'dao: get_perfiles_datos;
clase: dao_permisos;
include: db/dao_permisos.php;
clave: usuario_perfil_datos;
valor: nombre;', '2', 'Perfil de Datos', NULL, NULL, NULL, NULL, NULL, '0');
