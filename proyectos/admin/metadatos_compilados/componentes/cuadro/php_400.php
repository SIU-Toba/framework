...
class php_400
{
  ...
  array (
    'titulo' => 'Fuente Datos Motor',
    'subtitulo' => NULL,
    'sql' => 'select fuente_datos_motor,nombre,version from apex_fuente_datos_motor',
    'columnas_clave' => 'fuente_datos_motor',
