...
class php_425
{
  ...
  array (
    ...
    'nombre' => 'OBJETO - Objetos Asocicados INFO',
    'titulo' => 'Información sobre DEPENDENCIAS',
    'colapsable' => NULL,
    'descripcion' => NULL,
  ...
  array (
    'titulo' => 'Información sobre DEPENDENCIAS',
    'subtitulo' => 'Estos son los IDENTIFICADORES que deben utilizarse para asociar DEPENDENCIAS',
    'sql' => 'SELECT * FROM apex_clase_dependencias 
%f% %w% 
ORDER BY identificador;',
    'columnas_clave' => 'no utilizado',
