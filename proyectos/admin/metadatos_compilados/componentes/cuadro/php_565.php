...
class php_565
{
  ...
  array (
    'titulo' => NULL,
    'subtitulo' => NULL,
    'sql' => 'SELECT tarea_tema, descripcion FROM apex_ap_tarea_tema',
    'columnas_clave' => 'tarea_tema',
