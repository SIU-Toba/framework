...
class php__admin_objetos_prototipo_php
{
  ...
  array (
    'item_proyecto' => 'toba',
    'item' => '/admin/objetos/prototipo/php',
    'item_nombre' => 'OBJETO - Prototipado de Subclases (Generacion de PHP)',
    ...
    'item_act_accion_script' => 'acciones/admin/objetos/proto_php.php',
