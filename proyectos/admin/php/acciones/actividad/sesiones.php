...
if($this->hilo->obtener_proyecto() != 'admin'){
...
<?
	...
	if(!$rs) 
   	...
   	while(!$rs->EOF)
    {
     	echo "<a href='" . $this->vinculador->generar_solicitud('admin',null,array("opcion" => $rs->fields["solicitud_tipo"])) . "' class='basico'>";
...
<?
     	echo "<a href='" . $this->vinculador->generar_solicitud('admin',null,array("opcion" =>"log_sistema")) . "' class='basico'>";
        echo recurso::imagen_apl('solicitudes.gif',true,null,null,"Log sistema");
        echo "</a>&nbsp;";
     	echo "<a href='" . $this->vinculador->generar_solicitud('admin',null,array("opcion" =>"log_error_login")) . "' class='basico'>";
        echo recurso::imagen_apl('solicitudes.gif',true,null,null,"Log error login");
        echo "</a>&nbsp;";
     	echo "<a href='" . $this->vinculador->generar_solicitud('admin',null,array("opcion" =>"log_ip_rechazada")) . "' class='basico'>";
