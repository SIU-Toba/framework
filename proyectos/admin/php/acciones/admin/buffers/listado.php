...
<tr> 
	...
	<a href="<? echo $this->vinculador->generar_solicitud('admin',"/admin/buffers/propiedades") ?>" target="<? echo  apex_frame_centro ?>" class="list-obj">
...
?>
         ...
         <tr> 
          <td width="2%" class='lista-obj-botones'>
		 	<a href="<? echo $this->vinculador->generar_solicitud('admin',"/admin/buffers/propiedades", array(apex_hilo_qs_zona=> $rs->fields["proyecto"] .apex_qs_separador. $rs->fields["buffer"]) ) ?>" target="<? echo  apex_frame_centro ?>">
				<img src="<? echo recurso::imagen_apl("buffers.gif") ?>" alt="Editar el BUFFER" border="0">
			</a>
	  	  </td>
          <td width="2%" class='lista-obj-botones'>
		 	<a href="<? echo $this->vinculador->generar_solicitud('admin',"/admin/buffers/coloreado", array(apex_hilo_qs_zona=> $rs->fields["proyecto"] .apex_qs_separador. $rs->fields["buffer"]) ) ?>" target="<? echo  apex_frame_centro ?>">
				<img src="<? echo recurso::imagen_apl("php.gif") ?>" alt="Visualizar PHP" border="0">
			</a>
	  	  </td>
          <td width="2%" class='lista-obj-botones'>
		 	<a href="<? echo $this->vinculador->generar_solicitud('admin',"/admin/buffers/ejecutar", array(apex_hilo_qs_zona=> $rs->fields["proyecto"] .apex_qs_separador. $rs->fields["buffer"]) ) ?>" target="<? echo  apex_frame_centro ?>">
