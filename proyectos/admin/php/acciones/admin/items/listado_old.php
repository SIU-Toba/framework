...
?>
          <td  class='cat-arbol-carpeta' width='2%'>
			<a href="<? echo $this->vinculador->generar_solicitud('admin',"/admin/items/carpeta_propiedades",array( apex_hilo_qs_zona => $rs->fields['item_proyecto'] .apex_qs_separador. $rs->fields["item"])) ?>" target="<? echo  apex_frame_centro ?>"  class='cat-item'>
...
?>
          <td  class='cat-arbol-carpeta-info' width='2%'>
			<a href="<? echo $this->vinculador->generar_solicitud('admin',"/admin/items/carpeta_ordenar", array("padre_p"=>$rs->fields["item_proyecto"], "padre_i"=>$rs->fields["item"]) ) ?>" target="<? echo  apex_frame_centro ?>"  class='cat-item'>
          ...
          <td  class='cat-arbol-carpeta-info' width='2%'>
			<a href="<? echo $this->vinculador->generar_solicitud('admin',"/admin/items/carpeta_propiedades", array("padre_p"=>$rs->fields["item_proyecto"], "padre_i"=>$rs->fields["item"]) ) ?>" target="<? echo  apex_frame_centro ?>"  class='cat-item'>
			<? echo recurso::imagen_apl("items/carpeta_nuevo.gif",true,null,null,"Crear SUBCARPETA en esta rama del CATALOGO") ?></a>
		  </td>
          <td  class='cat-arbol-carpeta-info' width='2%'>
			<a href="<? echo $this->vinculador->generar_solicitud('admin',"/admin/items/propiedades", array("padre_p"=>$rs->fields["item_proyecto"], "padre_i"=>$rs->fields["item"]) ) ?>" target="<? echo  apex_frame_centro ?>"  class='cat-item'>
