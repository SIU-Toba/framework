...
?>
        <tr> 
          <td  class='lista-obj-dato2'  width="1">
		 	<a href="<? echo $this->vinculador->generar_solicitud('admin',"/admin/proyectos/propiedades",array(apex_hilo_qs_zona => $rs->fields['proyecto'])) ?>"  class="cat-item" target="<? echo  apex_frame_centro ?>">
