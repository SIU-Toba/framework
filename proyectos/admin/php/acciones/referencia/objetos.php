<?
	...
	$vinculo_cuadro = $this->vinculador->obtener_vinculo_a_item('admin',
																"/admin/apex/clase_autodoc",
																$clase_cuadro );
	...
	$vinculo_form = $this->vinculador->obtener_vinculo_a_item('admin',
																"/admin/apex/nucleo_autodoc",
																$clase_form );	
																																																																	
	$clase_hoja =  array(apex_hilo_qs_zona=> 'toba'.apex_qs_separador.'objeto_hoja');
	$vinculo_hoja = $this->vinculador->obtener_vinculo_a_item('admin',
																"/admin/apex/clase_autodoc",
																$clase_hoja );
?>
<map name="objetos"> 
