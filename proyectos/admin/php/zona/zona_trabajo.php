...
class zona_trabajo extends zona
{
	...
	//Carga el EDITABLE que se va a manejar dentro de la ZONA
	{
		...
		if(!$rs){
			throw new excepcion_toba("ZONA-USUARIO: NO se pudo cargar el editable ".$this->editable_id[0].",".$this->editable_id[1]." - [SQL]  $sql - [ERROR] " . $db["instancia"][apex_db_con]->ErrorMsg() );
			return false;
		}elseif($rs->EOF){
