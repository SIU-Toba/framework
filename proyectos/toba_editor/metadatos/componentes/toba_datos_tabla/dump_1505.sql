...
INSERT INTO apex_objeto (proyecto, objeto, anterior, identificador, reflexivo, clase_proyecto, clase, subclase, subclase_archivo, objeto_categoria_proyecto, objeto_categoria, nombre, titulo, colapsable, descripcion, fuente_datos_proyecto, fuente_datos, solicitud_registrar, solicitud_obj_obs_tipo, solicitud_obj_observacion, parametro_a, parametro_b, parametro_c, parametro_d, parametro_e, parametro_f, usuario, creacion, posicion_botonera) VALUES (
	...
	'odt_eventos', --subclase
	'db/odt_eventos.php', --subclase_archivo
	NULL, --objeto_categoria_proyecto
	NULL, --objeto_categoria
	'OBJETO - EI eventos', --nombre
	NULL, --titulo
	NULL, --colapsable
	NULL, --descripcion
...
INSERT INTO apex_objeto_db_registros_col (objeto_proyecto, objeto, col_id, columna, tipo, pk, secuencia, largo, no_nulo, no_nulo_db, externa) VALUES (
	...
	'E', --tipo
	'1', --pk
	'apex_objeto_eventos_seq', --secuencia
	NULL, --largo
	NULL, --no_nulo
	'0', --no_nulo_db
	'0'  --externa
...
INSERT INTO apex_objeto_db_registros_col (objeto_proyecto, objeto, col_id, columna, tipo, pk, secuencia, largo, no_nulo, no_nulo_db, externa) VALUES (
	...
	'1505', --objeto
	'423', --col_id
	'display_datos_cargados', --columna
	'E', --tipo
	'0', --pk
	NULL, --secuencia
	NULL, --largo
...
INSERT INTO apex_objeto_db_registros_col (objeto_proyecto, objeto, col_id, columna, tipo, pk, secuencia, largo, no_nulo, no_nulo_db, externa) VALUES (
	...
	'1505', --objeto
	'5000001', --col_id
	'accion_vinculo_carpeta', --columna
	'C', --tipo
	'0', --pk
	NULL, --secuencia
	'60', --largo
...
INSERT INTO apex_objeto_db_registros_col (objeto_proyecto, objeto, col_id, columna, tipo, pk, secuencia, largo, no_nulo, no_nulo_db, externa) VALUES (
	...
	'1505', --objeto
	'5000005', --col_id
	'accion_vinculo_popup_param', --columna
	'C', --tipo
	'0', --pk
	NULL, --secuencia
	'100', --largo
...
INSERT INTO apex_objeto_db_registros_col (objeto_proyecto, objeto, col_id, columna, tipo, pk, secuencia, largo, no_nulo, no_nulo_db, externa) VALUES (
	...
	'1505', --objeto
	'33000001', --col_id
	'accion_vinculo_servicio', --columna
	'C', --tipo
	'0', --pk
	NULL, --secuencia
	'100', --largo
