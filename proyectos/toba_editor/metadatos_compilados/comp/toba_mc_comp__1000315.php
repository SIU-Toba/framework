...
class toba_mc_comp__1000315
{
  ...
  array (
    ...
    'nombre' => 'Asistente - ABMS - pant_cuadro - form_cuadro',
    'titulo' => NULL,
    'colapsable' => 0,
    'descripcion' => NULL,
  ...
  array (
    0 => 
    array (
      'objeto_ei_formulario_fila' => 1000461,
      'objeto_ei_formulario' => 1000315,
      'objeto_ei_formulario_proyecto' => 'toba_editor',
      'identificador' => 'cuadro_eliminar_filas',
      'elemento_formulario' => 'ef_checkbox',
      'columnas' => 'cuadro_eliminar_filas',
      'obligatorio' => 0,
      'oculto_relaja_obligatorio' => 0,
      'orden' => '1',
      'etiqueta' => 'Puede eliminar filas',
      'etiqueta_estilo' => NULL,
      'descripcion' => 'Normalmente la eliminación de una entidad requiere previamente que el usuario entre a editarla. Con esta opción se le brinda una opción de eliminación directamente en el cuadro del listado.',
      'colapsado' => 0,
      'desactivado' => 0,
      'estilo' => NULL,
      'total' => NULL,
    ...
    1 => 
    array (
      'objeto_ei_formulario_fila' => 1000462,
      'objeto_ei_formulario' => 1000315,
      'objeto_ei_formulario_proyecto' => 'toba_editor',
      'identificador' => 'cuadro_eof',
      ...
      'etiqueta_estilo' => NULL,
      'descripcion' => 'Mensaje a mostrar cuando la tabla no tiene registros.',
      'colapsado' => 0,
      'desactivado' => 0,
      'estilo' => NULL,
      'total' => NULL,
