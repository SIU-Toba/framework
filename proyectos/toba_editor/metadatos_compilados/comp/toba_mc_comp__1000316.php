...
class toba_mc_comp__1000316
{
  ...
  array (
    ...
    'nombre' => 'Asistente - ABMS - pant_presentacion - form_presentacion',
    'titulo' => NULL,
    'colapsable' => 0,
    'descripcion' => NULL,
  ...
  array (
    0 => 
    array (
      'objeto_ei_formulario_fila' => 1000463,
      'objeto_ei_formulario' => 1000316,
      'objeto_ei_formulario_proyecto' => 'toba_editor',
      'identificador' => 'gen_separar_pantallas',
      'elemento_formulario' => 'ef_checkbox',
      'columnas' => 'gen_separar_pantallas',
      'obligatorio' => 0,
      'oculto_relaja_obligatorio' => 0,
      'orden' => '1',
      'etiqueta' => 'Separar selección y edición',
      'etiqueta_estilo' => NULL,
      'descripcion' => 'Destina distintas pantallas para la selección del elemento a editar (cuadro) y la edición en sí misma (formulario).',
      'colapsado' => 0,
      'desactivado' => 0,
      'estilo' => NULL,
      'total' => NULL,
