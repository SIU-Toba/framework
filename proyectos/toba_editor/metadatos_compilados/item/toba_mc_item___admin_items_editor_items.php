...
class toba_mc_item___admin_items_editor_items
{
  ...
  array (
    ...
    'item_nombre' => 'Editor de Items',
    'item_descripcion' => 'Un [wiki:Referencia/Item ítem] es la definición de una operación.',
