...
class toba_mc_comp__1826
{
  ...
  array (
    ...
    array (
      ...
      'etiqueta_estilo' => NULL,
      'descripcion' => 'Grupos de acceso con los cuales se ejecutará el proyecto en la previsualización. Esto determinará los derechos y el contenido del menú de la aplicación (items accesibles).',
      'colapsado' => 0,
      'desactivado' => 0,
      'estilo' => NULL,
      'total' => 0,
