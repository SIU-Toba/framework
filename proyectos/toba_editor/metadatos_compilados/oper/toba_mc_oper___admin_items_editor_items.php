...
class toba_mc_comp__1519
{
  ...
  array (
    ...
    array (
      ...
      'etiqueta_estilo' => NULL,
      'descripcion' => 'El [wiki:Referencia/Solicitud Tipo de Solicitud] marca desde que ambiente se puede solicitar el item y que clases/funciones habrá disponible para esa ejecución. Usualmente son solicitudes Web.',
      'colapsado' => NULL,
      'desactivado' => NULL,
      'estilo' => NULL,
      'total' => 0,
...
ORDER BY 1',
    ...
    array (
      ...
      'etiqueta_estilo' => NULL,
      'descripcion' => 'Listar el ITEM en la barra de navegación de la zona',
      'colapsado' => 0,
      'desactivado' => 0,
      'estilo' => NULL,
      'total' => 0,
    ...
    array (
      'objeto_ei_formulario_proyecto' => 'toba_editor',
      'objeto_ei_formulario' => 1519,
      'objeto_ei_formulario_fila' => 4620,
      'identificador' => 'redirecciona',
      'elemento_formulario' => 'ef_checkbox',
      'columnas' => 'redirecciona',
      'obligatorio' => 0,
      'oculto_relaja_obligatorio' => NULL,
      'orden' => '24',
      'etiqueta' => 'Redirecciona',
      'etiqueta_estilo' => NULL,
      'descripcion' => 'Indica que el ITEM puede bifurcarse (un evento del mismo puede pasar el control a otro item)',
      'colapsado' => 1,
      'desactivado' => 0,
      'estilo' => NULL,
      'total' => 0,
