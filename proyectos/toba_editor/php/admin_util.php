...
class admin_util
{
    public static function get_js_editor()
    {
        return "
    ...
    */
    public static function refrescar_editor_item($ir_a_item = null)
    {
        echo toba_js::abrir();
    ...
    *	Refresca el frame izquierdo del editor
    */
    public static function refrescar_barra_lateral()
    {
        echo toba_js::abrir();
    ...
    public static function redirecionar_a_editor_item($proyecto, $item)
    {
    ...
    public static function redireccionar_a_editor_objeto($proyecto, $objeto)
    {
    ...
    public static function get_icono_abrir_php($archivo)
    {
    ...
    public static function existe_archivo_subclase($path_relativo, $pm_id = null)
    {
    ...
    public static function get_path_archivo($path_relativo, $pm_id = null)
    {
        if (! is_null($pm_id)) {
     ...
     */
    public static function url_imagen_de_origen($img, $origen)
    {
        switch ($origen) {
            case 'apex':
     ...
     */
    public static function dir_imagen_de_origen($img, $origen)
    {
        switch ($origen) {
            case 'apex':
    ...
    public static function get_acceso_abrir_php($componente, $item_visualizador = 30000014, $parametros = array())
    {
    ...
    public static function get_acceso_ver_php($componente, $item_visualizador = 30000014, $frame = apex_frame_centro, $parametros = array())
    {
        $id = array('proyecto' => $componente[0],'componente' => $componente[1]) ;
    ...
    public static function get_utileria_editor_abrir_php($item_visualizador, $id_componente, $icono = 'reflexion/abrir.gif', $parametros = array())
    {
    ...
    public static function get_utileria_editor_ver_php($item_visualizador, $id_componente, $icono = 'nucleo/php.gif', $parametros = array())
    {
        $param_local = array(apex_hilo_qs_zona => $id_componente['proyecto'] . apex_qs_separador . $id_componente['componente']);
        $parametros = array_merge($param_local, $parametros);
    ...
    public static function get_ef_popup_utileria_php()
    {
        $iconos = array();
    ...
    public static function get_ef_popup_utileria_extension_php($parametros = array())
    {
    ...
    public static function get_ef_popup_utileria_abrir_php()
    {
