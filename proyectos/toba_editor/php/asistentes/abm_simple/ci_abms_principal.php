...
class ci_abms_principal extends ci_asistente_base
{
    ...
    public function get_nombre_tabla_actual()
    {
        return $this->dep('datos')->tabla('base')->get_columna('tabla');
    }

    public function get_fuente_actual()
    {
    ...
    public function conf__pant_basica()
    {
        if ($this->get_nombre_tabla_actual() == '') {
    ...
    public function evt__form_basico__modificacion($datos)
    {
    ...
    public function conf__form_basico(toba_ei_formulario $form)
    {
    ...
    public function conf__form_filas(toba_ei_formulario_ml $ml)
    {
    ...
    public function evt__form_filas__modificacion($datos)
    {
    ...
    public function evt__form_filas__refrescar($datos)
    {
    ...
    public function evt__form_cuadro__modificacion($datos)
    {
        $this->dep('datos')->tabla('base')->set($datos);
    }

    public function conf__form_cuadro(toba_ei_formulario $form)
    {
        $datos = $this->dep('datos')->tabla('base')->get();
        $form->set_datos($datos);
    }

    public function evt__form_cuadro_carga__modificacion($datos)
    {
    ...
    public function conf__form_cuadro_carga(toba_ei_formulario $form)
    {
     ...
     */
    public function evt__form_cuadro_carga__regenerar($datos)
    {
    ...
    public function conf__pant_form()
    {
    ...
    public function evt__cuadro_form_filas__seleccion($seleccion)
    {
        $this->dep('datos')->tabla('filas')->set_cursor($seleccion);
    }

    public function conf__cuadro_form_filas(toba_ei_cuadro $cuadro)
    {
    ...
    public function evt__form_form_fila__modificacion($datos, $resetear = true)
    {
    ...
    public function evt__form_form_fila__regenerar($datos)
    {
    ...
    public function conf__form_form_fila(toba_ei_formulario $form)
    {
    ...
    public function evt__pant_filtro__entrada()
    {
    ...
    public function evt__form_filtro__modificacion($datos)
    {
        $this->dep('datos')->tabla('base')->set($datos);
    }

    public function conf__form_filtro(toba_ei_formulario $form)
    {
        $datos = $this->dep('datos')->tabla('base')->get();
        $form->set_datos($datos);
    }

    public function evt__ml_filtro_filas__modificacion($datos)
    {
        $this->dep('datos')->tabla('filas')->procesar_filas($datos);
    }

    public function conf__ml_filtro_filas(toba_ei_formulario_ml $ml)
    {
        $datos = $this->dep('datos')->tabla('filas')->get_filas(array('en_filtro' => 1));
        $ml->set_datos($datos);
    }
    ...
    public function conf__form_presentacion(toba_ei_formulario $form)
    {
        $datos = $this->dep('datos')->tabla('base')->get();
        $form->set_datos($datos);
    }

    public function evt__form_presentacion__modificacion($datos)
    {
        $this->dep('datos')->tabla('base')->set($datos);
    }

    public function validar_datos_ingresados()
    {
