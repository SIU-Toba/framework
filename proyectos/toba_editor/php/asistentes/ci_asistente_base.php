...
class ci_asistente_base extends toba_ci
{
    ...
    public function get_clave_molde()
    {
        return $this->dep('datos')->tabla('molde')->get_clave_valor(0);
    }

    public function set_molde($proyecto, $id)
    {
    ...
    */
    ...
    public function evt__form_molde__modificacion($datos)
    {
        $this->dep('datos')->tabla('molde')->set($datos);
    }

    public function conf__form_molde()
    {
