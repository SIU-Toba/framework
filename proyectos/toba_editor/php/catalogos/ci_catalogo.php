...
abstract class ci_catalogo extends toba_ci
{
    ...
    */
    ...
    public function evt__fotos__baja($nombre)
    {
        $this->album_fotos->borrar_foto($nombre['foto_nombre']);
    }

    public function evt__fotos__defecto($nombre)
    {
    ...
    public function evt__fotos__foto($nombre)
    {
        if (trim($nombre) !== '') {
    ...
    public function evt__sacar_foto($nombre)
    {
