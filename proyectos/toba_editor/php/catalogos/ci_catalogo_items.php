...
class ci_catalogo_items extends ci_catalogo
{
    ...
    public const foto_inaccesibles = 'Items con problemas de acceso';
    public const foto_sin_objetos = 'Items sin objetos asociados';
    ...
    public function evt__fotos__seleccion($nombre)
    {
    ...
    public function get_nodo_raiz($inicial = null, $con_excepciones = true)
    {
        $excepciones = array();
    ...
    public function conf__items($arbol)
    {
    ...
    public function evt__items__cargar_nodo($id)
    {
        return $this->get_nodo_raiz($id, false);
    }

    public function evt__items__ver_propiedades($id)
    {
        $this->s__apertura[$id] = 1;
        $this->s__opciones['inicial'] = $id;
    }

    public function evt__items__cambio_apertura($datos)
    {
