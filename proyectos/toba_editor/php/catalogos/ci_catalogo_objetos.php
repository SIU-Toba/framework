...
class ci_catalogo_objetos extends ci_catalogo
{
    ...
    protected $catalogo;
    protected $opciones;
    public const foto_huerfanos = 'Objetos Huérfanos';
    public const foto_ext_rotas = 'Extensiones PHP rotas';
    ...
    public function agregar_foto_inicial()
    {
    ...
    public function evt__listado__cargar_nodo($id)
    {
        $this->dependencia('listado')->set_frame_destino(apex_frame_centro);
        if (isset($this->s__opciones)) {
    ...
    public function get_info_tipos_componente()
    {
