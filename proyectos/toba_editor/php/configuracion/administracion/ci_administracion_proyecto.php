...
class ci_administracion_proyecto extends toba_ci
{
    ...
    public function evt__actualizar()
    {
    ...
    public function evt__regenerar()
    {
    ...
    public function get_comando_en_ejecucion()
    {
    ...
    public function get_log_comando_ejecucion()
    {
    ...
    public function generar_linea_comando_proyecto($comando)
    {
