...
class ci_fuentes extends toba_ci
{
    ...
    public function get_lista_schemas()
    {
    ...
    public function es_motor_postgres()
    {
    ...
    public function conf__form_auditoria(toba_ei_formulario $form)
    {
        $datos = $this->dependencia('datos')->tabla('fuente')->get();
        $form->set_datos($datos);
    }

    public function evt__form_auditoria__modificacion($datos)
    {
    ...
    public function evt__form_auditoria__crear_auditoria()
    {
    ...
    public function conf__form_schemas(eiform_fuente_datos_esquemas $form)
    {
        $manejados = array();
    ...
    public function evt__form_schemas__modificacion($datos)
    {
    ...
    //				METODOS AUXILIARES
    //----------------------------------------------------------------------------------------------------------
    public function persistir_archivo_conf($id_base, $datos)
    {
    ...
    public function cargar_archivo_ini($id_base)
    {
        $instalacion = toba_modelo_catalogo::instanciacion()->get_instalacion(null);
        if ($instalacion->existe_base_datos_definida($id_base)) {
