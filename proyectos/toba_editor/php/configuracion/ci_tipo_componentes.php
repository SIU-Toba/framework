...
class ci_editor extends toba_ci
{
    ...
    public function evt__cuadro__seleccionar($seleccion)
    {
    ...
    public function evt__form_clase__modificacion($datos)
    {
    ...
    public function conf__form_clase($componente)
    {
    ...
    public function evt__form_relaciones__modificacion($datos)
    {
        $this->dep('datos')->tabla('relaciones')->procesar_filas($datos);
    }

    public function conf__form_relaciones($componente)
    {
