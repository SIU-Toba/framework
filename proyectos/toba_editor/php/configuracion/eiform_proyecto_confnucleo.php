...
class eiform_proyecto_confnucleo extends toba_ei_formulario
{
	function extender_objeto_js()
	{
		echo "						
			...
			";
		echo "
			{$this->objeto_js}.evt__pm_sesion__procesar = function(inicial) {
				if (!inicial) {
			...
			{$this->objeto_js}.modificar_vinculo__ef_sesion_subclase_archivo = function(id_vinculo)
            {
			...
			";
		echo "
			{$this->objeto_js}.evt__pm_usuario__procesar = function(inicial) {
				if (!inicial) {
			...
			{$this->objeto_js}.modificar_vinculo__ef_usuario_subclase_archivo = function(id_vinculo)
            {
			...
			";
		echo "
			{$this->objeto_js}.evt__pm_impresion__procesar = function(inicial) {
				if (!inicial) {
			...
			{$this->objeto_js}.modificar_vinculo__ef_salida_impr_html_a = function(id_vinculo)
            {
			...
			";
		echo "
			{$this->objeto_js}.evt__pm_contexto__procesar = function(inicial) {
				if (!inicial) {
			...
			{$this->objeto_js}.modificar_vinculo__ef_ce_subclase_archivo = function(id_vinculo)
            {
