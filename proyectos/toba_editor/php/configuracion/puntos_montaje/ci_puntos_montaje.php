...
class ci_puntos_montaje extends toba_ci
{
    ...
    public function cambiar_tab__anterior()
    {
    ...
    public function conf__cuadro_puntos_montaje(toba_ei_cuadro $cuadro)
    {
        $cuadro->set_datos($this->get_listado());
    }

    public function evt__cuadro_puntos_montaje__seleccion($datos)
    {
    ...
    public function evt__cuadro_puntos_montaje__eliminar($datos)
    {
        $this->eliminar($datos);
        unset($this->s__tipo);
    }
    ...
    public function evt__form_eleccion_tipo__modificacion($datos)
    {
    ...
    public function conf__form_proyecto()
    {
    ...
    public function evt__form_proyecto__modificacion($datos)
    {
    ...
    public function conf__form_otro()
    {
        $this->s__tipo_punto = $this->s__tipo;
        unset($this->s__tipo);
    }

    public function evt__form_otro__modificacion($datos)
    {
        $datos['tipo'] = $this->s__tipo_punto; // Seteamos el tipo acá así no se pasa por parámetro
        if ($this->estoy_editando()) {
    ...
    public function proyectos_accesibles()
    {
    ...
    public function grabar_otro($datos)
    {
    ...
    public function grabar_proyecto($datos)
    {
        $datos['proyecto'] = toba_editor::get_proyecto_cargado();
