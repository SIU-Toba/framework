...
class skins_ci extends toba_ci
{
    ...
    public function conf__form_importar(toba_ei_formulario $form)
    {
        $form->colapsar();
    }

    public function evt__form_importar__importar($datos)
    {
    ...
    public function evt__form_paleta__generar($datos)
    {
    ...
    public function conf__form_paleta(toba_ei_formulario_ml $form)
    {
    ...
    public function evt__form_paleta__modificacion($datos)
    {
        if ($this->importado) {
            return;
        }
