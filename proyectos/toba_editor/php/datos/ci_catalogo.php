...
class ci_catalogo extends toba_ci
{
    ...
    public function conf__fuentes(toba_ei_cuadro $cuadro)
    {
        ...
        foreach (array_keys($datos) as $id) {
            ...
            if (toba_info_editores::get_cantidad_dimensiones_fuente($datos[$id]['fuente_datos']) > 0) {
                ...
                $datos[$id]['editar'] .= $this->tag_vinculo_editor(
                    toba_editor::get_id(),
                    3461,
                    $parametros,
                    $img
    ...
    public function conf__consultas(toba_ei_cuadro $cuadro)
    {
    ...
    public function conf__tablas(toba_ei_cuadro $cuadro)
    {
    ...
    public function conf__dimensiones($cuadro)
    {
    ...
    public function conf__arbol_relaciones($componente)
    {
    ...
    public function evt__arbol_relaciones__cargar_nodo($id)
    {
    ...
    public function conf__servicios_web(toba_ei_cuadro $cuadro)
    {
        $cuadro->colapsar();
    ...
    public function tag_vinculo_editor($item_editor_proyecto, $item_editor, $parametros, $contenido, $ayuda = null)
    {
        $url = toba::vinculador()->get_url(
            $item_editor_proyecto,
            $item_editor,
            $parametros,
    ...
    public function get_string_iconos($iconos)
    {
        $salida = '';
