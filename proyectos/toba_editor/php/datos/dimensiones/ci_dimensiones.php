...
class ci_dimensiones extends toba_ci
{
    ...
    public function get_tablas_gatillo($tipo = 'directo')
    {
    ...
    public function evt__form_gatillos_dir__modificacion($datos)
    {
    ...
    public function conf__form_gatillos_dir($form)
    {
    ...
    public function conf__pant_gatillos_i($pantalla)
    {
    ...
    public function evt__form_gatillos_indir__modificacion($datos)
    {
        foreach (array_keys($datos) as $id) {
    ...
    public function conf__form_gatillos_indir($form)
    {
    ...
    *	Lista de tablas
    */
    public function get_tablas($fuente)
    {
    ...
    */
    public function get_tablas_gatillos()
    {
    ...
    */
    public function get_gatillos_directos()
    {
    ...
    public function conf__elementos()
    {
