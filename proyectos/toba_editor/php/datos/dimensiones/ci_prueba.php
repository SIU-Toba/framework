...
class ci_prueba extends toba_ci
{
    ...
    public function conf__test($pantalla)
    {
    ...
    public function evt__form_elegir_sql__modificacion($datos)
    {
    ...
    public function conf__form_elegir_sql(toba_ei_formulario_ml $form_ml)
    {
        $form_ml->set_datos($this->get_sqls_form());
    }

    //-- Elijo los parametros de la prueba ---------------------------------------------------
    public function evt__form_test__modificacion($datos)
    {
        $this->s__detalle_test = $datos;
    }

    public function conf__form_test(toba_ei_formulario $form)
    {
    ...
    public function evt__form_sql__modificacion($datos)
    {
    ...
    public function conf__form_sql(toba_ei_formulario $form)
    {
        $datos = $this->dep('datos')->get();
    ...
    public function grabar_info_test()
    {
    ...
    public function get_cabecera_prueba()
    {
        return $this->cabecera_prueba;
    }

    public function get_pruebas_realizadas()
    {
        return $this->pruebas;
    }

    //--------------------- Ejecucion de los test -----------------------------------
    public function ejecutar_test()
    {
        ...
        if (toba::perfil_de_datos()->posee_restricciones($this->fuente)) {
            $this->pruebas = toba::perfil_de_datos()->probar_sqls(
                $this->fuente,
