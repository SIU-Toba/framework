...
class ci_relaciones extends toba_ci
{
    ...
    public function evt__form_columnas__modificacion($datos)
    {
        $t1 = array();
        $t2 = array();
    ...
    public function conf__form_columnas(toba_ei_formulario_ml $form)
    {
        $datos = array();
    ...
    public function get_columnas_tabla_1()
    {
    ...
    public function get_columnas_tabla_2()
    {
        $datos = $this->dep('datos')->get();
    ...
    public function conf__esquema($esquema)
    {
        $dot = "digraph G {
