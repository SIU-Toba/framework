...
class ci_principal extends toba_ci
{
    ...
    */
    public function inicializar_item($dr)
    {
    ...
    public function conf__prop_basicas(toba_ei_formulario $form)
    {
    ...
    public function evt__prop_basicas__modificacion($registro)
    {
    ...
    //-- OBJETOS -----------------------------------------------
    //----------------------------------------------------------
    public function conf__objetos()
    {
        $objetos = $this->get_entidad()->tabla('objetos')->get_filas(null, true);
        return $objetos;
    }

    public function evt__objetos__modificacion($objetos)
    {
    ...
    public function conf__pant_permisos_tablas(toba_ei_pantalla $pant)
    {
    ...
    */
    public function conf__permisos()
    {
    ...
    public function evt__permisos__modificacion($grupos)
    {
    ...
    public function conf__form_tablas(toba_ei_formulario_ml $form)
    {
    ...
    public function evt__form_tablas__modificacion($datos)
    {
        $conj_actual = array();
    ...
    public function get_tablas_fuente($fuente, $schema = null)
    {
        try {
    ...
    public function get_schemas_fuente($fuente)
    {
        try {
    ...
    //								PANTALLA PERMISOS									   //
    //----------------------------------------------------------------------------------------------------------------------------------------------------//
    public function conf__form_acl(toba_ei_formulario_ml $form)
    {
    ...
    public function evt__form_acl__modificacion($datos)
    {
        foreach ($datos as $klave => $fila) {
            $permisos = array();
    ...
    public function set_permisos_basicos($id_fila)
    {
