...
class ef_popup_utileria_php implements toba_ef_icono_utileria
{
    ...
    public function __construct($es_abrir, $registrar_inmediatamente = true)
    {
    ...
    public function agregar_parametros($parametros)
    {
    ...
    public function cambiar_item($item = 30000014)
    {
        $this->vinculo->set_item('toba_editor', $item);
    }

    public function invocar_sin_archivo($sin_archivo)
    {
