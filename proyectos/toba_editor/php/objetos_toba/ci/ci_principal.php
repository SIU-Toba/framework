...
class ci_editor extends ci_editores_toba
{
    ...
    */
    public function modificar_dependencia($anterior, $nuevo)
    {
    ...
    public function evt__cancelar_pantalla()
    {
        $this->get_entidad()->tabla('pantallas')->resetear_cursor();
    }

    public function evt__aceptar_pantalla()
    {
        $this->get_entidad()->tabla('pantallas')->resetear_cursor();
    }
    ...
    public function evt__pantallas_lista__modificacion($registros)
    {
        /*
    ...
    public function evt__pantallas_lista__seleccion($id)
    {
        $this->pant_sel_temp = $id;
    }

    public function conf__pantallas_lista($ml)
    {
    ...
    public function evt__pantallas__modificacion($datos)
    {
        $this->get_entidad()->tabla('pantallas')->set($datos);
    }

    public function conf__pantallas(toba_ei_formulario $obj)
    {
        ...
        if (!isset($this->s__pantalla_php_db[$id_actual])) {										//No tiene archivo de subclase
            ...
            // Link al editor
            $parametros = toba_componente_info::get_utileria_editor_parametros(
    ...
    public function conf__pantallas_ei($componente)
    {
    ...
    public function evt__pantallas_ei__modificacion($datos)
    {
    ...
    public function combo_dependencias()
    {
        $datos = null;
        $a = 0;
    ...
    public function conf__pantallas_evt(toba_ei_formulario $form)
    {
        $datos = array();
    ...
    public function evt__pantallas_evt__modificacion($datos)
    {
    ...
    public function conf__cuadro_layout(toba_ei_cuadro $cuadro)
    {
    ...
    public function evt__cuadro_layout__seleccion($id)
    {
        $this->pant_sel_temp = $id;
    }

    public function conf__form_layout(toba_ei_formulario $form)
    {
    ...
    public function evt__form_layout__modificacion($datos)
    {
    ...
    public function evt__4__salida()
    ...
    public function conf__cuadro_layout_impresion(toba_ei_cuadro $cuadro)
    {
        $cursor = $this->get_entidad()->tabla('pantallas')->get_cursor();
        $cuadro->seleccionar(array(apex_datos_clave_fila => $cursor));
        $filas = $this->get_entidad()->tabla('pantallas')->get_filas();
    ...
    public function evt__cuadro_layout_impresion__seleccion($id)
    {
        $this->pant_sel_temp = $id;
    }

    public function conf__form_layout_impresion(toba_ei_formulario $form)
    {
        $vinculo = toba::vinculador()->get_url(null, null, array(), array('servicio' => 'ejecutar'));
        $form->ef('template')->set_botonera('Layout');
        $form->ef('template')->set_alto('400px');
    ...
    public function evt__form_layout_impresion__modificacion($datos)
    {
        if (!isset($datos['tipo_layout'])) {
    ...
    */
     ...
     */
    public function set_pantallas_evento($pant_presentes, $evento)
    {
     ...
     */
    public function get_pantallas_evento($evento)
    {
    ...
    public function get_pantallas_posibles()
    {
