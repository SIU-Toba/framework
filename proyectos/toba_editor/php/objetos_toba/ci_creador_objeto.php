...
class ci_creador_objeto extends toba_ci
{
    ...
    public function post_eventos()
    {
        ...
        } elseif (! isset($this->objeto_construido)) {
    ...
    public function conf__pant_tipos()
    {
    ...
    public function evt__tipos__seleccionar($clase)
    {
    ...
    public function evt__info_asignacion__modificacion($datos)
    {
        $this->destino += $datos;
    }

    public function conf__info_asignacion()
    {
        if (isset($this->destino)) {
            return $this->destino;
        }
    ...
    */
    public function evt__info_asignacion_dr__modificacion($datos)
    {
        $this->destino += $datos;
    }

    public function conf__info_asignacion_dr()
    {
        if (isset($this->destino)) {
            return $this->destino;
        }
    ...
    public function conf__pant_construccion()
    {
        $this->pantalla()->agregar_dep('editor');
    }

    public function cargar_editor()
    {
    ...
    public function get_nombre_destino()
    {
    ...
    public function hay_destino()
    {
        return isset($this->destino['tipo']);
    }

    public function destino_es_item()
    {
    ...
    */
    public function evt__editor__procesar()
    {
    ...
    public function redireccionar_a_objeto_creado()
    {
        admin_util::redireccionar_a_editor_objeto(
            $this->objeto_construido['proyecto'],
    ...
    */
    public function get_destino_objeto()
    {
     ...
     */
    public static function servicio__ejecutar()
    {
