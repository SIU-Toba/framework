...
abstract class ci_editores_toba extends toba_ci
{
    ...
    public function componente_existe_en_db()
    {
        return $this->get_entidad()->esta_cargada();
    }

    public function set_objeto($id)
    {
        $this->id_objeto = $id;
    }
    ...
    public function conf__base($form)
    {
    ...
    public function get_clase_actual()
    {
    ...
    public function get_clase_info_actual()
    {
    ...
    */
    ...
    public function modificar_evento($id_anterior, $id_nuevo)
    {
    }
    ...
    public function notificar_eliminacion_evento($evento)
    {
    }

    public function get_pm_personalizacion()
    {
        $resultado = null;
