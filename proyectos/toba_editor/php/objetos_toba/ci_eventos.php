...
class ci_eventos extends toba_ci
{
    ...
    public function set_evento_editado($id)
    {
    ...
    public function mostrar_evento_detalle()
    {
    ...
    public function get_eventos_internos()
    {
    ...
    public function evt__generador__cargar($datos)
    {
    ...
    public function get_modelos_evento()
    {
    ...
    public function evt__eventos_lista__modificacion($registros)
    {
        /*
    ...
    public function conf__eventos_lista($ml)
    {
    ...
    public function evt__eventos_lista__seleccion($id)
    {
    ...
    //-----------------------------------------
    public function evt__eventos__modificacion($datos)
    {
    ...
    public function conf__eventos($componente)
    {
    ...
    public function evt__eventos__cancelar()
    {
        $this->limpiar_seleccion();
    }

    public function evt__eventos__aceptar($datos)
    {
    ...
    public function get_puntos_de_control($filtro)
    {
