...
class ci_clonador_objetos extends toba_ci
{
    ...
    *********************************/
    ...
    public static function get_tipos_destino()
    {
    ...
    public static function get_objetos_destino($clase = null)
    {
        if (isset($clase)) {
            switch ($clase) {
                case 'toba_item':
    ...
    *********************************/
    ...
    public function evt__destino__modificacion($datos)
    {
        $this->datos = $datos;
