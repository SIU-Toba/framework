...
class ci_principal extends ci_editores_toba
{
    ...
    public function conf__prop_basicas($form)
    {
        $datos = $this->get_entidad()->tabla('prop_basicas')->get();
        ...
        if ($this->s__ap_php_db) {
            ...
            if ($this->s__ap_php_archivo) {
                ...
                $abrir = toba_componente_info::get_utileria_editor_abrir_php(
                    array('proyecto' => $this->id_objeto['proyecto'],
    ...
    public function get_tablas($fuente, $schema = null)
    {
    ...
    public function get_tablas_extension($fuente, $schema = null)
    {
    ...
    public function get_schema($fuente = null)
    {
    ...
    public function get_schema_extension($fuente = null)
    {
        if (is_null($fuente) || ! is_array($fuente)) {
            throw new toba_error_modelo('No se proporciono un ID válido para la fuente de datos', 'Se intenta obtener los esquemas configurados para una fuente inexistente');
        }
    ...
    public function evt__prop_basicas__cargar_tablas($datos)
    {
    ...
    public function actualizar_nombre_objeto_dt($datos)
    {
    ...
    public function get_abreviacion_clase_actual()
    {
    ...
    public function conf__columnas($form)
    {
        return $this->get_entidad()->tabla('columnas')->get_filas(null, true);
    }

    public function evt__columnas__modificacion($datos)
    {
    ...
    public function evt__columnas__leer_db($datos)
    {
    ...
    public function evt__fks__modificacion($datos)
    {
        $this->get_entidad()->tabla('fks')->procesar_filas($datos);
    }

    public function verificar_existencia_columna_clave($datos)
    {
        $hay_pk = false;
    ...
    public function verificar_existencia_columna_valores_unicos()
    {
        $esta_completo = true;
    ...
    public function conf__fks(toba_ei_formulario_ml $form)
    {
    ...
    public function get_columnas_original()
    {
        return $this->get_columnas($this->s__tabla);
    }

    public function get_columnas_ext()
    {
    ...
    public function get_tabla_original()
    {
        return $this->s__tabla;
    }

    public function get_tabla_ext()
    {
    ...
    public function get_lista_columnas_ext()
    {
        return $this->get_entidad()->tabla('columnas')->get_filas(array('externa' => 1));
    }

    public function get_lista_columnas_no_ext()
    {
        return $this->get_entidad()->tabla('columnas')->get_filas(array('externa' => 0));
    }

    public function get_lista_posibles_columnas_parametro()
    {
    ...
    public function conf__externas(toba_ei_formulario_ml $ml)
    {
    ...
    public function evt__externas__seleccion($id_ext)
    {
        $this->get_entidad()->tabla('externas')->set_cursor($id_ext);
    }

    public function evt__externas__modificacion($datos)
    {
    ...
    protected function reasociar_columnas_externas($id_ext, $col_parametros, $col_resultados)
    {
        ...
        if ($col_parametros != $col_parametro_actuales || $col_resultados != $col_resultado_actuales) {
            ...
            foreach ($col_parametros as $col_par) {
                ...
                $this->get_entidad()->tabla('externas_col')->nueva_fila(
                    array('es_resultado' => 0),
                    $padre
                );
            }
            //--- Columnas Resultado
    ...
    public function conf__detalle_carga(toba_ei_formulario $form)
    {
    ...
    public function evt__detalle_carga__cancelar()
    {
        $this->get_entidad()->tabla('externas')->resetear_cursor();
    }

    public function evt__detalle_carga__modificacion($datos)
    {
        $this->get_entidad()->tabla('externas')->set($datos);
    }

    public function evt__detalle_carga__aceptar($datos)
    {
    ...
    public function get_lista_columnas()
    {
        return $this->get_entidad()->tabla('columnas')->get_filas();
    }

    public function evt__valores_unicos__modificacion($datos)
    {
        $this->get_entidad()->tabla('valores_unicos')->procesar_filas($datos);
    }

    public function conf__valores_unicos($c)
    {
    ...
    public function ajax__existe_metodo_dt($dt, toba_ajax_respuesta $respuesta)
    {
    ...
    public function ajax__crear_metodo_get_descripciones($dt, toba_ajax_respuesta $respuesta)
    {
        $sql = $this->get_sql_carga_tabla($dt);
        if (isset($sql)) {
            $datos = toba_info_editores::get_tabla_fuente_de_dt($dt);
