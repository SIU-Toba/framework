...
class ci_principal extends ci_editores_toba
{
    ...
    public function conf__dependencias()
    {
        return $this->get_entidad()->tabla('dependencias')->get_filas(null, true);
    }

    public function evt__dependencias__modificacion($datos)
    {
    ...
    public function get_tabla_relaciones()
    ...
    public function evt__relaciones__salida()
    {
    ...
    */
    public function eliminar_relaciones_con_dependencia($id_dep)
    {
    ...
    public function modificar_id_en_relaciones($anterior, $nuevo)
    {
        $relaciones = $this->get_entidad()->tabla('relaciones')->get_filas(array(), true);
        foreach ($relaciones as $id => $relacion) {
    ...
    public function conf__opciones()
    {
        return $this->get_entidad()->tabla('prop_basicas')->get();
    }

    public function evt__opciones__modificacion($datos)
    {
