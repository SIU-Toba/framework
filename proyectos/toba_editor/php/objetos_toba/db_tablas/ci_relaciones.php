...
class ci_relaciones extends toba_ci
{
    ...
    public function mostrar_detalle_relacion()
    {
    ...
    public function conf__relaciones_columnas(toba_ei_formulario_ml $form_ml)
    {
    ...
    public function evt__relaciones_columnas__modificacion($datos)
    {
    ...
    public function evt__relaciones_columnas__aceptar($datos)
    {
        $this->evt__relaciones_columnas__modificacion($datos);
        $this->evt__relaciones_columnas__cancelar();
    }

    public function evt__relaciones_columnas__cancelar()
    {
        $this->limpiar_seleccion();
    }
    //-----------------------------------------------------------------------------------
    ...
    public function conf__relaciones_esquema(toba_ei_esquema $esquema)
    {
    ...
    public function conf__relaciones_lista(eiform_abm_detalle $form_ml)
    {
        $datos = array();
        $relaciones = $this->get_entidad()->tabla('relaciones')->get_filas();
    ...
    public function evt__relaciones_lista__seleccion($id)
    {
    ...
    public function evt__relaciones_lista__modificacion($registros)
    {
    ...
    public function conversion_form_a_fila($datos)
    ...
    public function conversion_fila_a_form($fila)
    ...
    public function hay_ciclos($tablas, $relaciones)
    {
