...
class ci_efs extends toba_ci
{
    ...
    public function mostrar_efs_detalle()
    {
    ...
    */
    public function seleccionar_ef($id)
    {
    ...
    public function evt__efs_lista__modificacion($registros)
    {
        /*
    ...
    public function conf__efs_lista()
    {
    ...
    public function evt__efs_lista__seleccion($id)
    {
    ...
    public function conf_fila__efs_lista($fila)
    {
    ...
    public function evt__efs__modificacion($datos)
    {
        $this->get_tabla()->modificar_fila($this->s__seleccion_efs_anterior, $datos);
    }

    public function conf__efs($form)
    {
    ...
    public function evt__efs__cancelar()
    {
        unset($this->s__seleccion_efs);
        unset($this->s__seleccion_efs_anterior);
    }
    ...
    public function get_posibles_maestros()
    {
    ...
    public function get_definicion_parametros($carga = false)
    {
        $ef = $this->get_tipo_ef();
    ...
    public function conf__param_varios(toba_ei_formulario $form)
    {
    ...
    public function evt__param_varios__modificacion($datos)
    {
        $this->modificado = true;
        $this->set_parametros($datos);
    }

    public function ajax__get_regexp($tipo, toba_ajax_respuesta $respuesta)
    {
        $exp = null;
        switch ($tipo) {
            case 'mail':
    ...
    public function conf__param_carga(toba_ei_formulario $form)
    {
    ...
    public function evt__param_carga__modificacion($datos)
    {
        $this->modificado = true;
    ...
    public function evt__efs_importar__importar($datos)
    {
    ...
    */
    ...
    public function conf__efs_importar()
    {
    ...
    //---- EI: Cascadas		 ----
    //---------------------------------
    public function conf__esquema_cascadas()
    {
        $diagrama = "digraph G {\nsize=\"7,7\";rankdir=LR;\n";
    ...
    public function ajax__esquema_cascadas($parametros, toba_ajax_respuesta $respuesta)
    {
