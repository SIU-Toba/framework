...
class ci_principal extends ci_editores_toba
{
    ...
    public function mostrar_columna_detalle()
    {
    ...
    public function evt__columnas_lista__modificacion($registros)
    {
        /*
    ...
    public function conf__columnas_lista()
    {
    ...
    public function evt__columnas_lista__seleccion($id)
    {
    ...
    public function evt__columnas__aceptar($datos)
    {
        if (isset($datos['estilo_precarga'])) {
            if (! isset($datos['estilo'])) {
                $datos['estilo'] = toba_info_editores::get_nombre_clase_css($datos['estilo_precarga']);
    ...
    public function evt__columnas__cancelar()
    {
        unset($this->s__seleccion_columna);
    }
    ...
    public function conf__columna_corte($form)
    {
        $indice = 0;
        $ids_visitados = array();
        $filas = array();
    ...
    public function evt__columna_corte__modificacion($datos)
    {
    ...
    public function evt__columnas_importar__importar($datos)
    {
    ...
    public function conf__columnas_importar()
    {
     ...
     * @private
     */
    public function notificar_eliminacion_evento($evt)
    {
    ...
    */
    ...
    public function get_eventos_vinculo_cargados()
    {
        $condicion = null;
    ...
    public function conf__prop_cortes()
    {
        return $this->get_entidad()->tabla('prop_basicas')->get();
    }

    public function evt__prop_cortes__modificacion($datos)
    {
        $this->get_entidad()->tabla('prop_basicas')->set($datos);
    }

    public function evt__cortes__modificacion($datos)
    {
        $this->get_entidad()->tabla('cortes')->procesar_filas($datos);
    }

    public function conf__cortes()
    {
