...
class ci_subclases extends toba_ci
{
    ...
    public function get_prefijo_clase()
    {
    ...
    //--------	UBICACION
    //------------------------------------------------------------------
    public function evt__pant_ubicacion__salida()
    {
        $this->s__path_relativo = $this->dep('carpetas')->get_path_relativo();
    }

    public function conf__carpetas(toba_ei_archivos $archivos)
    {
    ...
    public function get_path_relativo()
    {
    ...
    //--------	FORM NOMBRE
    //------------------------------------------------------------------
    public function evt__pant_nombre__salida()
    {
        if ($this->s__modo_pers) {
    ...
    public function conf__form_nombre(toba_ei_formulario $form)
    {
    ...
    public function conf__archivos(toba_ei_archivos $archivos)
    {
    ...
    public function evt__form_nombre__modificacion($datos)
    {
    ...
    public function conf__pant_generacion()
    {
