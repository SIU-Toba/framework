...
class ci_subclases_generacion extends toba_ci
{
    ...
    public function conf__pant_opciones()
    {
    ...
    //---------- OPCIONES
    //-----------------------------------------------------------------
    public function conf__form_opciones(toba_ei_formulario $form)
    {
    ...
    public function evt__form_opciones__modificacion($datos)
    {
    ...
    public function conf__form_metodos(toba_ei_formulario $form)
    {
    ...
    public function evt__form_metodos__modificacion($datos)
    {
    ...
    public function conf__codigo(toba_ei_codigo $codigo)
    {
        $codigo->set_datos($this->get_codigo_vista_previa());
    }

    public function evt__codigo__modificacion($datos)
    {
    ...
    public function evt__svn_blame()
    {
        $this->comando_svn = 'blame';
    }

    public function evt__svn_revert()
    {
        $this->comando_svn = 'revert';
    }

    public function evt__svn_diff()
    {
        $this->comando_svn = 'diff';
    }

    public function evt__svn_add()
    {
        $this->comando_svn = 'add';
    }

    public function get_previsualizacion()
    {
    ...
    public function conf__pant_vista_previa()
    {
    ...
    public function get_codigo_vista_previa()
    {
    ...
    public function get_path_archivo()
    {
        return $this->s__path_archivo;
    }

    public function get_metodos_a_generar()
    {
        $metodos = array();
        if (isset($this->s__datos_metodos)) {
    ...
    public function resetear_metodos()
    {
