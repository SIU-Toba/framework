...
class ci_comparador extends toba_ci
{
    ...
    public function get_contenido($estilo)
    {
    ...
    public function obtener_estilos($plantilla)
    {
        $css = new cssparser();
    ...
    public function analizar_diferencias()
    {
    ...
    //----------------------------- archivos -----------------------------
    public function conf__archivos()
    {
    ...
    public function evt__archivos__modificacion($registro)
    {
    ...
    //------------------------------ faltantes -----------------------------------
    public function conf__faltantes()
    {
    ...
    //------------------------------ sobrantes -----------------------------------
    public function conf__sobrantes()
    {
        $this->analizar_diferencias();
