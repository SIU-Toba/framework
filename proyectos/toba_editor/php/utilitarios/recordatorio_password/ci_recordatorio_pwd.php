...
class ci_recordatorio_pwd extends toba_ci
{
    ...
    public function conf__form_usuario(toba_ei_formulario $form)
    {
    ...
    public function evt__form_usuario__enviar($datos)
    {
    ...
    public function conf__form_pregunta(toba_ei_formulario $form)
    {
    ...
    public function evt__form_pregunta__modificacion($datos)
    {
    ...
    public function evt__recordame()
    {
    ...
    public function conf__pant_pregunta(toba_ei_pantalla $pantalla)
    {
    ...
    /*
        ...
        */
    public function verificar_usuario_activo($usuario)
    {
        try {
    ...
    public function verificar_desafio_secreto($datos_usuario)
    {
        $datos = $this->recuperar_pregunta_secreta($this->s__usuario);
        if (! is_null($datos)) {
    ...
    /**
        ...
        * @return string
        */
    public function recuperar_direccion_mail_usuario($usuario)
    {
        try {
    ...
    /**
        ...
        * @return array
        */
    public function recuperar_pregunta_secreta($usuario)
    {
        try {
            $aux = null;
    ...
    /*
        ...
        */
    public function enviar_mail_aviso_cambio()
    {
    ...
    /*
        ...
        */
    public function get_random_temporal()
    {
    ...
    /*
        ...
        */
    public function generar_link_confirmacion($usuario, $random)
    {
    ...
    */
    public function disparar_confirmacion_cambio()
    {
    ...
    //                                        METODOS PARA SQLs
    //-----------------------------------------------------------------------------------------------------------------------------------------------------------------
    public function guardar_datos_solicitud_cambio($random, $mail)
    {
    ...
    public function recuperar_datos_solicitud_cambio($usuario, $random)
    {
    ...
    public function bloquear_random_utilizado($usuario, $random)
    {
