...
class casos_web extends toba_ci
{
    ...
    private static $path_autoload_sel = '/php/testing/selenium/test_selenium_autoload.php';
    ...
    public function conf__lista_archivos($cuadro)
    {
        $cuadro->colapsar();
        $lista = array();
    ...
    public function evt__lista_archivos__abrir($caso_sel)
    {
        foreach (toba_test_lista_casos::get_casos() as $caso) {
    ...
    public function evt__seleccion__modificacion($selecciones)
    {
    ...
    public function get_selecciones()
    {
        return $this->selecciones;
    }
