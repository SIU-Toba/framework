...
class toba_mc_item__3313
{
  ...
  array (
    ...
    array (
      ...
      'objeto' => 1863,
      'objeto_nombre' => 'Ocultar y deshabilitar en JS',
      'objeto_subclase' => 'ci_ocultar_deshabilitar',
      'objeto_subclase_archivo' => 'componentes/eventos/ci_ocultar_deshabilitar.php',
      'orden' => 0,
      'clase_proyecto' => 'toba',
      'clase' => 'objeto_ci',
