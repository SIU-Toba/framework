...
class toba_mc_item___objetos_ei_calendario
{
  ...
  array (
    ...
    array (
      ...
      'objeto' => 1440,
      'objeto_nombre' => 'Ejemplo de ei_calendario - ei_formulario',
      'objeto_subclase' => 'extension_ci',
      'objeto_subclase_archivo' => 'componentes/ei_calendario/extension_ci.php',
      'orden' => 0,
      'clase_proyecto' => 'toba',
      'clase' => 'toba_ci',
