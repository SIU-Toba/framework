...
class toba_mc_comp__1000214
{
  ...
  array (
    ...
    array (
      'pantalla' => 1000069,
      'identificador' => 'pant_definicion',
      'etiqueta' => '¿Qué es SIU-Toba?',
      'descripcion' => NULL,
      'tip' => NULL,
      'imagen_recurso_origen' => NULL,
      'imagen' => NULL,
      ...
      'subclase_archivo' => 'tutorial/pant_introduccion.php',
    ),
    2 => 
    array (
      'pantalla' => 1000070,
      'identificador' => 'pant_directorios',
      'etiqueta' => 'Esquema de Directorios',
      'descripcion' => NULL,
      'tip' => NULL,
      'imagen_recurso_origen' => NULL,
      'imagen' => NULL,
      ...
      'eventos' => NULL,
      'orden' => 3,
      'subclase' => 'pant_directorios',
      'subclase_archivo' => 'tutorial/pant_introduccion.php',
    ),
    3 => 
    array (
      'pantalla' => 1000072,
      'identificador' => 'pant_ejecucion',
      'etiqueta' => 'Esquema de Ejecución',
      'descripcion' => NULL,
      'tip' => NULL,
      'imagen_recurso_origen' => NULL,
      'imagen' => NULL,
      ...
      'eventos' => NULL,
      'orden' => 4,
      'subclase' => 'pant_ejecucion',
      'subclase_archivo' => 'tutorial/pant_introduccion.php',
    ),
    4 => 
    array (
      'pantalla' => 1000071,
      'identificador' => 'pant_administracion',
      'etiqueta' => 'Administración Básica',
      'descripcion' => NULL,
      'tip' => NULL,
      'imagen_recurso_origen' => NULL,
      'imagen' => NULL,
