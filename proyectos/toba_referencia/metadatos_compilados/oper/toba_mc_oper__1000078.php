...
class toba_mc_comp__1000215
{
  ...
  array (
    ...
    array (
      'pantalla' => 1000074,
      'identificador' => 'pant_acceso',
      'etiqueta' => '[video] Acceso al Editor',
      'descripcion' => NULL,
      'tip' => NULL,
      'imagen_recurso_origen' => NULL,
      'imagen' => NULL,
      ...
      'eventos' => NULL,
      'orden' => 2,
      'subclase' => 'pant_acceso',
      'subclase_archivo' => 'tutorial/pant_editor.php',
    ),
    2 => 
    array (
      'pantalla' => 1000075,
      'identificador' => 'pant_items',
      'etiqueta' => 'Navegación por operaciones',
      'descripcion' => NULL,
      'tip' => NULL,
      'imagen_recurso_origen' => NULL,
      'imagen' => NULL,
    ...
    array (
      'pantalla' => 1000076,
      'identificador' => 'pant_prev',
      'etiqueta' => 'Previsualización y edición contextual',
      'descripcion' => NULL,
      'tip' => NULL,
      'imagen_recurso_origen' => NULL,
      'imagen' => NULL,
    ...
    array (
      'pantalla' => 1000135,
      'identificador' => 'pant_instancia',
      'etiqueta' => 'Edición de la instancia',
      'descripcion' => NULL,
      'tip' => NULL,
      'imagen_recurso_origen' => NULL,
      'imagen' => NULL,
