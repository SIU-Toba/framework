...
class toba_mc_comp__1000226
{
  ...
  array (
    ...
    array (
      ...
      'subclase_archivo' => 'tutorial/pant_cuadros.php',
    ),
    2 => 
    array (
      'pantalla' => 1000117,
      'identificador' => 'conf_eventos',
      'etiqueta' => 'Configuración y Eventos',
      'descripcion' => NULL,
      'tip' => NULL,
      'imagen_recurso_origen' => NULL,
      'imagen' => NULL,
      ...
      'eventos' => NULL,
      'orden' => 3,
      'subclase' => 'pant_conf_eventos',
      'subclase_archivo' => 'tutorial/pant_cuadros.php',
    ),
    3 => 
    array (
      'pantalla' => 4000003,
      'identificador' => 'filtros',
      'etiqueta' => 'Integración con filtros',
      'descripcion' => NULL,
      'tip' => NULL,
      'imagen_recurso_origen' => NULL,
      'imagen' => NULL,
      ...
      'eventos' => NULL,
      'orden' => 4,
      'subclase' => 'pant_filtros',
      'subclase_archivo' => 'tutorial/pant_cuadros.php',
    ),
    4 => 
    array (
      'pantalla' => 4000004,
      'identificador' => 'paginado',
      'etiqueta' => 'Paginado y ordenamiento',
      'descripcion' => NULL,
      'tip' => NULL,
      'imagen_recurso_origen' => NULL,
      'imagen' => NULL,
