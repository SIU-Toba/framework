...
class toba_mc_comp__1000236
{
  ...
  array (
    ...
    array (
      ...
      'subclase_archivo' => 'tutorial/pant_abm_mt.php',
    ),
    2 => 
    array (
      'pantalla' => 1000126,
      'identificador' => 'ci_seleccion',
      'etiqueta' => 'Extensión del Ci de Navegación/Selección',
      'descripcion' => NULL,
      'tip' => NULL,
      'imagen_recurso_origen' => NULL,
      'imagen' => NULL,
      ...
      'eventos' => NULL,
      'orden' => 3,
      'subclase' => 'pant_ci_seleccion',
      'subclase_archivo' => 'tutorial/pant_abm_mt.php',
    ),
    3 => 
    array (
      'pantalla' => 1000127,
      'identificador' => 'ci_edicion',
      'etiqueta' => 'Extensión del Ci de Edición',
      'descripcion' => NULL,
      'tip' => NULL,
      'imagen_recurso_origen' => NULL,
      'imagen' => NULL,
