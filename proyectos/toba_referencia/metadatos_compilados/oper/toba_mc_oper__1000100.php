...
class toba_mc_comp__1000237
{
  ...
  array (
    ...
    array (
      ...
      'eventos' => NULL,
      'orden' => 2,
      'subclase' => 'pant_fuente',
      'subclase_archivo' => 'tutorial/pant_api.php',
    ),
    2 => 
    array (
      'pantalla' => 1000130,
      'identificador' => 'pant_vinculacion',
      'etiqueta' => 'Vinculación entre Items',
      'descripcion' => NULL,
      'tip' => NULL,
      'imagen_recurso_origen' => NULL,
      'imagen' => NULL,
      ...
      'eventos' => NULL,
      'orden' => 3,
      'subclase' => 'pant_vinculacion',
      'subclase_archivo' => 'tutorial/pant_api.php',
    ),
    3 => 
    array (
      'pantalla' => 1000131,
      'identificador' => 'pant_memoria',
      'etiqueta' => 'Memoria',
      'descripcion' => NULL,
      'tip' => NULL,
      'imagen_recurso_origen' => NULL,
      ...
      'eventos' => NULL,
      'orden' => 4,
      'subclase' => 'pant_memoria',
      'subclase_archivo' => 'tutorial/pant_api.php',
    ),
    4 => 
    array (
      'pantalla' => 1000132,
      'identificador' => 'pant_logger',
      'etiqueta' => 'Logger',
      'descripcion' => NULL,
      'tip' => NULL,
      'imagen_recurso_origen' => NULL,
      ...
      'eventos' => NULL,
      'orden' => 5,
      'subclase' => 'pant_logger',
      'subclase_archivo' => 'tutorial/pant_api.php',
    ),
    5 => 
    array (
      'pantalla' => 1000133,
      'identificador' => 'pant_mensajes',
      'etiqueta' => 'Mensajes y Notificaciones',
      'descripcion' => NULL,
      'tip' => NULL,
      'imagen_recurso_origen' => NULL,
      'imagen' => NULL,
