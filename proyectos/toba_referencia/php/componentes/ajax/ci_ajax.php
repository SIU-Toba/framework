...
class ci_ajax extends toba_ci
{
     ...
     */
    public function conf__form_datos_param(toba_ei_formulario $form)
    {
     ...
     */
    public function ajax__calcular($parametros, toba_ajax_respuesta $respuesta)
    {
     ...
     */
    public function ajax__validar_dia_habil($dia, toba_ajax_respuesta $respuesta)
    {
        $mensaje = '';
    ...
    public function ajax__validar_lista_dias($fechas, toba_ajax_respuesta $respuesta)
    {
        $salida = array();
     ...
     */
    public function validar_dia($dia, & $mensaje)
    {
        if (trim($dia) == '') {
            return true;
        }
     ...
     * Javascript necesario para el caso de preguntar/responder datos
     */
    public function js_caso_validacion()
    {
        echo "
    ...
    public function evt__confirmar()
    {
     ...
     */
    public function ajax__album_flickr($tag, toba_ajax_respuesta $respuesta)
    {
    ...
    public function ajax__api_bajo_nivel($parametros, toba_ajax_respuesta $respuesta)
    {
     ...
     * Javascript necesario para el caso de una respuesta html
     */
    public function js_caso_bajo_nivel()
    {
        $id_js = toba::escaper()->escapeJs($this->objeto_js);
        echo "		
