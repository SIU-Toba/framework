...
class ci_navegacion_principal extends toba_ci
{
    ...
    public function conf__form_pago()
    {
    ...
    public function evt__form_pago__pagar($datos)
    {
        $this->s__pago = $datos;
        //--- Cambio explicito de pantalla
    ...
    public function conf__pant_pago()
    {
    ...
    public function evt__pant_ubicacion__entrada()
    {
