...
class ci_mascaras extends toba_ci
{
    ...
    public function conf__form(toba_ei_formulario $componente)
    {
    ...
    public function conf__form_expreg(toba_ei_formulario $form)
    {
    ...
    public function evt__form_expreg__modificacion($datos)
    {
        $this->s__datos_expreg = $datos;
    }

    public function get_fecha_inicio($nro)
    {
