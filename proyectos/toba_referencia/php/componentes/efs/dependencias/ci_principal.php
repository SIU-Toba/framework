...
class ci_principal extends toba_ci
{
    ...
    public function conf__ml($componente)
    {
    ...
    public function evt__ml__pedido_registro_nuevo()
    {
        $fila = array();
    ...
    public function ajax__combo_edit_get_opciones($parametros, toba_ajax_respuesta $respuesta)
    {
