...
class extension_ci extends toba_ci
{
    ...
    public function conf__calendario($calendario)
    {
    ...
    public function evt__calendario__seleccionar_dia($seleccion)
    {
        $this->s__dia = "{$seleccion['anio']}-{$seleccion['mes']}-{$seleccion['dia']}";
        unset($this->s__semana);
    }

    public function evt__calendario__seleccionar_semana($seleccion)
    {
