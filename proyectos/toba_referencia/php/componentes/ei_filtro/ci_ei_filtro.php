...
class ci_ei_filtro extends toba_ci
{
    ...
    public function evt__filtro__where($datos)
    {
        $this->s__datos = $datos;
    ...
    public function evt__filtro__where_particular($datos)
    {
        $this->s__datos = $datos;
    ...
    public function evt__filtro__clausulas($datos)
    {
        $this->s__datos = $datos;
    ...
    public function evt__filtro__datos($datos)
    {
