...
class ci_principal extends toba_ci
{
    ...
    public function datos_combo_dao()
    {
        $res = array(
    ...
    public function datos_comunes_form()
    {
        return array(
                'combo_dao' => '1',
                'combo_editable' => '5',
...
9 - Este es un multilínea.',
    ...
    public function get_desc_nuevo_ef($param)
    {
        if (isset($param)) {
    ...
    public function evt__form__readonly_server()
    {
    ...
    public function evt__form_ml__carga_defecto()
    {
    ...
    public function conf__form_ml()
    {
        return $this->datos_form_ml;
    }

    public function evt__form_ml__modificacion($datos)
    {
    ...
    public function evt__form_ml__readonly_server()
    {
