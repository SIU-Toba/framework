...
class ci_impresion extends toba_ci
{
    ...
    public function vista_xslfo(toba_vista_xslfo $vista)
    {
        $vista->set_nombre_archivo("salida.pdf");
    }

    public function get_popup($clave)
    {
        return 'Nombre';
    }
    ...
    public function conf__ml(toba_ei_formulario_ml $form)
    {
        $datos[0]['id'] = '1';
        $datos[0]['tipo'] = '1';
        $datos[0]['desc'] = 'Hola';
    ...
    public function servicio__impreso_plano()
    {
