...
class modelo_persona
{
    ...
    public static function get_personas($where = "", $order_by = "", $limit = "")
    {
        if ($order_by == "") {
    ...
    public static function get_cant_personas($where = "")
    {
        $sql = "SELECT 
					count(*) as cantidad
				FROM 
    ...
    public static function get_deportes($id_persona)
    {
        $sql = "SELECT
					deporte,
					dia_semana,
    ...
    public static function get_juegos($id_persona, $de_mesa = -1)
    {
        $where_de_mesa = '';
        if ($de_mesa == 1) {
    ...
    public function update_imagen($datos)
    {
    ...
    public function get_datos($incluir_imagen = false)
    {
