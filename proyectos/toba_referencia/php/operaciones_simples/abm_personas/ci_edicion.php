...
class ci_edicion extends toba_ci
{
    ...
    public function conf__form_persona()
    {
    ...
    public function evt__form_persona__modificacion($registro)
    {
    ...
    public function conf__form_juegos()
    {
        return $this->get_relacion()->tabla('juegos')->get_filas(null, true);
    }

    public function evt__form_juegos__modificacion($datos)
    {
    ...
    public function conf__cuadro_deportes()
    {
    ...
    public function evt__cuadro_deportes__seleccion($seleccion)
    {
    ...
    public function conf__form_deportes()
    {
    ...
    public function evt__form_deportes__modificacion($registro)
    {
        $this->get_relacion()->tabla('deportes')->set($registro);
        $this->evt__form_deportes__cancelar();
    }

    public function evt__form_deportes__baja()
    {
        $this->get_relacion()->tabla('deportes')->set(null);
        $this->evt__form_deportes__cancelar();
    }

    public function evt__form_deportes__alta($registro)
    {
        $this->get_relacion()->tabla('deportes')->nueva_fila($registro);
    }

    public function evt__form_deportes__cancelar()
    {
