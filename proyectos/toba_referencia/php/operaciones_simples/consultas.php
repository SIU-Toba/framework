...
class consultas
{
    public static function get_deportes_por_persona($where = 'true')
    {
        $sql = "
			SELECT
    ...
    */
    public static function get_juegos()
    {
    ...
    */
    public static function get_deportes($filtro = null)
    {
        $where = '';
        if (isset($filtro)) {
    ...
    */
    public static function get_personas($filtro = null)
    {
        $where = '';
        if (isset($filtro)) {
            if (isset($filtro['nombre'])) {
    ...
    public static function get_personas_con_deporte($deporte)
    {
    ...
    public static function get_persona_datos($id_persona)
    {
        $sql = "SELECT
			id,
			nombre,
    ...
    public static function get_persona_datos_zona($persona)
    {
        return self::get_persona_datos($persona['id']);
    }


    public static function get_persona_nombre($id_persona)
    {
    ...
    */
    public static function get_dia_semana($dia)
    {
    ...
    public static function traeme_mis_dias($dias_mios)
    {
        $resultado = array();
        $dias = self::get_dias_semana();
        foreach ($dias as $dia) {
    ...
    */
    public static function get_horas_dia()
    {
        for ($a = 0;$a < 24;$a++) {
            $horas[$a]['id'] = $a + 1;
    ...
    public static function get_paises($filtro = null, $locale = null)
    {
    ...
    public static function get_pais($id = null)
    {
        if (! isset($id)) {
            return array();
        }
    ...
    public static function get_prefijo_telefonico($pais)
    {
        $pais = quote($pais);
