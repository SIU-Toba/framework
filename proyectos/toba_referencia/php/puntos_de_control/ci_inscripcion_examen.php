...
class ci_inscripcion_examen extends toba_ci
{
    ...
    public function evt__personas__seleccion($seleccion)
    {
    ...
    public function conf__personas($componente)
    {
    ...
    public function evt__alumnos__anterior()
    {
        $this->set_pantalla('pant_sel_persona');
    }

    public function evt__alumnos__seleccion($seleccion)
    {
        $this->s__carrera = $seleccion['carrera'];
        $this->set_pantalla('pant_sel_materia');
    }

    public function conf__alumnos($componente)
    {
        $filtrado = array();
    ...
    public function evt__materias__anterior()
    {
        $this->set_pantalla('pant_sel_carrera');
    }

    public function evt__materias__seleccion()
    {
        $this->set_pantalla('pant_sel_comision');
    }

    public function conf__materias($componente)
    {
        $filtrado = array();
