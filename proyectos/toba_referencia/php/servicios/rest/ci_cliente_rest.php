...
class ci_cliente_rest extends toba_ci
{
     ...
     */
    public function get_cliente_rest()
    {
        try {
    ...
    public function conf__form_debug_rest(toba_ei_formulario $form)
    {
    ...
    public function conf__get(toba_ei_cuadro $cuadro)
    {
    ...
    public function evt__get__personas()
    {
        try {
            $cliente = $this->get_cliente_rest();
    ...
    public function evt__get__persona()
    {
        $cliente = $this->get_cliente_rest();
    ...
    public function evt__get__persona_juegos()
    {
        $cliente = $this->get_cliente_rest();
        try {
    ...
    public function evt__get__personas_alias()
    {
        $cliente = $this->get_cliente_rest();
        try {
    ...
    public function evt__post__persona($datos)
    {
        $cliente = $this->get_cliente_rest();
        try {
    ...
    public function evt__delete__persona($datos)
    {
        $cliente = $this->get_cliente_rest();
    ...
    public function evt__put__persona($datos)
    {
        $cliente = $this->get_cliente_rest();
        $id = $datos['id'];
        unset($datos['id']);
    ...
    {
        //$msg = $e->getMessage(). "\n";
        $msg = 'Request: '  . Psr7\Message::toString($e->getRequest()). PHP_EOL;
        $msg .= 'Response: ' . Psr7\Message::toString($e->getResponse()) . PHP_EOL;
    ...
    public function evt__get_cuadro__cambiar_pagina($pagina)
    {
        $this->filtrar();
    }

    public function conf__get_cuadro(toba_ei_cuadro $cuadro)
    {
        if (isset($this->rs_personas)) {
    ...
    public function evt__get_cuadro__ordenar($orden)
    {
        $this->s__orden = $orden;
        $this->filtrar();
    }

    public function conf__get_filtro(toba_ei_filtro $filtro)
    {
    ...
    public function evt__get_filtro__filtrar($filtro)
    {
        $this->s__filtro = $filtro;
        $this->filtrar();
    }

    public function evt__get_filtro__cancelar()
    {
    ...
    public function evt__imagen__put_imagen($datos)
    {
    ...
    public function evt__imagen__get_imagen($datos)
    {
        $cliente = $this->get_cliente_rest();
        try {
    ...
    public function formatear_valor($valor)
    {
