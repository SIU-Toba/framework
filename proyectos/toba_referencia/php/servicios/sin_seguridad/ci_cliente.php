...
class ci_cliente extends toba_ci
{
    ...
    public function conf__form_echo(toba_ei_formulario $form)
    {
    ...
    public function evt__form_echo__enviar($datos)
    {
        $this->s__echo = $datos;
...
XML;
    ...
    public function conf__form_adjunto(toba_ei_formulario $form)
    {
    ...
    public function evt__form_adjunto__enviar($datos)
    {
...
XML;
    ...
    public function conf__form_datos_password(toba_ei_formulario $form)
    {
    ...
    public function evt__form_datos_password__enviar($datos)
    {
    ...
    public function conf__form_secuencia(toba_ei_formulario $form)
    {
    ...
    public function evt__form_secuencia__enviar($datos)
    {
    ...
    public function conf__form_excepciones(toba_ei_formulario $form)
    {
    ...
    public function evt__form_excepciones__enviar($datos)
    {
