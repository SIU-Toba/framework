...
class serv_sin_seguridad extends toba_servicio_web
{
     ...
     *(maps to the xs:string XML schema type )
     */
    public function op__test(toba_servicio_web_mensaje $mensaje)
    {
...
XML;
     ...
     * (maps to the xs:string XML schema type )
     */
    public function op__upload(toba_servicio_web_mensaje $mensaje)
    {
        //--1- Controlar entrada
...
XML;
     ...
     *(maps to the xs:string XML schema type )
     */
    public function op__aplanar_array(toba_servicio_web_mensaje $mensaje)
    {
    ...
    public function op__persona_alta(toba_servicio_web_mensaje $mensaje)
    {
        //-- Inserta la persona
    ...
    public function op__persona_set_deportes(toba_servicio_web_mensaje $mensaje)
    {
        $datos = $mensaje->get_array();
    ...
    public function op__persona_set_juegos(toba_servicio_web_mensaje $mensaje)
    {
        $datos = $mensaje->get_array();
    ...
    public function op__enviar_excepcion(toba_servicio_web_mensaje $mensaje)
    {
        $datos = $mensaje->get_array();
