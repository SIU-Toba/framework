...
class ci_firma_digital extends toba_ci
{
    ...
    public function conf__firmador(toba_ei_firma $firmador)
    {
     ...
     */
    public function evt__firmador__enviar_pdf($token)
    {
     ...
     */
    public function evt__firmador__recibir_pdf_firmado($path, $token)
    {
    ...
    public function evt__finalizar()
    {
        unset($this->s__seleccion);
        $this->set_pantalla("pant_listado");
    }
    ...
    public function conf__pant_firma(toba_ei_pantalla $pant)
    {
        $this->get_datos_persona();
    ...
    public function evt__borrar_pdf()
    {
    ...
    public function get_datos_persona()
    {
    ...
    public function guardar_pdf_en_tabla($path_pdf, $firmado)
    {
        $firmado = $firmado ? 1 : 0;
