...
class ci_uso_del_menu extends toba_ci
{
    ...
    public function evt__pant_agregar_opcion__entrada()
    {
    ...
    public function evt__pant_cambiar_opcion__entrada()
    {
        $datos = array(
    ...
    public function evt__pant_cambiar_comportamiento__entrada()
    {
