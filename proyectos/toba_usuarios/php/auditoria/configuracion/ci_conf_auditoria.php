...
class ci_conf_auditoria extends toba_ci
{
    ...
    public function conf_evt__cuadro__configurar(toba_evento_usuario $evt, $fila)
    {
        $existe = false;
        try {
    ...
    public function conf_evt__cuadro__crear_auditoria(toba_evento_usuario $evt, $fila)
    {
        $existe = false;
        try {
            $existe = $this->existe_auditoria($evt->get_parametros());
    ...
    public function evt__cuadro__configurar($seleccion)
    {
    ...
    public function evt__cuadro__crear_auditoria($seleccion)
    {
        $this->s__seleccionado = $seleccion;
    ...
    public function conf__form_tablas(toba_ei_formulario $form)
    {
    ...
    public function get_tablas_triggers_activos()
    {
        $datos = array();
    ...
    public function get_db($proyecto)
    {
    ...
    public function get_manejador($proyecto)
    {
    ...
    public function existe_auditoria($proyecto)
    {
        $id = toba_info_editores::get_fuente_datos_defecto($proyecto);
        $info = toba::proyecto($proyecto)->get_info_fuente_datos($id, $proyecto);
        $tiene_metadato = ($info['tiene_auditoria'] == 1);
    ...
    public function get_tablas_disponibles()
    {
