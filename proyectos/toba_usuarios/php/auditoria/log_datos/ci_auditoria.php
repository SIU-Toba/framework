...
class ci_auditoria extends toba_ci
{
    ...
    public function get_db($proyecto = null)
    {
        if (! isset($proyecto)) {
    ...
    public function get_tablas($proyecto = null, $esquema = null)
    {
        $tablas = array();
        if (! isset($proyecto)) {
            $proyecto = $this->s__filtro['proyecto'];
    ...
    public function get_esquemas_combo($proyecto = null)
    {
        $resultado = array();
        $db = $this->get_db($proyecto);
    ...
    public function analizar_diferencias(& $datos, $campos_clave, $campos_propios)
    {
        $indice = array();
