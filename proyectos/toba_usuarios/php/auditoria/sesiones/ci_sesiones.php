...
class ci_sesiones extends toba_ci
{
    ...
    public function evt__sesiones__seleccion($seleccion)
    {
        $this->s__sesion = $seleccion['id'];
        $this->set_pantalla('listar_solicitudes');
    }

    public function conf__sesiones($componente)
    {
        if (isset($this->s__filtro)) {
    ...
    public function conf__listar_solicitudes()
    {
    ...
    public function conf__solicitudes($componente)
    {
