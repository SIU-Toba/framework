...
class admin_instancia
{
    ...
    public function validar_estructura_instancia()
    {

    }

    public static function get_proyecto_defecto()
    {
    ...
    public static function ref($recargar = false)
    {
    ...
    public static function chequear_usar_perfiles_propios($id_proyecto, toba_ei_pantalla $pantalla)
    {
    ...
    public static function set_usar_perfiles_propios($id_proyecto)
    {
    ...
    public static function get_lista_ips_rechazadas()
    {
    ...
    public static function get_lista_usuarios_bloqueados($estado)
    {
        $estado = quote($estado);
        $sql = "SELECT 
					usuario, nombre 
    ...
    public static function eliminar_bloqueo($ip)
    {
        $ip = quote($ip);
        $schema_logs = toba::instancia()->get_db()->get_schema(). '_logs';
    ...
    public static function eliminar_bloqueos()
    {
        $schema_logs = toba::instancia()->get_db()->get_schema(). '_logs';
    ...
    public static function eliminar_bloqueo_usuario($usuario)
    {
    ...
    public static function eliminar_bloqueo_usuarios()
    {
        $sql = 'UPDATE apex_usuario SET bloqueado = 0 WHERE bloqueado = 1';
        toba::db('toba_usuarios')->ejecutar($sql);
    }

    public static function agregar_bloqueo_usuario($usuario)
    {
        $usuario = quote($usuario);
    ...
    public static function agregar_bloqueo_usuarios()
    {
