...
class consultas_instancia
{
    ...
    public static function get_datos_proyecto($proyecto)
    {
        $proyecto = quote($proyecto);
        $sql = "SELECT * FROM apex_proyecto WHERE proyecto = $proyecto";
        $rs = toba::db('toba_usuarios')->consultar($sql);
        return $rs[0];
    }

    public static function get_cantidad_ips_rechazadas()
    {
        $schema_logs = toba::db('toba_usuarios')->get_schema(). '_logs';
        $sql = "SELECT count(*) as cantidad FROM $schema_logs.apex_log_ip_rechazada;";
        $rs = toba::db('toba_usuarios')->consultar($sql);
        return $rs[0]['cantidad'];
    }

    public static function get_cantidad_usuarios_bloqueados()
    {
    ...
    public static function get_cantidad_usuarios_desbloqueados()
    {
    ...
    public static function get_cantidad_sesiones_proyecto($proyecto)
    {
        $proyecto = quote($proyecto);
        $schema_logs = toba::db('toba_usuarios')->get_schema(). '_logs';
    ...
    public static function get_sesiones($proyecto, $filtro)
    {
        $proyecto = quote($proyecto);
        $where = '';
    ...
    public static function get_id_sesion($id_solicitud)
    {
		...
		";
        $fila = toba::db('toba_usuarios')->consultar_fila($sql);
        if (isset($fila['id'])) {
            return $fila['id'];
        } else {
    ...
    public static function get_solicitudes_browser($sesion, $id_solicitud = null)
    {
        $extra = '';
    ...
    public static function get_solicitud_observaciones($solicitud)
    {
    ...
    public static function get_solicitudes_consola($proyecto, $filtro)
    {
        $proyecto = quote($proyecto);
        $schema_logs = toba::db('toba_usuarios')->get_schema(). '_logs';
        $sql = "		
    ...
    public static function get_solicitudes_web_service($filtro = array())
    {
        $where = array();
        if (isset($filtro['proyecto'])) {
            $where[] = 's.proyecto = ' .quote($filtro['proyecto']);
        }
        if (isset($filtro['web_service'])) {
            $where[] = 's.item ILIKE  ' . quote("{$filtro['web_service']}%");
        }
        if (isset($filtro['metodo'])) {
            $where[] = 'sws.metodo ILIKE  ' . quote("{$filtro['metodo']}%");
        }
        if (isset($filtro['ip'])) {
            $where[] = 'sws.ip =' .quote($filtro['ip']);
        }
        if (isset($filtro['solicitud'])) {
            $where[] = 's.solicitud = ' .quote($filtro['solicitud']);
        }
        $schema_logs = toba::db('toba_usuarios')->get_schema(). '_logs';
        $sql = "
				SELECT	s.solicitud as id, 
    ...
    public static function armar_offset_pagina($tamanio, $pagina)
    {
        $limit = '';
        if (isset($tamanio)) {
    ...
    public static function armar_where_usuarios($filtro)
    {
        $where = array();
        if (isset($filtro)) {
    ...
    public static function get_cantidad_usuarios($filtro = null)
    {
        $where = '';
    ...
    public static function get_cantidad_usuarios_proyecto($proyecto, $filtro = null)
    {
        $proyecto = quote($proyecto);
    ...
    public static function get_cantidad_usuarios_no_vinculados($proyecto = null, $filtro = null)
    {
    ...
    public static function get_lista_usuarios($filtro = null, $tamanio = null, $pagina = null)
    {
        $where = '';
        $condiciones = self::armar_where_usuarios($filtro);
        if (! empty($condiciones)) {
    ...
    public static function get_usuarios_no_vinculados($filtro = null)
    {
    ...
    public static function get_usuarios_vinculados_proyecto($proyecto, $filtro = null, $tamanio = null, $pagina = null)
    {
        $proyecto = quote($proyecto);
    ...
    public static function get_usuarios_no_vinculados_proyecto($proyecto, $filtro = null, $tamanio = null, $pagina = null)
    {
        $join = '';
        if (isset($proyecto)) {
            $proyecto = quote($proyecto);
    ...
    public static function get_existe_usuario($usuario)
    {
    ...
    public static function set_segundo_factor_x_perfil($proyecto, $perfil, $segundo_factor, $usuarios = array())
    {
        ...
        $id = toba::db('toba_usuarios')->sentencia_preparar($sql);
        return toba::db('toba_usuarios')->sentencia_ejecutar($id, $params);
    }
    ...
    public static function get_lista_grupos_acceso_usuario_proyecto($usuario, $proyecto)
    {
        $proyecto = quote($proyecto);
        $usuario = quote($usuario);
    ...
    public static function get_lista_grupos_acceso($filtro)
    {
        $where = array();
        if (isset($filtro['proyecto'])) {
            $where[] = 'proyecto = '.quote($filtro['proyecto']);
        }
        if (isset($filtro['grupo'])) {
            $where[] = 'usuario_grupo_acc = '.quote($filtro['grupo']);
        }
        if (isset($filtro['menu' ])) {
            $where[] = 'menu_usuario = '.quote($filtro['menu']);
        }
    ...
    public static function get_usuarios_con_grupo_acceso_unico($proyecto, $perfil)
    {
    ...
    public static function get_lista_grupos_acceso_proyecto($proyecto)
    {
        return self::get_lista_grupos_acceso(array('proyecto' => $proyecto));
    }

    public static function get_descripcion_grupo_acceso($proyecto, $grupo)
    {
        $proyecto = quote($proyecto);
        $grupo = quote($grupo);
    ...
    public static function get_descripcion_perfil_datos($proyecto, $perfil)
    {
        $proyecto = quote($proyecto);
        $perfil = quote($perfil);
    ...
    //------ Items de Menus ----------------------------------------------
    //---------------------------------------------------------------------
    public static function get_menu_tipos($filtro = array())
    {
        $where = array();
        if (isset($filtro['menu'])) {
    ...
    public static function get_menus_existentes($proyecto)
    {
    ...
    public static function get_items_combo($proyecto)
    {
    ...
    public static function get_lista_perfil_datos($proyecto)
    {
        $proyecto = quote($proyecto);
        $sql = "SELECT 	proyecto,
    ...
    //------ Servicios Web ------------------------------------------
    //---------------------------------------------------------------------
    public static function get_servicios_web_consumidos($filtro)
    {
        $where_filtro = array();
        if (isset($filtro['proyecto'])) {
            $where_filtro[] = 'proyecto = '. quote($filtro['proyecto']);
        }
        if (isset($filtro['tipo'])) {
            $where_filtro[] = 'tipo= '. quote($filtro['tipo']);
        }
