...
class ci_armador_menues extends toba_ci
{
    ...
    public function set_proyecto($proyecto)
    {
    ...
    public function es_edicion()
    {
        return $this->dep('datos')->esta_cargada();
    }

    public function conf__arbol_origen($arbol)
    {
    ...
    public function get_ids_enviados()
    {
    ...
    public function conf__pant_final(toba_ei_pantalla $pantalla)
    {
    ...
    public function evt__armar_menu()
    {
        $this->set_pantalla('pant_armado');
    }

    public function evt__cambiar_texto()
    {
        $this->set_pantalla('pant_descripciones');
    }

    public function evt__previsualizar()
    {
    ...
    //---- form_armado ------------------------------------------------------------------
    //-----------------------------------------------------------------------------------
    public function evt__form_armado__modificacion($datos)
    {
    ...
    //---- AUXILIARES -------------------------------------------------------------------
    //-----------------------------------------------------------------------------------
    public function descubrir_padre($datos, $id)
    {
        $padre = null;
    ...
    public function recuperar_info_items()
    {
        $resultado = array();
    ...
    public function buscar_datos_persistidos()
    {
    ...
    public function get_arreglo_js()
    {
        $arbol = array();
    ...
    //					SERVICIOS AJAX
    //------------------------------------------------------------------------------------------------------------------
    public function ajax__get_estructura_arbol($parametros, toba_ajax_respuesta $respuesta)
    {
    ...
    public function ajax__set_descripcion_nodo($parametros, toba_ajax_respuesta $respuesta)
    {
