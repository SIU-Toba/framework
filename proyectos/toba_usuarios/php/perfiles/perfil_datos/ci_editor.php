...
class ci_editor extends toba_ci
{
    ...
    public function evt__perfil__modificacion($datos)
    {
        $datos['proyecto'] = $this->s__proyecto;
        $this->datos()->tabla('perfil')->set($datos);
    }

    public function conf__perfil(toba_ei_formulario $form)
    {
    ...
    public function evt__dimensiones__seleccion($seleccion)
    {
        $this->s__dimension = $seleccion['dimension'];
        $this->set_pantalla('pant_dimensiones');
    }

    public function conf__dimensiones(toba_ei_cuadro $cuadro)
    {
    ...
    public function conf__pant_dimensiones($pantalla)
    {
    ...
    public function conf__elementos(toba_ei_formulario_ml $form_ml)
    {
    ...
    public function evt__elementos__modificacion($datos)
    {
        foreach (array_keys($datos) as $id) {
    ...
    public function get_elementos_dimension()
    {
    ...
    public function get_fuente_proyecto_alterno($id, $proyecto)
    {
