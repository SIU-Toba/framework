...
class ci_editor_perfiles extends toba_ci
{
    ...
    public function set_perfil_funcional($perfil_funcional)
    {
    ...
    public function guardar_arbol_items($alta)
    {
    ...
    public function conf__arbol_perfiles($arbol)
    {
    ...
    public function conf__form_restricciones($componente)
    {
    ...
    public function evt__form_restricciones__modificacion($datos)
    {
    ...
    public function conf__form_permisos($componente)
    {
    ...
    public function evt__form_permisos__modificacion($datos)
    {
    ...
    public function conf__form_membresia(toba_ei_formulario $form)
    {
    ...
    public function evt__form_membresia__modificacion($datos)
    {
