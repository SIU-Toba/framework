...
class ci_navegacion_perfiles extends toba_ci
{
    ...
    public function conf__seleccion_perfil()
    {
    ...
    public function conf__edicion_perfil()
    {
    ...
    public function actualizar_info_ini()
    {
        admin_instancia::set_usar_perfiles_propios($this->dep('editor_perfiles')->get_proyecto());
    }

    public function actualizar_script_roles($eliminados = array())
    {
        ...
        if ($usa_permisos_por_tabla) {
            ...
            $modelo->set_db(toba::db('toba_usuarios'));
    ...
    public function evt__ver_grafico()
    {
    ...
    public function evt__eliminar()
    {
        ...
        $this->dep('datos')->persistidor()->desactivar_transaccion();
        toba::db('toba_usuarios')->abrir_transaccion();
        ...
        toba::db('toba_usuarios')->ejecutar($sql);
        toba::db('toba_usuarios')->cerrar_transaccion();
    ...
    public function conf__cuadro_grupos_acceso($componente)
    {
        if (isset($this->s__filtro)) {
    ...
    public function evt__cuadro_grupos_acceso__seleccion($seleccion)
    {
    ...
    public function conf__form_datos_perfil(toba_ei_formulario $componente)
    {
    ...
    public function evt__form_datos_perfil__modificacion($datos)
    {
        $this->datos('accesos')->set($datos);
    }

    public function evt__filtro_proyectos__filtrar($datos)
    {
        $this->s__filtro = $datos;
    }

    public function evt__filtro_proyectos__cancelar()
    {
        unset($this->s__filtro);
    }

    public function conf__filtro_proyectos($componente)
    {
        if (isset($this->s__filtro)) {
    ...
    public function conf__esquema(toba_ei_esquema $esquema)
    {
    ...
    public function get_grafo()
    {
        ...
        foreach ($perfiles as $perfil) {
            ...
            $miembros = toba_info_permisos::get_perfiles_funcionales_miembros($perfil['proyecto'], $perfil['usuario_grupo_acc'], toba::db('toba_usuarios'));
    ...
    public function validar_ciclos()
    {
    ...
    public function get_menues_existentes()
    {
