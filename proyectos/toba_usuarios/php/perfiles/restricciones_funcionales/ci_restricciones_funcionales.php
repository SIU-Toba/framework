...
class ci_restricciones_funcionales extends toba_ci
{
    ...
    public function evt__guardar()
    {
        ...
        if ($alta) {
            $restriccion = toba::db('toba_usuarios')->recuperar_secuencia('apex_restriccion_funcional_seq');
        }
    ...
    public function conf__seleccion()
    {
        if (! isset($this->s__filtro)) {
    ...
    public function evt__cuadro_restricciones__seleccion($seleccion)
    {
    ...
    public function conf__cuadro_restricciones($componente)
    {
        if (isset($this->s__filtro)) {
    ...
    public function conf__form_restriccion(toba_ei_formulario $componente)
    {
        if ($this->dep('restricciones')->esta_cargada()) {
    ...
    public function evt__form_restriccion__modificacion($datos)
    {
        if ($this->dep('restricciones')->esta_cargada()) {
    ...
    public function conf__arbol(arbol_restricciones_funcionales $arbol)
    {
     ...
     */
    public function evt__arbol__cargar_nodo($id)
    {
    ...
    public function buscar_nodo($id_nodo, $padre)
    {
    ...
    public function cortar_arbol()
    {
        unset($this->s__arbol_cargado);
        $this->s__restriccion = -1;
    }

    public function get_proyecto_seleccionado()
    {
