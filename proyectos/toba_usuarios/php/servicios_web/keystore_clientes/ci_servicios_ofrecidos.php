...
class ci_servicios_ofrecidos extends toba_ci
{
    ...
    public function get_modelo_proyecto()
    {
    ...
    public function complementar_datos($datos)
    {
        $conf_final = array();
    ...
    public function conf__form_muestra(toba_ei_formulario $form)
    {
        $proyecto = $this->get_modelo_proyecto();
    ...
    public function servicio__download_certificado()
    {
    ...
    public function conf__cuadro_sel_conf(toba_ei_cuadro $cuadro)
    {
    ...
    public function evt__cuadro_sel_conf__seleccion($seleccion)
    {
        $this->s__conf_activa = $seleccion['headers'];
        $this->set_pantalla('pant_edicion');
    }

    public function evt__cuadro_sel_conf__agregar()
    {
        $this->set_pantalla('pant_edicion');
    }

    public function evt__cuadro_sel_conf__eliminar($seleccion)
    {
        $this->s__conf_activa = $seleccion['headers'];
        $this->eliminar_config();
    }

    public function recuperar_clientes_configurados($servicio)
    {
        $datos = array();
        $proyecto = $this->get_modelo_proyecto();
    ...
    public function conf__form_parametros(toba_ei_formulario_ml $form_ml)
    {
    ...
    public function evt__form_parametros__modificacion($datos)
    {
    ...
    public function eliminar_config()
    {
        if (isset($this->s__conf_activa)) {					//Si existe la entrada editada, entonces leo sus datos y la elimino
            $proyecto = $this->get_modelo_proyecto();
            $ini = toba_modelo_servicio_web::get_ini_server($proyecto, $this->s__seleccionado);
    ...
    public function evt__procesar_parcial()
    {
        $this->guardar_config();
        $this->finalizar_operacion();
        $this->set_pantalla('pant_sel_conf');
    ...
    public function evt__cancelar_parcial()
    {
        $this->finalizar_operacion();
        $this->set_pantalla('pant_sel_conf');
    }
    ...
    public function finalizar_operacion()
    {
