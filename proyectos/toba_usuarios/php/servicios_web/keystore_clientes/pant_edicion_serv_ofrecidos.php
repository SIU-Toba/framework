...
class pant_edicion_serv_ofrecidos extends toba_ei_pantalla
{
	...
	{
		$id_form_par = $this->controlador()->dep('form_parametros')->get_id_objeto_js();
		$id_form = $this->controlador()->dep('form_basico')->get_id_objeto_js();
		
		echo "
		//---- Eventos ---------------------------------------------
		
		{$this->controlador()->objeto_js}.evt__validar_datos = function()
		{
