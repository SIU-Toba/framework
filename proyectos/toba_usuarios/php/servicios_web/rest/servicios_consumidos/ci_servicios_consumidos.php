...
class ci_servicios_consumidos extends toba_ci
{
    ...
    public function finalizar_operacion()
    {
        ...
        if (isset($this->cert)) {
            if (file_exists($this->cert['path'])) {
                unlink($this->cert['path']);
            }
            $this->cert = null;
        }
        if (isset($this->key)) {
            if (file_exists($this->key['path'])) {
                unlink($this->key['path']);
            }
            $this->key = null;
        }
        if (isset($this->ca)) {
            if (file_exists($this->ca['path'])) {
                unlink($this->ca['path']);
            }
            $this->ca = null;
        }
    ...
    public function ajax__test_configuracion($clave_param, toba_ajax_respuesta $respuesta)
    {
    ...
    public function conf__form_basico_ws(toba_ei_formulario $form)
    {
    ...
    public function evt__form_basico_ws__modificacion($datos)
    {
    ...
    public function get_tipos_autenticacion()
    {
