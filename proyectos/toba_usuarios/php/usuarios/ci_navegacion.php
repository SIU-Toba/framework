...
class ci_navegacion extends toba_ci
{
    ...
    public function conf__seleccionar()
    {
    ...
    public function conf_evt__cuadro__eliminar(toba_evento_usuario $evt)
    {
    ...
    public function evt__cuadro__seleccion($id)
    {
        $this->dep('editor')->limpiar_datos();
    ...
    public function evt__cuadro__eliminar($id)
    {
        $this->dep('datos')->cargar($id);
        $this->evt__eliminar();
    }
