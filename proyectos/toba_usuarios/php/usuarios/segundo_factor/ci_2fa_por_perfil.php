...
class ci_2fa_por_perfil extends toba_ci
{
    ...
    public function evt__cuadro__segundo_factor_mas($seleccion)
    {
        try {
            ...
            toba::db('toba_usuarios')->abortar_transaccion();
            throw $e;
        }
    }


    public function evt__cuadro__segundo_factor_menos($seleccion)
    {
        try {
            toba::db('toba_usuarios')->abrir_transaccion();
            $membresias = $this->buscar_membresias($seleccion);
    ...
    //---- AUXILIARES -------------------------------------------------------------------
    //-----------------------------------------------------------------------------------
    public function buscar_membresias($seleccion)
    {
    ...
    public function marcar_usuarios_perfil($perfiles)
    {
    ...
    public function desmarcar_usuarios_perfil($perfiles)
    {
