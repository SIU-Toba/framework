...
--	CONSTRAINT	"apex_log_sis_fk_usuario" FOREIGN KEY ("usuario") REFERENCES "apex_usuario" ("usuario") ON DELETE NO ACTION ON UPDATE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE,
	CONSTRAINT	"apex_log_sis_fk_tipo" FOREIGN KEY ("log_sistema_tipo") REFERENCES "apex_log_sistema_tipo" ("log_sistema_tipo") ON DELETE CASCADE ON UPDATE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE
);
--###################################################################################################-------------------
