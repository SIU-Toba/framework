...
var JsonRpcContainer = function(configParams) {
  ...
  this.path_ = path.replace("%host%", document.location.host).replace("%toba_alias%", window.toba_alias).replace("%toba_href%", window.location.protocol+'//'+document.location.host+window.toba_alias);
  ...
  this.invalidatePath_ = invalidatePath.replace("%host%",
      document.location.host).replace("%toba_alias%", window.toba_alias).replace("%toba_href%", window.location.protocol+'//'+document.location.host+window.toba_alias);
...
(function() {
  ...
  JsonRpcContainer.generateErrorResponse = function(result, requestObjects,
      callback) {
    var globalErrorCode =(result.rc || result.data)? JsonRpcContainer.translateHttpError(result.rc || result.data.error):opensocial.ResponseItem.Error.INTERNAL_ERROR;
