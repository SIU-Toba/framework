...
ini_set("include_path", ini_get("include_path"). $separador . '../../php/3ros/shindig');
...
function __autoload($className) {
  ...
  foreach ($locations as $path) {
    if (file_exists("../../php/3ros/shindig/{$path}/$fileName")) {
      require '../../php/3ros/shindig/'.$path . '/' . $fileName;
      return;
    }
  }
